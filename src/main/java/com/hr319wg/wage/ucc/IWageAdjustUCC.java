...
{
  public abstract List getAdjustList(PageVO paramPageVO, boolean isAppro, boolean isNotAppro, User paramUser)
    throws SysException;
  ...
  public abstract void deleteAdjust(String paramString)
    throws SysException;

  public abstract void saveWageAdjustDetailBO(WageAdjustDetailBO paramWageAdjustDetailBO)
    throws SysException;

  public abstract WageAdjustRuleBO getWageAdjustRuleBO(String paramString)
    throws SysException;

  public abstract void saveWageAdjustRuleBO(WageAdjustRuleBO paramWageAdjustRuleBO)
    throws SysException;
  ...
  public abstract void createAdjustDetail(String paramString1, String paramString2, String[] paramArrayOfString)
    throws SysException;
}

/* Location:           E:\desk1\lib3\
 * Qualified Name:     com.hr319wg.wage.ucc.IWageAdjustUCC
