...
public class PersonChangeShowBackingBean extends BaseBackingBean
{
  ...
  private boolean showChangeUnit = false;
    ...
    try {
      ...
      if ("1".equals(this.mode)) {
        if ("ORACLE".equals(Constants.DB_TYPE)) {
          filter += " and typeof(B730702,'0200','0200110001')='1'";
        }
        else {
          filter += " and dbo.typeof(B730702,'0200','0200110001')='1'";
        }
      }
      else if ("2".equals(this.mode)) {
        if ("ORACLE".equals(Constants.DB_TYPE)) {
          filter += " and typeof(B730702,'0200','0200120001')='1'";
        }
        else {
          filter += " and dbo.typeof(B730702,'0200','0200120001')='1'";
        }
      }
