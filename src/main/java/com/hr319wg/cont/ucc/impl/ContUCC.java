  ...
  implements IContUCC
{
  ...
  public String getMaxContNo(String pre) throws SysException {
    String sql = "select max(cont_code) from cont_info where cont_code like '" + pre + "%'";
    return this.sysactivepageapi.queryForString(sql);
  }
  ...
  public ContBO[] queryAll(String createOrgId, String personName, String approveStatus, PageVO vo) throws SysException {
    return this.contservice.queryAll(createOrgId, personName, approveStatus, vo);
  }
  public ContBO[] queryAllByApproveOrgId(String approveOrgId, String personName, String approveStatus, PageVO vo, String contOper) throws SysException {
    return this.contservice.queryAllByApproveOrgId(approveOrgId, personName, approveStatus, vo, contOper);
  }
  public ContBO[] queryAllByApproveOrgId(String approveOrgId, String personName, String approveStatus, PageVO vo) throws SysException {
    return this.contservice.queryAllByApproveOrgId(approveOrgId, personName, approveStatus, vo);
  }
  ...
  public List makeLink(String[] ids, String validDate) throws SysException
  {
    ...
    try {
      for (int i = 0; i < ids.length; i++) {
        ...
        ContPersonBO bo = this.contpersonservice.findContPersonById(personId);
        contPersonBO_List.add(bo);

        if ((("1".equals(Constants.CONT_AUDIT_MODE)) || ("2".equals(Constants.CONT_AUDIT_MODE))) && (!contbo.getApproveStatus().equals("201003"))) {
        ...
        String contTerm = "";
        if ((contStartDate != null) && (!contStartDate.equals("")) && (contEndDate != null) && (!contEndDate.equals(""))) {
          int endYear = Integer.parseInt(contEndDate.substring(0, 4));
          int startYear = Integer.parseInt(contStartDate.substring(0, 4));
          int endMon = Integer.parseInt(contEndDate.substring(5, 7));
          int startMon = Integer.parseInt(contStartDate.substring(5, 7));
          ...
          contTerm = String.valueOf((endYear - startYear) * 12 + (endMon - startMon) + plus);
        }

        String[] infoItems5 = { "A708703", "A708701", "A708705", "A708710", "A708715", "A708720", "A708205", "A708211", "A708213", "A708216", "A708217"};
        String[] ietmValues5 = { CommonFuns.filterNull(contbo.getContCode()), CommonFuns.filterNull(contbo.getContTermClass()), CommonFuns.filterNull(contbo.getContClass()), CommonFuns.filterNull(contbo.getContStartDate()), CommonFuns.filterNull(contbo.getContEndDate()), CommonFuns.filterNull(contbo.getSalaryClass()), CommonFuns.filterNull(contTerm), 
        		CommonFuns.filterNull(contbo.getProbationEndDate()), CommonFuns.filterNull(contbo.getProbationSalaryMoney()), CommonFuns.filterNull(contbo.getPraxisEndDate()), CommonFuns.filterNull(contbo.getBasicSalaryMoney())};

        this.sysactivepageapi.updatePageInfo("A708", null, bo.getPersonId(), null, false, null, null, infoItems5, ietmValues5);

        String[] infoItems6 = { "A710000", "A710701", "A710705", "A710708", "A710715", "A710720", "A710727", "A710729", "A710731", "A710735", "A710738", "A710749", "A710755", "A710760",
        		"A710725", "A710222", "A710200", "A710223"};

        String[] ietmValues6 = { "00901", CommonFuns.filterNull(contbo.getContCode()), CommonFuns.filterNull(contbo.getContTermClass()), CommonFuns.filterNull(contbo.getContClass()), CommonFuns.filterNull(contbo.getContStartDate()), CommonFuns.filterNull(contbo.getContEndDate()), CommonFuns.filterNull(contbo.getValidDate()), CommonFuns.filterNull(contbo.getPostName()), CommonFuns.filterNull(contbo.getWorkContent()), CommonFuns.filterNull(contbo.getWorkPlace()), CommonFuns.filterNull(contbo.getSalaryClass()), CommonFuns.filterNull(contbo.getContRemark()), CommonFuns.filterNull(contbo.getAttachmentId()), CommonFuns.filterNull(contbo.getAgreeTestify()),
        		CommonFuns.filterNull(contbo.getProbationEndDate()), CommonFuns.filterNull(contbo.getProbationSalaryMoney()), CommonFuns.filterNull(contbo.getPraxisEndDate()), CommonFuns.filterNull(contbo.getBasicSalaryMoney())};

        this.sysactivepageapi.addPageInfo("A710", null, null, bo.getPersonId(), false, infoItems6, ietmValues6);

        String[] infoItems7 = { "A725701", "A725705", "A725710", "A725715" };
        String[] ietmValues7 = { CommonFuns.filterNull(contbo.getApproveStatus()), CommonFuns.filterNull(contbo.getUptoValidDate()), CommonFuns.filterNull(contbo.getApprovePersonId()), CommonFuns.filterNull(contbo.getApproveDate()) };

        this.sysactivepageapi.updatePageInfo("A725", null, bo.getPersonId(), null, false, null, null, infoItems7, ietmValues7);

        if ("1".equals(Constants.EMP_ADD_AFTER_APPROVE)) {
          String updateSQL = "update a001 set A001730='00900' where id='" + personId + "'";
      ...
      throw new RollbackableException("E0600217", errorInfo, ex, getClass());
    }
  ...
  public String getDismissPerson(TableVO table, User user, String orgid, String selectNewPersonIds) throws SysException {
    return this.contservice.getDismissPerson(table, user, orgid, selectNewPersonIds);
  }

  public String findContPostBObyId(String id) throws SysException {
    String sql = "SELECT C001005 FROM C001 WHERE POSTID in (select A001715 from A001 where ID='" + id + "')";
    return this.sysactivepageapi.queryForString(sql);
  }

  public String findC019(String id) throws SysException {
    String sql = "SELECT C019700 FROM C019 WHERE POSTID in (select A001715 from A001 where ID='" + id + "')";
    return this.sysactivepageapi.queryForString(sql);
  }
  ...
  public void changeContMaster(String chgId) throws SysException {
    String sql = "update emp_chginfo set cont_old_end='1',cont_new_begin='1' where chg_id='" + chgId + "'";
