...
/*
 *  HrSSOStub java implementation
 */

public class HrSSOStub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService("HrSSO"
				+ getUniqueSuffix());
	...
	public HrSSOStub(
		...
		this(configurationContext, "http://portal.sias.edu.cn:8888/hrsso.asmx");
	 ...
	 * Default Constructor
	 */
	public HrSSOStub() throws org.apache.axis2.AxisFault {

		this("http://portal.sias.edu.cn:8888/hrsso.asmx");
	 ...
	 */
	public HrSSOStub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
		this(null, targetEndpoint);
	}

	/**
	 * Auto generated method signature 登录验证
	 * 
	 * @see org.tempuri.HrSSO#validate
	 * @param validate0
	 * 
	 * @param mySoapHeader1
	 */

	public com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse validate(

			com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate validate0,
			com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE mySoapHeader1)
...

	{
		...
		try {
			...
			if (mySoapHeader1 != null) {
				...
				org.apache.axiom.om.OMElement omElementmySoapHeader1 = toOM(
						mySoapHeader1,
						optimizeContent(new javax.xml.namespace.QName(
								"http://tempuri.org/", "validate")));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(),
					com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse.class,
					getEnvelopeNamespaces(_returnEnv));

			return (com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse) object;
	...
	/**
	 * Auto generated method signature for Asynchronous Invocations 登录验证
	 * 
	 * @see org.tempuri.HrSSO#startvalidate
	 * @param validate0
	 * 
	 * @param mySoapHeader1
	 */
	...
	com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE mySoapHeader1,
			...
			final com.hr319wg.custom.validateLogin.web.HrSSOCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback.receiveResultvalidate((com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse) object);
	...
	// http://portal.sias.edu.cn:8888/hrsso.asmx
	public static class Validate implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "validate", "ns1");
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":validate", xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "validate", xmlWriter);
				}
			...
			if (localCredentialsTracker) {
				...
				if (!namespace.equals("")) {
					...
					if (prefix == null) {
						...
						xmlWriter.writeStartElement(prefix, "credentials",
								namespace);
						xmlWriter.writeNamespace(prefix, namespace);
						xmlWriter.setPrefix(prefix, namespace);

					} else {
						xmlWriter.writeStartElement(namespace, "credentials");
					}
		...
		public static class Factory {
			 ...
			 */
			public static Validate parse(javax.xml.stream.XMLStreamReader reader)
				...
				try {
							...
							if (!"validate".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (Validate) ExtensionMapper
					...
					if (reader.isStartElement()
						...
						object.setAppid(org.apache.axis2.databinding.utils.ConverterUtil
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName(
									"http://tempuri.org/", "key").equals(reader
									.getName())) {
	...
	public static class MySoapHeaderE implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "MySoapHeader", "ns1");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					MySoapHeaderE.this.serialize(MY_QNAME, factory, xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
					MY_QNAME, factory, dataSource);
		...
		public void serialize(
			...
			localMySoapHeader.serialize(MY_QNAME, factory, xmlWriter);
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName(
											"http://tempuri.org/",
											"MySoapHeader").equals(reader
											.getName())) {

								object.setMySoapHeader(MySoapHeader.Factory
										.parse(reader));
	...
	public static class MySoapHeader implements
			org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * MySoapHeader Namespace URI = http://tempuri.org/ Namespace Prefix =
		 * ns1
		 */
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":MySoapHeader",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "MySoapHeader", xmlWriter);
				}
						...
						if (fullTypeName != null) {
							...
							if (!"MySoapHeader".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (MySoapHeader) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
	...
	public static class ValidateResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://tempuri.org/", "validateResponse", "ns1");
		...
		protected boolean localValidateResult;
		 ...
		 *            ValidateResult
		 */
		public void setValidateResult(boolean param) {
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					ValidateResponse.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":validateResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "validateResponse", xmlWriter);
				}
			...
			if (!namespace.equals("")) {
				...
				if (prefix == null) {
					...
					xmlWriter.writeStartElement(prefix, "validateResult",
							namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
			...
			if (false) {
				...
				xmlWriter
						.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localValidateResult));
			}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			elementList.add(new javax.xml.namespace.QName(
					"http://tempuri.org/", "validateResult"));
			...
			public static ValidateResponse parse(
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"validateResponse".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (ValidateResponse) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (reader.isStartElement()
						...
						object.setValidateResult(org.apache.axis2.databinding.utils.ConverterUtil
	...
	private org.apache.axiom.om.OMElement toOM(
			com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(
					com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(
			com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(
					com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
		...
		try {
			...
			emptyEnvelope.getBody().addChild(
					param.getOMElement(com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate.MY_QNAME,
							factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate.class.equals(type)) {

				return com.hr319wg.custom.validateLogin.web.HrSSOStub.Validate.Factory.parse(param
						.getXMLStreamReaderWithoutCaching());

			}

			if (com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse.class.equals(type)) {

				return com.hr319wg.custom.validateLogin.web.HrSSOStub.ValidateResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE.class.equals(type)) {

				return com.hr319wg.custom.validateLogin.web.HrSSOStub.MySoapHeaderE.Factory.parse(param
						.getXMLStreamReaderWithoutCaching());
