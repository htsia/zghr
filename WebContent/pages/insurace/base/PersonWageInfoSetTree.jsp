...
<%
    String setType = "A";
    CodeItemBO cItem = SysCacheTool.findCodeItem(Constants.INFO_SET_TYPE_CODEID, "2001010402");
        ...
        if(infosetTypes != null && infosetTypes.size()>0){
            ...
            for(int i=0;i<count;i++){
                ...
                if(!citem.getTreeId().startsWith(typeTreeId))
                    continue;
                if("2001010400".equals(citem.getItemSuper())){
                    String str = "T" + citem.getItemId() + " = tree.add(root,'last','" + citem.getItemName() + "', 'T" + citem.getItemId() + "','','','file','','');";
                    out.println(str);
                }else{
                    String str = "T" + citem.getItemId() + " = tree.add(T" + citem.getItemSuper() +",'last','" + citem.getItemName() + "', 'T" + citem.getItemId() + "','','','file','','');";
                    out.println(str);
                }
            }
        }
                ...
                if(setBO.getSet_sType() != null && !"".equals(setBO.getSet_sType())){
                    ...
                    if(treeId.startsWith(typeTreeId)){
                        ...
                        if(0==pmsapi.checkInfoSet((User) session.getAttribute(Constants.USER_INFO),setBO.getSetId())){
                            ...
                            String str =setBO.getSetId() + " = tree.add(" + rootNode + ",'last','" + setBO.getSetName() + "','" + setBO.getSetId() + "','"+setBO.getSet_rsType()+"','','database','','');";
                            out.println(str);
                        }
                    }
                }
