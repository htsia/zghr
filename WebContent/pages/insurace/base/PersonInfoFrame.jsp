...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function refreshLocal(setId, rsType, id) {
            ...
            //            alert(setId)
            if ("A815" == setId) {
                document.main.location = "/pages/wage/base/PersonSalaryList.jsf?" + arg;
            } else {
                if (rsType == '2') {
                    document.main.location = "/wage/base/PersonInfoDetailList.jsf?" + arg;
                } else {
                    document.main.location = "/wage/base/PersonInfoDetail.jsf?" + arg;
                }
            }
        }
...
<table width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF">
    <tr>
        <td height="22" colspan=3 valign="top" class="td_title" align="left" id=showname>
