...
%>
    ...
    <script type="text/javascript" language="javascript">
        function refreshList(unitId) {
                document.list.location = "/insurace/RateSetList.jsf?superId=" + unitId;
        }
...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
        <td class="td_title" colspan=3><img src="/images/tips.gif">缴费比例设定</td>
    </tr>
    <tr>
        ...
        <td align="center" valign="top" class="explorer">
            <iframe name="list" frameborder="0" framespacing="0" scrolling="auto"  width="100%"
                                src="/insurace/RateSetList.jsf"></iframe>
       </td>
    </tr>
</table>
