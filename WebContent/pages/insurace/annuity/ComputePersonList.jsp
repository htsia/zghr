...
<x:saveState value="#{annu_computelistBB}"/>
<x:saveState value="#{wage_dateBB}"/>

<h:form id="form1">
    <h:inputHidden value="#{annu_computelistBB.pageInit}"/>
    <h:inputHidden id="deptpower" value="#{wage_computeBB.deptpower}"/>
    <h:inputHidden id="setId" value="#{annu_computelistBB.setId}"/>
    <h:inputHidden id="unitId" value="#{annu_computelistBB.unitId}"/>
    <h:inputHidden id="setName" value="#{annu_computelistBB.setName}"/>
    <h:inputHidden id="dateId" value="#{annu_computelistBB.dateId}"/>
    ...
    <h:panelGrid columns="2" align="center" width="95%" >
       <h:panelGroup>
            <h:outputText escape="false" value="<strong>发薪单位：</strong>#{annu_computelistBB.unitName}"/>
            <h:outputText value="   "></h:outputText>
            <h:outputText escape="false" value="<strong>账套：</strong>#{annu_computelistBB.setName}"/>
            <h:outputText value="   "></h:outputText>
            <h:outputText value="#{annu_computelistBB.payoffDate}"></h:outputText>
        </h:panelGroup>
    </h:panelGrid>
    ...
    <h:panelGrid columns="11" align="center" width="95%" >
        <h:panelGroup>
            <h:selectOneMenu id="ReportID" style="width:150px">
                <c:selectItems value="#{annu_computelistBB.bxreportList}"/>
            </h:selectOneMenu>
        ...
        <h:panelGroup>
            ...
            <h:commandButton value="查询" action="#{annu_computelistBB.queryPersonByNameStr}" styleClass="button01"/>
            <h:commandButton value="自定义查询" styleClass="button01"
                             action="#{annu_computelistBB.queryAdvance}"
                             onclick="return doAdvanceQuery('A','ORG','011','Y','','','N','152','N')"/>
        </h:panelGroup>

        <h:panelGroup>
                       <h:selectOneMenu id="groupLevel" value="#{annu_computelistBB.groupLevel}">
                       ...
                       <h:commandButton value="选择" styleClass="button01" action="#{annu_computelistBB.changeLevel}"></h:commandButton>
                       <h:selectOneMenu id="WageDept"  value="#{annu_computelistBB.dept}">
                          <c:selectItems value="#{annu_computelistBB.deptList}"></c:selectItems>
                       </h:selectOneMenu>
                       <h:commandButton styleClass="button01"value="过滤" action="#{annu_computelistBB.queryPersonByDept}"></h:commandButton>
        </h:panelGroup>
        ...
        <h:panelGrid columns="1" align="right" cellspacing="2" >
            <h:panelGroup>
                ...
                <h:commandButton value="返回" action="#{wage_dateBB.dateList}" styleClass="button01">
                    <x:updateActionListener property="#{wage_dateBB.setId}" value="#{annu_computelistBB.setId}"/>
                    <x:updateActionListener property="#{wage_dateBB.setName}" value="#{annu_computelistBB.setName}"/>
                    <x:updateActionListener property="#{wage_dateBB.unitId}" value="#{annu_computelistBB.unitId}"/>
                    <x:updateActionListener property="#{wage_dateBB.unitName}" value="#{annu_computelistBB.unitName}"/>
                </h:commandButton>
            </h:panelGroup>
        </h:panelGrid>
    </h:panelGrid>
