    ...
    <h:dataTable value="#{wage_dateBB.dateList}" var="list" align="center" id="dateList"
        ...
        <h:column>
            ...
            <h:panelGrid columns="5" align="center" cellspacing="2">
                <h:commandButton value="打开" action="#{annu_computelistBB.queryAnnuBySetId}"
                                 styleClass="button01" >
                    <x:updateActionListener property="#{annu_computelistBB.dateId}" value="#{list.dateId}"/>
                    <x:updateActionListener property="#{annu_computelistBB.payoffDate}" value="#{list.date}"/>
                    <x:updateActionListener property="#{annu_computelistBB.setId}" value="#{wage_dateBB.setId}"/>
                    <x:updateActionListener property="#{annu_computelistBB.unitId}" value="#{wage_dateBB.unitId}"/>
                    <x:updateActionListener property="#{annu_computelistBB.setName}" value="#{wage_dateBB.setName}"/>
                    <x:updateActionListener property="#{annu_computelistBB.unitName}" value="#{wage_dateBB.unitName}"/>
                    <x:updateActionListener property="#{annu_computelistBB.operCompute}" value="#{list.operCompute}"/>
                </h:commandButton>
            </h:panelGrid>
        </h:column>
    </h:dataTable>
