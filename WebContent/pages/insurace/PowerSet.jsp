...
<%
    ...
    if (user == null) {
        ...
        title = "保险项目权限管理";
        url = "/insurace/PowerSetChild.jsf?act=list&unitId=" + unitId;
    }
%>

    <script type="text/javascript" language="javascript">
        function refreshList(unitId, childNum) {
                document.list.location = "/insurace/PowerSetChild.jsf?act=list&unitId=" + unitId;
        }
         with (window) onload = onresize = function(){
            var mainHeight = document.body.offsetHeight - 26;
