...
<%
    ...
    try{
        ...
        String col = dwt.getInsuraceDynCols(user,setId, payoff_id, status);
...
<table width="90%"  class="table03" align="center">
    ...
    %>
        ...
        <table width="90%" border="0" align="center">
    <tr>
        <td align="left">审批人：<%=CommonFuns.filterNull(request.getParameter("approver"))%></td>
        <td align="left"></td>
        <td align="left">复核人： <%=CommonFuns.filterNull(request.getParameter("checker"))%></td>
        <td align="left"></td>
         <td align="left">制表人：<%=CommonFuns.filterNull(request.getParameter("creator"))%></td>
        <td align="left"></td>
