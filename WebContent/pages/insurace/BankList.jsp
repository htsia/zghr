...
%>
    ...
    <script type="text/javascript">
        function foradd() {
            window.showModalDialog("/wage/set/BankEdit.jsf?moduleID="+document.all("form1:moduleID").value+"&setID="+document.all("form1:setID").value, null, "dialogWidth:480px; dialogHeight:400px;center:center;resizable:no;status:no;scroll:no;");
            return true;
        }
        function forModify(bankid) {
            window.showModalDialog("/wage/set/BankEdit.jsf?moduleID="+document.all("form1:moduleID").value+"&setID="+document.all("form1:setID").value+"&bankID="+bankid, null, "dialogWidth:480px; dialogHeight:400px;center:center;resizable:no;status:no;scroll:no;");
            return true;
        }
...
<h:form id="form1">
    ...
    <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
       <h:panelGroup>
        ...
        <h:outputText value=" 保险管理 ->  报盘格式设置"/>
        </h:panelGroup>
    </h:panelGrid>
