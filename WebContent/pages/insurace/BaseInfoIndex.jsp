...
<head>
    ...
    <script type="text/javascript" language="javascript">
        function refreshList(unitId) {
           document.list.location = "/insurace/BaseInfoSet.jsf?act=init&unitId=" + unitId;
        }
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
        <td class="td_title"><img src="/images/tips.gif">缴费基数设定</td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" valign="top" class="explorer" id="showTree" width="210">
                                    <iframe name="tree" frameborder="0"  height="400" scrolling="auto" width="100%"
                    ...
                    <td align="center" valign="top" class="explorer">
                                    <iframe name="list" frameborder="0" height="400" scrolling="no" width="100%"
                                            src="/insurace/BaseInfoSet.jsf?act=init"></iframe>
                    </td>
                </tr>
            </table>
        </td>
