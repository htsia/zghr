...
%>
    ...
    <script type="text/javascript">
        ...
        function doOpenInputPower(setId){
            window.showModalDialog("/insurace/SetInputPower.jsf?setID=" + setId, "", "dialogWidth:500px; dialogHeight:400px; status:0;");
            return false;
        }
        function doOpenBasePower(setId){
            window.showModalDialog("/insurace/SetBasePower.jsf?setID=" + setId, "", "dialogWidth:500px; dialogHeight:400px; status:0;");
            return false;
        }
...
<h:form id="form1">
    ...
    <h:panelGrid align="center" width="95%">
        ...
        <h:dataTable value="#{wage_setBB.setlist}" var="list"  id="dateList"
            ...
            <h:column>
                ...
                <h:panelGrid align="center" columns="1" cellspacing="2">
                    <h:panelGroup>
                        ...
                        <h:commandButton  styleClass="button01" value="基数权限设置" rendered="#{wage_setBB.canModifyDepPower}" onclick="return doOpenBasePower('#{list.setId}');" />
                    </h:panelGroup>
