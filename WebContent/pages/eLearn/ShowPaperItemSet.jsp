...
<%
    ...
    String rootId = request.getParameter("PaperID");
%>
<html>
<head><title></title>
    ...
    <script language="javascript">
        ...
        function showTree(pid) {
            ...
            xmlHttp.open("GET", "../ajax/eLearnPaperItemSet.jsp?superId=" + pid, true);
            xmlHttp.send(null);
        }
        ...
        function parseResults() {
            ...
            var trees = results.getElementsByTagName("PaperItemSet");
            if (superId == "<%=rootId%>") {
