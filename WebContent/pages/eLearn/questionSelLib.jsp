...
<script type="text/javascript">
    ...
    function refreshList(orgId) {
        ...
        document.main.location.href = "/eLearn/QuestionSelList.jsf?superId=" + orgId;
    }
...
<h:form id="form1">
	  <h:inputHidden id="currentID" value="#{eLearn_queryQuestionBB.currentID}"></h:inputHidden>
      <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="1" align="center">
        <h:panelGroup>
            ...
            <h:outputText value="ÌâÄ¿Ñ¡Ôñ"></h:outputText>
        </h:panelGroup>
      </h:panelGrid>
