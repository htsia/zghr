...
　　　　<h:commandButton value="上传软件" onclick="showUpFilePopDialog();" styleClass="button01"/>
        <h:commandButton value="删 除" action="#{eLearn_upFileBB.delectfiles}" styleClass="button01"/>
    </h:panelGrid>
    ...
    <h:dataTable value="#{eLearn_upFileBB.listweb}" var="filelist"  id="dateList"
                 headerClass="td_top" width="100%" columnClasses="td_middle_center" align="center" border="1" styleClass="table03" >
                  ...
                  <f:facet name="header">
                      ...
                      <x:selectOneRadio id="scs" forceId="true" forceIdIndex="false" value="#{eLearn_upFileBB.choseattachid}">
