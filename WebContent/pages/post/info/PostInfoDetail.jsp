...
<h:form id="form1">
    <h:commandLink id="saveOne" action="#{post_editPostBB.saveOne}" style="display:none"/>
    <h:commandLink id="saveManyAdd" action="#{post_editPostBB.saveManyAdd}" style="display:none"/>
    <h:commandLink id="saveManyUpdate" action="#{post_editPostBB.saveManyUpdate}" style="display:none"/>
    <h:commandLink id="back" action="#{post_editPostBB.back}" style="display:none"/>
    <c:verbatim>
