...
%>
    ...
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/post/del/PostDelQuery.jsf?flag=1&superId="+orgId;
        }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif" alt="">
              <%=LanguageSupport.getResource("GWGL-0218"," ¸ÚÎ»É¾³ý")%> 
           </td>
        </tr>
    </table>
           ...
           <td width="10" class="ctrlbar" valign="middle">
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                    src="/post/del/PostDelQuery.jsf"></iframe>
            </td>
        </tr>
    </table>
</h:form>
