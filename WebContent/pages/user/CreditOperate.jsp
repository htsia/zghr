...
<script type="text/javascript">
        ...
        function getSelectedNode(nodeName) {
            ...
            document.all("formCreditOperate:selectedNodes").value = selNodes;
            return true;
        }

        function setSelectedNode(nodeName) {
            var selNodes = document.all("formCreditOperate:selectedNodes").value;
...
<h:inputHidden id="pageInit" value="#{SYS_OPERATEBB.pageInit}"/>
    ...
    <tr>
        ...
        <script language="javascript" src="../../js/floater.js"></script>
           <div id="floater" style="position:absolute; width:120px; z-index:1; height: 23px; left: 580px;">
                  ...
                  <h:commandButton id="save" styleClass="button01" value="保存" onclick="return getSelectedNode('checkitem')"  action="#{SYS_OPERATEBB.updateRoleOperate}"></h:commandButton>
<c:verbatim>
            </div>
        </td>
    </tr>
                ...
                <tr>
                    <td bgcolor="#FFFFFF">
                        ...
                        <script language="JavaScript">
                            ...
                            var root = tree.root;
                            var operRoot = tree.addChkNode(root, "last", "权限列表", "0000", "0001", "", "folder", "", "", false, true, 'checkitem', '0000', '0001');

                            <%
                                 List list = (List) request.getAttribute("SYS_OPERATE");
                            ...
                            var pflag = document.all("formCreditOperate:pageFlag").value;
                            if (pflag == "1")  //角色权限设置
                                tree.oncheck = checkall;
                            else{          //用户权限浏览
                                tree.oncheck = nocheck;
                                document.all("formCreditOperate:save").style.display = "none";
                            }
                        </script>
                    </td>
                </tr>
