...
<h:inputHidden id="pageInit" value="#{user_selRoleListBB.singleAssign}"/>
<f:verbatim>
...
<h:dataTable value="#{user_selRoleListBB.roleinfos}" var="list" width="97%"
    ...
    <h:column>
        ...
        <f:verbatim escape="false">
            <div align="center"> <input type="checkbox" name="selectItem" </f:verbatim><h:outputText value="#{list.isHave}"/><f:verbatim> sysOper="</f:verbatim><h:outputText value="#{list.sysOper}"/><f:verbatim>" value="</f:verbatim>
