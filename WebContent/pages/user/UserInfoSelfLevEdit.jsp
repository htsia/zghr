...
<%@ include file="../include/taglib.jsp" %>
    ...
    <h:form id="formUserInfoEdit" >
        ...
        <table width="100%" border="0" cellspacing="6" cellpadding="0" align="center">
            <tr>
                <td class="td_title">修改自助权限</td>
            </tr>
        </table>

        <table width="98%" border="0" align="center" cellpadding="5" cellspacing="0">
            <tr>
                <td width="40%" height="24" class="td_form01">自助信息查看级别</td>
...
<c:verbatim>
            ...
            <tr>
                <td colspan="2" align="right">
                    ...
                    <h:commandButton styleClass="button01" onclick="return forsubmit(document.forms(0))" action="#{user_userInfoBB.updateUserInfoLevel}" value="保存"></h:commandButton>
