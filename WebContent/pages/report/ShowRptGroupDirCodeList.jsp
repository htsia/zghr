...
<%
  ...
  if( request.getParameter("parentGroupId") != null && !"".equals( request.getParameter("parentGroupId")  )){
    	parentGroupId =  request.getParameter("parentGroupId");
    }else{
       parentGroupId =  (String)session.getAttribute("parentGroupId");
  }
%>
<html>
<head><title></title>
    ...
    <script language="javascript">
        ...
        function showTree(pid) {
            ...
            xmlHttp.open("GET", "../ajax/RptGroupDirList.jsp?superId="+pid+"&parentGroupId=<%=parentGroupId%>",  true);
            xmlHttp.send(null);
        }
