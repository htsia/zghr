...
%>
    ...
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/system/DeletePersonQuery.jsf?&flag=1&superId=" + orgId;
        }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif">
               <%=LanguageSupport.getResource("XTGL-1011","   删除人员(注意:删除后无法恢复!)")%>  
             </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0"  scrolling="no" width="100%"
                                   src="/system/DeletePersonQuery.jsf"></iframe>
            </td>
        </tr>
    </table>
</h:form>
