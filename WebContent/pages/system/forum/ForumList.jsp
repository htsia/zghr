...
<script language="javascript">
    ...
    function openQuestion(ID){
        window.showModalDialog("/system/OpenQuestion.jsf?hitAdd=true&fomID="+ID, null, "dialogWidth:"+screen.width*0.75+"px; dialogHeight:"+screen.height*0.75+"px;center:center;resizable:no;status:no;scroll:no;");
        return true;
    }
</script>
         ...
         <tr><td height=8>
            ...
            <h:panelGrid align="center" styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
                <h:panelGroup>
                  ...
                  <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1311","论坛")%> 
                 </f:verbatim>
                </h:panelGroup>
           ...
           <div style='width:100%;height:100%;overflow:auto' id=datatable>
            ...
            <h:dataTable value="#{self_forumListBB.forumList}" var="list" width="100%"  id="dateList"
                ...
                <h:column>
                    <f:facet name="header">
                <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1312","发帖日期")%> 
                 </f:verbatim>
                    </f:facet>
                ...
                <h:column>
                    ...
                    <h:outputText style="width:80px" value="#{list.nickName}" />
                </h:column>
                ...
                <h:column>
                    ...
                    <h:outputText style="width:80px" value="#{list.ansCounter}" />
                </h:column>
                ...
                <h:column>
                    ...
                    <h:outputText style="width:80px" value="#{list.hiteCounter}" />
                </h:column>
                ...
                <h:column>
                    ...
                    <h:commandButton value="打开" styleClass="button01" onclick="return openQuestion('#{list.fomID}');"></h:commandButton>
                </h:column>
            </h:dataTable>
<c:verbatim>
           </div>
