...
<x:saveState value="#{self_forumEditBB}"/>
      ...
      <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="1">
           <h:panelGroup>
                <h:graphicImage value="/images/tips.gif" />
                 <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1308","发新帖")%> 
                 </f:verbatim>
           </h:panelGroup>
       </h:panelGrid>
        ...
        <h:panelGrid border="0" columns="2" align="center" cellspacing="2"    cellpadding="10"	columnClasses="td_form01,td_form02" styleClass="table03">
                <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1309","署名方式")%> 
                 </f:verbatim>
            <h:selectOneMenu value="#{self_forumEditBB.nameStyle}">
			...
			<h:inputText id="text1" styleClass="input" value="#{self_forumEditBB.fqbo.subject}" size="80" maxlength="50"/>

			 <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1111","内容")%> 
            </f:verbatim>
			<h:inputTextarea id="textarea" rows="15" cols="80"	value="#{self_forumEditBB.fqbo.content}"/>
		</h:panelGrid>
		<f:verbatim>
			<br>
		</f:verbatim>
        ...
        <h:panelGrid border="0" columns="2" cellpadding="8" align="right">
			<h:commandButton value="保存" action="#{self_forumEditBB.saveNewQuestion}" styleClass="button01" />
