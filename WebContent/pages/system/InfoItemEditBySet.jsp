...
<h:inputHidden id="pageInit" value="#{sys_infoItemEditBB.initEdit}"></h:inputHidden>
...
<h:panelGrid columns="2" width="20%" cellpadding="0"
    ...
    <h:commandButton value="返 回"  styleClass="button01" type="button" onclick="window.close();"/>
</h:panelGrid>
</h:panelGrid>
<script type="text/javascript">
	forDataType(2);
