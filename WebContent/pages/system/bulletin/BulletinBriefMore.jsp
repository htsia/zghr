...
<script type="text/javascript">
    function refreshList(orgId) {
        document.main.location.href = "/system/BulletinBriefMoreChild.jsf?superId=" + orgId;
    }
	  ...
	  <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="1" align="center">
        <h:panelGroup>
            <h:graphicImage value="/images/tips.gif" />
               <f:verbatim>
                     <%=LanguageSupport.getResource("XTGL-1292","公告信息列表")%> 
               </f:verbatim>
        </h:panelGroup>
      </h:panelGrid>
      <c:verbatim>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="no" width="100%"
                        src="/system/BulletinBriefMoreChild.jsf"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
