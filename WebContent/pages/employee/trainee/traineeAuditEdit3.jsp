		...
		<h:panelGrid width="100%" columns="1">
			<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
	    	 <f:verbatim>
	            ...
	            <h:selectOneMenu id="status" value="#{empTraineeAuditMgrBB.changBo.auditResult2}">
	          ...
	          <f:verbatim>
	            ...
	            <h:inputTextarea value="#{empTraineeAuditMgrBB.changBo.auditOption2}" rows="3" cols="60"/>
	
	           <f:verbatim>
	    	     <%=LanguageSupport.getResource("YXGL-1026", "操作")%>       
	    	    </f:verbatim>
	            <h:commandButton styleClass="button01" value="审批" action="#{empTraineeAuditMgrBB.audit2}" onclick="checkData()"/>
	    	</h:panelGrid>
