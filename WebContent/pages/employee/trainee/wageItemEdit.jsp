...
function forCopyPersonItem(){
  ...
  <x:saveState value="#{empTraineeWageMgrBB}" />
  <h:form id="form1">
      <h:inputHidden id="initEdit" value="#{empTraineeWageMgrBB.initEdit}"></h:inputHidden>
      <f:verbatim>
    ...
    <tr>
        ...
        <%=LanguageSupport.getResource( "RYGL-2223", "D级员工转正")%>
        </td>
    </tr>
</table>
...
<tr nowrap>
    ...
    <td class="td_form02">
         ...
         <h:inputText value="#{empTraineeWageMgrBB.itembo.fieldId}" readonly="true"></h:inputText>
	<f:verbatim>
	</td>
</tr>
<tr nowrap>
    ...
    <td class="td_form02">
        ...
        <h:inputText value="#{empTraineeWageMgrBB.itembo.fieldDes}" readonly="true"></h:inputText>
	<f:verbatim>
	</td>
</tr>
<tr nowrap>
    <td class="td_form01" ><%=LanguageSupport.getResource( "JGGL-1100", "原值")%></td>
   <%
...
<tr><td align="right">
		 ...
		 <h:commandButton value="保存"  action="#{empTraineeWageMgrBB.saveItem}" styleClass="button01" onclick="checkform()"/>
<f:verbatim>
</td></tr>
</table>
</f:verbatim>	
