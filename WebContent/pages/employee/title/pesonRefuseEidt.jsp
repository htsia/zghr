...
<h:form id="form1" >
      <h:inputHidden id="initEdit" value="#{emptitledeptAduitmgrBB.initRefuseEdit}"></h:inputHidden>
      ...
      <h:panelGrid columns="1"  width="98%" align="left">
           <h:panelGrid columns="2" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
               ...
               <h:outputText value="退回原因"></h:outputText>
               <h:inputTextarea value="#{emptitledeptAduitmgrBB.itembo.refuseReson}" cols="50" rows="5" readonly="#{emptitledeptAduitmgrBB.edit=='false'}">
               </h:inputTextarea>
           </h:panelGrid>
           <h:panelGrid align="right">
              <h:commandButton value="退回" id="save" action="#{emptitledeptAduitmgrBB.refuseItem}"   styleClass="button01" onclick="javascript:return chkData()" rendered="#{emptitledeptAduitmgrBB.edit=='true'}"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
<script type="text/javascript">
