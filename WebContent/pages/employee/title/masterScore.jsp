...
<h:form id="form1">
	<h:inputHidden value="#{emptitleapplyAduitBB.inintScore}"></h:inputHidden>
	<c:verbatim>
		<table height=98% width=98% align="center">
			<tr>
				<td height="10" align="right" valign="top"></c:verbatim> <h:panelGrid
					...
					<h:panelGroup>
						...
						<h:commandButton value="首页" action="#{emptitleapplyAduitBB.first2}"
							styleClass="button01"></h:commandButton>
						<h:commandButton value="上页" action="#{emptitleapplyAduitBB.pre2}"
							styleClass="button01"></h:commandButton>
						<h:commandButton value="下页" action="#{emptitleapplyAduitBB.next2}"
							styleClass="button01"></h:commandButton>
						<h:commandButton value="尾页" action="#{emptitleapplyAduitBB.last2}"
							styleClass="button01"></h:commandButton>
					</h:panelGroup>
			...
			<tr>
				...
				</c:verbatim> <x:dataTable value="#{emptitleapplyAduitBB.scoreList}"
