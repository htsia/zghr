...
<script language="javascript">
    ...
    for(int i=0;i<list.size();i++){
     ...
     if("A703".equals(set.getSetId()) || "A051".equals(set.getSetId()) ||"A850".equals(set.getSetId()) ||"A220".equals(set.getSetId()) ||"A225".equals(set.getSetId()) || "A230".equals(set.getSetId())){
            continue;
         }
    if(!"2".equals(flag)){
