...
%>
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/employee/AppORDismiss/apporDisList.jsf?superId=" + orgId+"&oper=1358";
        }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif"> 
              ...
              <%=LanguageSupport.getResource( "RYGL-2021", "任免审批")%>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/employee/AppORDismiss/apporDisList.jsf?oper=1358"></iframe>
