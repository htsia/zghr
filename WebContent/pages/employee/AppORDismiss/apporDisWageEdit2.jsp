...
<script type="text/javascript">
   function modify(id){
	   window.showModalDialog("/employee/AppORDismiss/wageItemEdit.jsf?itemId="+id, null, "dialogWidth:400px; dialogHeight:300px;center:center;resizable:no;status:no;scroll:yes;");
	   return true;
   }
</script>
...
<h:form id="form1">
    ...
    <x:dataTable value="#{empApporDisWageMgrBB.wageItemList}" var="list" align="center" id="dateList"
        ...
        <h:column>
         ...
         <h:column>
            <c:facet name="header">
            <f:verbatim>
			  	<%=LanguageSupport.getResource( "RYGL-2044", "调整依据")%>
		    </f:verbatim>
            </c:facet>
