       ...
       <table height=98% width=100% align="center">
		...
		<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
    	 <h:outputText value="审批意见"/>
            <h:selectOneMenu id="status" value="#{empApporDisAuditBB.empapporDisbo.auditResult2}">
           ...
           <f:verbatim>
            ...
            <h:inputTextarea value="#{empApporDisAuditBB.empapporDisbo.auditOption2}" rows="3" cols="60"/>

            <f:verbatim>
    	    	<%=LanguageSupport.getResource( "YXGL-1026", "操作")%>
    	   </f:verbatim>
            <h:commandButton styleClass="button01" value="审批" action="#{empApporDisAuditBB.audit2}" onclick="checkData()"/>
    	
    	</h:panelGrid>
    	<h:panelGrid width="100%" columns="4" cellspacing="2" columnClasses="td_form01,td_form02,td_form01,td_form02" styleClass="table03">
    	    	<f:verbatim>
    	    	   <%=LanguageSupport.getResource( "YXGL-2025", "原职务")%>
    	        </f:verbatim>
    	    	<h:panelGroup>
    	    	...
    	    	<f:verbatim>
    	    	   <%=LanguageSupport.getResource( "YXGL-2026", "新职务")%>
    	        </f:verbatim>
    	    	<h:panelGroup>
