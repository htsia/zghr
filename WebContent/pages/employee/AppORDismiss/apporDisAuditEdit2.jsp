       ...
       <table height=98% width=100% align="center">
		...
		<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
    	   <f:verbatim>
            ...
            <h:selectOneMenu id="status" value="#{empApporDisAuditBB.empapporDisbo.auditResult1}">
          ...
          <f:verbatim>
            ...
            <h:inputTextarea value="#{empApporDisAuditBB.empapporDisbo.auditOption1}" rows="3" cols="60"/>

             <f:verbatim>
    	    	<%=LanguageSupport.getResource( "YXGL-1026", "操作")%>
    	   </f:verbatim>
            <h:commandButton styleClass="button01" value="审批" action="#{empApporDisAuditBB.audit1}" onclick="checkData()"/>
    	</h:panelGrid>
