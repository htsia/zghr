...
function checkform() {
  ...
  <h:form id="form1">
      <h:inputHidden id="initEdit" value="#{empbeginnerMgrBB.initPersonEdit}"></h:inputHidden>
      ...
      <h:panelGrid columns="1"  width="98%" align="left">
           <h:panelGrid columns="2" columnClasses="td_form01,td_form02" align="center" styleClass="table03" width="98%">
               ...
               <h:inputText value="#{empbeginnerMgrBB.empbeginnerbo.name}" readonly="true"></h:inputText>
			   <f:verbatim>
			      <%=LanguageSupport.getResource("RYGL-2139", "预计转正日期")%>
			   </f:verbatim>
               <h:inputText value="#{empbeginnerMgrBB.planDate}"></h:inputText>
                <f:verbatim>
			      <%=LanguageSupport.getResource("RYGL-2138", "调整转正日期")%>
			   </f:verbatim>
			   <h:panelGroup>
               <h:inputText styleClass="input" id="date" value="#{empbeginnerMgrBB.empbeginnerbo.planPassDate}"
			...
			<h:panelGrid align="right">
              <h:commandButton value="保存"  action="#{empbeginnerMgrBB.saveEmpBeginnerBO}" styleClass="button01" onclick="checkform()"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
 <script type="text/javascript">
