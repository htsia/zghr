...
function forCopyPersonItem(){
  ...
  <x:saveState value="#{empbeginnerWageMgrBB}" />
  <h:form id="form1">
      <h:inputHidden id="initEdit" value="#{empbeginnerWageMgrBB.initEdit}"></h:inputHidden>
      <f:verbatim>
    ...
    <tr>
        <td class="td_title"><img src="/images/tips.gif">
               ...
               <%=LanguageSupport.getResource("RYGL-2022","转岗管理")%>  
        </td>
    </tr>
</table>
...
<tr nowrap>
    ...
    <td class="td_form02">
         ...
         <h:inputText value="#{empbeginnerWageMgrBB.itembo.fieldId}" readonly="true"></h:inputText>
	<f:verbatim>
	</td>
</tr>
<tr nowrap>
    ...
    <td class="td_form02">
        ...
        <h:inputText value="#{empbeginnerWageMgrBB.itembo.fieldDes}" readonly="true"></h:inputText>
	<f:verbatim>
	</td>
</tr>
<tr nowrap>
...
<tr><td align="right">
		 ...
		 <h:commandButton value="保存"  action="#{empbeginnerWageMgrBB.saveItem}" styleClass="button01" onclick="checkform()"/>
<f:verbatim>
</td></tr>
</table>
</f:verbatim>	
