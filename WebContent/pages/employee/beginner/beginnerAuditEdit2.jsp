		...
		<h:panelGrid width="100%" columns="1">
			<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
	    	  <f:verbatim>
	            ...
	            <h:selectOneMenu id="status" value="#{empbeginnerAuditMgrBB.beginnerbo.auditResult1}">
	            ...
	            <h:inputTextarea value="#{empbeginnerAuditMgrBB.beginnerbo.auditOption1}" rows="3" cols="60"/>
	
	            <f:verbatim>
	    	       <%=LanguageSupport.getResource("YXGL-1026","操作")%>    
	    	    </f:verbatim>
	            <h:commandButton styleClass="button01" value="审批" action="#{empbeginnerAuditMgrBB.audit1}" onclick="checkData()"/>
	    	</h:panelGrid>
    	    <h:panelGrid width="100%" columns="4" cellspacing="2" columnClasses="td_form01,td_form02,td_form01,td_form02" styleClass="table03">
    	    	...
    	    	<h:panelGroup>
    	    	 ...
    	    	 <f:verbatim>
	    	       <%=LanguageSupport.getResource("YXGL-2126","转正后岗位级别")%>    
	    	    </f:verbatim>
    	    	<h:panelGroup>
