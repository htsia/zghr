...
<script type="text/javascript">
  function selPost(){
    ...
    <x:saveState value="#{emp_allotstudentBB}"/>
    <h:form id="form1">
        <h:inputHidden value="#{emp_allotstudentBB.pageInit}"/>
        <%
        ...
        <table width=95% align=center border=0 cellpadding=0 cellspacing=0>
            <tr><td colspan=4> <strong>分配如下学员：</strong><br>
               <%
                   String UnitID="";
                   String Namelist="";
             ...
             <tr nowrap>
                ...
                <td class="td_form02" colspan="3">
                    ...
                    <h:inputText styleClass="input" id="A016030" value="#{emp_allotstudentBB.chgs}" dict="yes" dict_num="OU"  code=""
...
<c:verbatim>
        ...
        <h:inputText styleClass="input" id="A001715" value="#{emp_allotstudentBB.posts}" dict="yes" dict_num="PO"  code=""
        ...
        <table width=95% border=0 align=center cellpadding=0 cellspacing=0 >
            <tr>
                <td align="center">
                      ...
                      <h:commandButton id="save" styleClass="button01" value="保存" onclick="return forsubmit(document.forms(0))" action="#{emp_allotstudentBB.saveDispatch}" /></td>
<c:verbatim>
            </tr>
        </table>
 </c:verbatim>
