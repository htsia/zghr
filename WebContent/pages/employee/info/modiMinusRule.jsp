...
<%@ page import="com.hr319wg.sys.configuration.LanguageSupport" %>
    ...
    <script language="javascript">
        ...
        function forSel() {
            PopUpMutilCodeDlgNoSubmit('form1:classvalue', 'form1:classvaluedes', '0200','0200120001');
            return false;
        }
...
<h:form id="form1">
    ...
    <f:verbatim><br>
        <table width="96%" height="97%" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="center" width="25%" class=activetab><img src="/images/common/handtip.gif">&nbsp;<a href="modiMinusRule.jsf?Init=true"><%=LanguageSupport.getResource("RYGL-2318","减少设置")%> </a></td>
            ...
            <h:panelGrid align="right" width="100%" cellpadding="0" cellspacing="2" columns="1">
               <h:panelGroup>
                <h:commandButton id="set" styleClass="button01" value=" 设置 "
                                 ...
                                 action="#{emp_OrgSumItemSetBB.addMinusItem}"/>
    ...
    <h:dataTable styleClass="table03" align="center" width="95%"    id="dateList"
                 ...
                 value="#{emp_OrgSumItemSetBB.minusitemBos}"
                 var="list" border="1">
        <h:column>
            <f:facet name="header">
