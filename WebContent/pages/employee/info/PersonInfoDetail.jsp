...
<h:form id="form1">
    ...
    <h:commandLink id="saveOne" action="#{emp_personEditBB.saveOne}" style="display:none"/>
    <h:commandLink id="saveManyAdd" action="#{emp_personEditBB.saveManyAdd}" style="display:none"/>
    <h:commandLink id="saveManyUpdate" action="#{emp_personEditBB.saveManyUpdate}" style="display:none"/>
    <h:commandLink id="back" action="#{emp_personEditBB.back}" style="display:none"/>
     <h:commandLink id="refreshDataButton" action="" style="display:none"/>
    <c:verbatim>
