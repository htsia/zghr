...
<h:form id="form1">
<h:inputHidden value="#{emp_baseInputBB.pageInit}"/>
    <c:verbatim><br></c:verbatim>
    <h:panelGrid columns="2" width="95%"  styleClass="table03" align="center" columnClasses="td_top,td_top">

        <h:outputText value="选择输入项："/>
        <h:selectManyCheckbox value="#{emp_baseInputBB.selectFields}" layout="pageDirection" id="inputField">
            <c:selectItems value="#{emp_baseInputBB.fieldsList}"/>
    ...
    <h:panelGrid columns="4" cellspacing="3" align="right">
        ...
        <h:commandButton styleClass="button01" value="确认" action="#{emp_baseInputBB.queryPersonInput}"
    ...
    <h:panelGrid columns="1" cellspacing="0" align="center" width="95%" >
        ...
        <h:dataTable value="#{emp_baseInputBB.personlist}" var="list" id="dateList"
