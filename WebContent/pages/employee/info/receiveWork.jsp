...
<head>
    ...
    <script type="text/javascript">
        function doProcess(ID){
            window.showModalDialog("/employee/info/doReceiveWork.jsf?personID="+ID, null, "dialogWidth:350px; dialogHeight:250px;center:center;resizable:no;status:no;");
            return true;
        }
    </script>
</head>
...
<h:form id="form1">
    <h:inputHidden id="fromOrgEdit" value="#{emp_WorkImportBB.receiveList}"/>
    ...
    <br>
    <h:dataTable value="#{emp_WorkImportBB.personList}" var="list" align="center"
          ...
          <%=LanguageSupport.getResource("RYGL-2148","处理日期") %>
            ...
            <%=LanguageSupport.getResource("YXGL-1026","操作") %>
                ...
                <h:panelGroup>
                    <h:commandButton styleClass="button01" action="#{emp_WorkImportBB.doqueryReceive}"  value="办理接收" onclick="doProcess('#{list.personid}')"></h:commandButton>
                </h:panelGroup>
            </h:column>
