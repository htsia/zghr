...
<f:verbatim>
    ...
    <tr nowrap>
         ...
         <h:outputText value="调动部门至(不选表示不调动)" />
    <f:verbatim>
         </td>
        <td colspan="3" class=td_form02>
    </f:verbatim>
        ...
        <table width=95% border=0 align=center cellpadding=0 cellspacing=0 >
            <tr>
                <td align="left">
                  ...
                  <h:outputText value="加入离职黑名单" rendered="#{sys_commonInfoBB.enableBlackSheet}"></h:outputText>
<f:verbatim>
               </td>
               <td align="right">
</f:verbatim>
 ...
 <f:verbatim>
             ...
             <tr><td>
                 ...
                 <h:outputText value="原因：" rendered="#{sys_commonInfoBB.enableBlackSheet}"></h:outputText>
