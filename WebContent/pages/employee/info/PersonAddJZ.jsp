...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td class="td_title"><img src="/images/tips.gif"> 
          ...
          <%=LanguageSupport.getResource("RYGL-2346", "增加人员 ")%> ->       
            </td>
...
<table  width=840 align=center border=0 cellpadding=0 cellspacing=0 class="table03">
    <tr nowrap>
    <td class="td_form01 td_form_required"><%= LanguageSupport.getResource("RYGL-2347", "主管部门")%></td>
    <td class=td_form02 >
</f:verbatim>
...
<table  width=840 align=center border=0 cellpadding=0 cellspacing=0 class="table03">
<tr>
    <td class=td_form01><%=LanguageSupport.getResource("RYGL-2360", "现居住地区")%></td>
    <td class=td_form02>
</f:verbatim>
     <h:inputText styleClass="input" id="A080722" code="" dict="yes" dict_num="0105"
             readonly="true" value="#{emp_personAddBB.personvo.homeArea}"
             alt="A080722|1|s|50||"/>

<f:verbatim>
     <input type="button" class="button_select" onclick="PopUpCodeDlgOneControl('form1:A080722')">
    </td>

    <td class=td_form01 width="80"><%=LanguageSupport.getResource("RYGL-2358", "家庭住址")%></td>
    <td class=td_form02 colspan=3>
</f:verbatim>
        <h:inputText style="width:280px" value="#{emp_personAddBB.personvo.homeAddress}"/>
<f:verbatim>
    </td>
</tr>

    <tr>
        <td class="td_form01" width="80"><%=LanguageSupport.getResource("RYGL-2357", "工作单位")%></td>
        <td class=td_form02 width="180">
    </f:verbatim>
    ...
    <table width=840 align=center border=0 cellpadding=0 cellspacing=0>
            <tr nowrap>
                <td class="f05"><%=LanguageSupport.getResource("RYGL-2354", "原军队情况")%></td>
            </tr>
    </table>
    <br>
...
<table width=840 align=center border=0 cellpadding=0 cellspacing=0 class="table03">
    <tr>
        <td class="td_form01" width="100"><%=LanguageSupport.getResource("RYGL-2353", "原所在部队")%></td>
        <td class=td_form02 width="180">
    </f:verbatim>
        <h:inputText   value="#{emp_personAddBB.returnDep}"/>
    <f:verbatim>
        </td>

        <td class="td_form01" width="100"><%=LanguageSupport.getResource("RYGL-2352", "原部队职务")%></td>
        <td class=td_form02 width="180">
    </f:verbatim>
        <h:inputText   value="#{emp_personAddBB.returnDuty}"/>

    <f:verbatim>
        </td>
        <td class="td_form01" width="100"><%=LanguageSupport.getResource("RYGL-2351", "原部队职务级别")%></td>
        <td class=td_form02 width="180">
    </f:verbatim>
        <h:inputText styleClass="input" id="A076735" code="" dict="yes" dict_num="2229"
                readonly="true" value="#{emp_personAddBB.returnDutyLevel}"
                alt="原部队职务级别|1|s|50||"/>

    <f:verbatim>
        <input type="button" class="button_select" onclick="PopUpCodeDlgOneControl('form1:A076735')"></td>
    </tr>

        <tr>
            <td class="td_form01"><%=LanguageSupport.getResource("RYGL-2350", "入伍时间")%></td>
            <td class=td_form02>
            </f:verbatim>
            <h:inputText styleClass="input" id="A076705" value="#{emp_personAddBB.enterTime}"
                         readonly="true" alt="入伍时间|1|d|50||"/>
            <f:verbatim>
            <input type="button" class="button_select" onclick="PopUpCalendarDialog('form1:A076705')">
            </td>

            <td class="td_form01"><%=LanguageSupport.getResource("RYGL-2344", "批准复转时间")%></td>
                <td class=td_form02>
        </f:verbatim>
                    <h:inputText styleClass="input" id="A076710" value="#{emp_personAddBB.returnTime}"
                                 readonly="true" alt="批准复转时间|1|d6|50||"/>
        <f:verbatim>
    ...
    <tr>
        <td align="right">
            ...
            <h:commandButton value=" 下一步 " onclick="javascript:return forSave()" styleClass="button01"
                             action="#{emp_personAddBB.createPersonJZ}"/>&nbsp;&nbsp;
