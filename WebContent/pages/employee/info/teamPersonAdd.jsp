...
<h:form id="form1">
    ...
    <c:verbatim>
        ...
        <tr><td height=8 align="right">
            ...
            <h:commandButton value="首页" action="#{teamMgrBB.addfirst}" styleClass="button01"></h:commandButton>
            <h:commandButton value="上页" action="#{teamMgrBB.addpre}" styleClass="button01"></h:commandButton>
            <h:commandButton value="下页" action="#{teamMgrBB.addnext}" styleClass="button01"></h:commandButton>
            <h:commandButton value="尾页" action="#{teamMgrBB.addlast}" styleClass="button01"></h:commandButton>
            <h:outputText value="  "></h:outputText>
           <h:commandButton value="确定" styleClass="button01"  onclick="doOK();" action="#{teamMgrBB.addPerson}"></h:commandButton>
           <h:commandButton value="保存" styleClass="button01"   onclick="doCancel();"></h:commandButton>
    <c:verbatim>
        </td></tr>
        ...
        <h:dataTable value="#{teamMgrBB.addPersonList}" var="list" width="100%" id="dateList"
                    ...
                    <h:column>
                        <f:facet name="header">
                           <f:verbatim>
                               <%=LanguageSupport.getResource("RYGL-2399","机构")%> 
                            </f:verbatim>
                        </f:facet>
                    ...
                    <f:facet name="header">
                     <f:verbatim>
                               <%=LanguageSupport.getResource("RYGL-2400","岗位")%> 
                            </f:verbatim>
                    </f:facet>
