...
<script type="text/javascript">
    ...
    function doOpenWorkLetter() {
         var ret=window.showModalDialog("/employee/chg/BasicOpenWorkLetter.jsf?Init=true", null, "dialogWidth:"+screen.width*0.85+"px; dialogHeight:"+screen.height*0.85+"px;center:center;resizable:no;status:no;");
         return true;
    }
    ...
    function OpenRptOrFlow(id){
        ...
        %>
        var url="/pages/report/RollORFlowReportShow.jsp?RptCode="+document.all("form1:ReportID").value+"&ID="+id+"&Title=WL_"+orguid+id;
        window.open(url);
        return false;
    }
...
<h:form id="form1">
    <h:inputHidden value="#{emp_letterBB.initBasicWrok}"></h:inputHidden>
    <c:verbatim>
        ...
        <table><tr>
            <td>
                ...
                <h:selectOneMenu id="ReportID" style="width:190px">
                    <c:selectItems value="#{emp_letterBB.baseworkReport}"/>
                </h:selectOneMenu>
<c:verbatim>
            </td>
            <td>
            ...
            <h:dataTable value="#{emp_letterBB.letterList}" var="list" width="100%"
                ...
                <h:column >
                    <c:facet  name="header">
                     ...
                     <h:commandButton value="修改编号"  styleClass="button01" onclick="ModifyNo('#{list.chgId}');"></h:commandButton>
                     <h:commandButton value="打印" type="button" styleClass="button01" onclick="OpenRptOrFlow('#{list.chgId}');"></h:commandButton>
                </h:column>
