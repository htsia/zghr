...
<base target="_self">
<h:form id="form1">
    <h:inputHidden id="pageInit" value="#{emp_letterBB.initbasicEditNo}"/>
    <h:inputHidden  value="#{emp_letterBB.letterType}"/>
    <table>
    <tr><td align="right">
         <h:commandButton value="±£´æ" styleClass="button01" action="#{emp_letterBB.modiBasicLetterNo}"/>
     </td></tr>
     <tr><td>
        <h:panelGrid columns="2" width="100%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
            ...
            <h:outputText id="oldname" value="#{emp_letterBB.changeinfo.fromletterno}" />
