...
<c:verbatim>
    <script type="text/javascript">
        function refreshList(orgId) {
        	document.main.location.href = "/employee/personAdjustInfoQuery.jsf?superId=" + orgId;
        }
...
<h:form id="form1">
    ...
    <table  width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <%=CodeUtil.interpertCode(CodeUtil.TYPE_OPERATER, "1316") %>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top" height="100%">
                 <iframe name="main" height="100%"  frameborder="0"  height="100%" scrolling="no" width="100%"
                     src="/employee/personAdjustInfoQuery.jsf?act=init&superId=<%=user.getOrgId()%>"></iframe>
            </td>
        </tr>
    </table>
    </f:verbatim>    
