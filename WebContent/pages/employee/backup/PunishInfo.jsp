...
<table align="center" width="645" border="0" cellspacing="0" cellpadding="0">
    <tr height="43">
        <td align="right" height="43" style="font-size:14.0pt"><input type="button" value='<%=LanguageSupport.getResource( "RYGL-2100", "导出并打印")%>'
                                                                      onclick="window.open('/pages/employee/backup/PublishInfoExcel.jsf?chk='+document.forms(0).id.value)"/>
        </td>
    </tr>
</table>
<%
