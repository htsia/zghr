...
%>
        ...
        <p align="center"  style="font-size:14.0pt"><b>
           <%=LanguageSupport.getResource( "RYGL-2052", "基本情况表")%>
       </b></p>
...
<tr height="35">
    ...
    <td align="center" width="82" style="font-size:9.0pt;border:1px solid #555555;"><%=LanguageSupport.getResource( "MSG-0013", "出生日期")%><b></b></td>
...
<tr height="35">
    <td align="center" width="81" style="font-size:9.0pt;border:1px solid #555555;"><b><%=LanguageSupport.getResource( "MSG-0012", "后备人才培养方向")%></b></td>
    <td align="center" colspan="3" width="299" style="border:1px solid #555555;">&nbsp;</td>
    <td align="center" width="82" style="font-size:9.0pt;border:1px solid #555555;"><b><%=LanguageSupport.getResource( "RYGL-2067", "确定为后备人才时间")%></b></td>
    <td align="center" colspan="2" width="199" style="border:1px solid #555555;">&nbsp;</td>
</tr>
<%
} else {
...
%>
<tr height="35">
    <td align="center" width="81" style="font-size:9.0pt;border:1px solid #555555;"><b><%=LanguageSupport.getResource( "RYGL-1016", "姓 名")%></b></td>
    <%
...
<tr height="35">
    ...
    <td align="center" width="82" style="font-size:9.0pt;border:1px solid #555555;"><b><%=LanguageSupport.getResource( "RYGL-2071", "最高学位")%></b></td>
...
<tr>
    <td align="center" width="81" style="font-size:9.0pt;border:1px solid #555555;"><b><%=LanguageSupport.getResource( "MSG-0012", "主要家庭成员及社会关系情况")%></b></td>
    <td align="center" colspan="6" style="font-size:9.0pt;border:1px solid #555555;">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table03">
            <tr>
                ...
                <td align="center" style="font-size:9.0pt;border:1px solid #555555;" width="43"><b><%=LanguageSupport.getResource( "MSG-0012", "性别")%></b></td>
            ...
            <tr>
                ...
                %>
                <td align="center" width="102" style="font-size:9.0pt;">&nbsp;</td>
                <%
                } else {
                %>
                ...
                %>
                <td align="center" width="49" style="font-size:9.0pt;">&nbsp;</td>
                <%
                } else {
                %>
                ...
                %>
                <td align="center" width="43" style="font-size:9.0pt;">&nbsp;</td>
                <%
                } else {
                %>
                <td align="center"   style="font-size:9.0pt;"
