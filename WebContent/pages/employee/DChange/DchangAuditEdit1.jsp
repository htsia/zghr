       ...
       <table height=98% width=100% align="center">
		...
		<h:panelGrid width="100%" columns="1">
			<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
	            ...
	            <h:selectOneMenu id="status" value="#{empDchangeAuditMgrBB.empTypeChangebo.auditResult}">
	            ...
	            <h:inputTextarea value="#{empDchangeAuditMgrBB.empTypeChangebo.auditOption}" rows="3" cols="60"/>
	
	             <f:verbatim>
	    	     <%=LanguageSupport.getResource("YXGL-1026", " 操作")%>
	    	    </f:verbatim>
	            <h:commandButton styleClass="button01" value="审批" action="#{empDchangeAuditMgrBB.audit}" onclick="checkData()"/>
	    	</h:panelGrid>
