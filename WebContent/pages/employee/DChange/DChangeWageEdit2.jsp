    ...
    <h:panelGrid width="98%" columns="2">
          <h:panelGrid align="right" columns="2">
            ...
            <f:verbatim>
	            ...
	            <h:commandButton value="首页" action="#{empDchangeWageMgrBB.first}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{empDchangeWageMgrBB.pre}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{empDchangeWageMgrBB.next}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{empDchangeWageMgrBB.last}" styleClass="button01"></h:commandButton>
            </h:panelGroup>
