    ...
    <h:form id="form1">
        ...
        <table width=95% align=center border=0 cellpadding=0 cellspacing=0>
            ...
            <%=LanguageSupport.getResource("RYGL-2049", " 人员姓名 ")%>
               ...
               <h:commandButton styleClass="button01" value="选择" onclick="return fPopUpBackPerTreeDlg('');" action="#{empDchangeMgrBB.selPerson}" />
<c:verbatim>
               </td>
            </tr>
            <tr nowrap>
...
<c:verbatim>
                ...
                <td class=td_form01> <%=LanguageSupport.getResource("RYGL-2222", "转正后岗位")%></td>
                <td class=td_form02 >
</c:verbatim>
        ...
        <table width=95% border=0 align=center cellpadding=0 cellspacing=0 whdth='100%'>
            <tr>
                <td align="right">
                    ...
                    <h:commandButton id="save" styleClass="button01" value="保存" onclick="checkData()" action="#{empDchangeMgrBB.save}" /></td>
<c:verbatim>
            </tr>
        </table>
</c:verbatim>
