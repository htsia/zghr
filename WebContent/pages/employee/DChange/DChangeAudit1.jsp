...
%>
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/employee/DChange/DChangeList.jsf?superId=" + orgId+"&oper=1382";
        }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif"> 
               ...
               <%=LanguageSupport.getResource("RYGL-2224", "D级员工转正审批 ")%>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/employee/DChange/DChangeList.jsf?oper=1382"></iframe>
