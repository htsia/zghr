				...
				<td height=8></c:verbatim> <h:panelGrid width="98%" columns="2">
						<h:panelGrid align="right" columns="2">
							<h:panelGroup>
								...
								<h:outputText
									value="#{empprobastionWageMgrBB.mypage.totalRecord}"></h:outputText>
								...
								<h:outputText
									value="#{empprobastionWageMgrBB.mypage.currentPage}"></h:outputText>
								<f:verbatim>
									<%=LanguageSupport.getResource(
										"COMM-1047", "页")%>
								</f:verbatim>
								...
								<h:commandButton value="首页"
									action="#{empprobastionWageMgrBB.first}" styleClass="button01"></h:commandButton>
								<h:commandButton value="上页"
									action="#{empprobastionWageMgrBB.pre}" styleClass="button01"></h:commandButton>
								<h:commandButton value="下页"
									action="#{empprobastionWageMgrBB.next}" styleClass="button01"></h:commandButton>
								<h:commandButton value="尾页"
									action="#{empprobastionWageMgrBB.last}" styleClass="button01"></h:commandButton>
							</h:panelGroup>
			...
			<tr>
				<td>
					<div style='width: 100%; height: 100%; overflow: auto' id=datatable>
						...
						<x:dataTable value="#{empprobastionWageMgrBB.wageItemList}"
							...
							<h:column>
								...
								<h:commandButton value="删除" rendered="false" onclick="return confirm('确定要删除吗?');"
									action="#{empprobastionWageMgrBB.delete}" styleClass="button01">
									<x:updateActionListener
										property="#{empprobastionWageMgrBB.itemId}"
										value="#{list.adjustID}" />
								</h:commandButton>
							</h:column>
						</x:dataTable>
