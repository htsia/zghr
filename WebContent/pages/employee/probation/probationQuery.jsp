...
<h:form id="form1">
    <h:inputHidden id="pageInit" value="#{empprobastionmgrBB.queryInit}"/>
    ...
    <table height=96% width=100%>
     <tr><td height=8>
        <table width="95%"  >
            ...
            <h:outputText value="当前机构：#{empprobastionmgrBB.orgName}"/>
            <h:outputText escape="false" value="<strong>  姓名、简拼或编号:</strong>"/>
            <h:inputText value="#{empprobastionmgrBB.name}" size="15"/>

            <h:outputText escape="false" value="<strong>预计转正时间:</strong>"/>
            <h:inputText value="#{empprobastionmgrBB.time}" id="time" readonly="true" alt="日期|1|d|50||" size="15"/>
 			<f:verbatim>
 			...
 			<h:inputText value="#{empprobastionmgrBB.time2}" id="time2" readonly="true" alt="日期|1|d|50||" size="15"/>
 			<f:verbatim>
            ...
            <td align="right">
                ...
                <h:outputText value="#{empprobastionmgrBB.mypage.totalRecord}"/>
	            <h:outputText value="  "/>
	            <f:verbatim>
				   <%=LanguageSupport.getResource("COMM-1044", "页数")%>:
              	</f:verbatim>
	            <h:outputText value="#{empprobastionmgrBB.mypage.totalPage}"/>
	            <h:outputText value="  "/>
	            <f:verbatim>
					 <%=LanguageSupport.getResource("COMM-1045", "每页有")%>
			    </f:verbatim>
	            <h:outputText value="#{empprobastionmgrBB.mypage.pageSize}"/>
	            <h:outputText value="  "/>
	            <f:verbatim>
			       <%=LanguageSupport.getResource("COMM-1046", "当前为第")%>
				 </f:verbatim>
	            <h:outputText value="#{empprobastionmgrBB.mypage.currentPage}"/>
	            <f:verbatim>
