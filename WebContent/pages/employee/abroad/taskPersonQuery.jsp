...
<h:form id="form1">
    <h:inputHidden value="#{taskSelPersonBB.initAdd}"></h:inputHidden>
    <c:verbatim>
    ...
    <c:verbatim>
        ...
        <tr><td height=8 align="right">
            ...
            <h:inputText id="codValue" value="#{taskSelPersonBB.codValue}"></h:inputText>
            <h:outputText value="  "></h:outputText>
            <h:commandButton value="查询" onclick="check()" action="#{taskSelPersonBB.QueryAddPerson2}" styleClass="button01"></h:commandButton>
            <f:verbatim>
				 <%=LanguageSupport.getResource("COMM-1048", "共")%>:
            </f:verbatim>
    		<h:outputText value="#{taskSelPersonBB.mypage.totalPage}"></h:outputText>
    		 <f:verbatim>
            ...
            <h:outputText value="#{taskSelPersonBB.mypage.pageSize}"></h:outputText>
            <h:outputText value="  "></h:outputText>
            <f:verbatim>
				 <%=LanguageSupport.getResource("COMM-1046", "当前为第")%>:
            </f:verbatim>
            <h:outputText value="#{taskSelPersonBB.mypage.currentPage}"></h:outputText>
              <f:verbatim>
				 <%=LanguageSupport.getResource("COMM-1047", "页")%>:
            </f:verbatim>
            <h:commandButton value="首页" action="#{taskSelPersonBB.addfirst}" styleClass="button01"></h:commandButton>
            <h:commandButton value="上页" action="#{taskSelPersonBB.addpre}" styleClass="button01"></h:commandButton>
            <h:commandButton value="下页" action="#{taskSelPersonBB.addnext}" styleClass="button01"></h:commandButton>
            <h:commandButton value="尾页" action="#{taskSelPersonBB.addlast}" styleClass="button01"></h:commandButton>
            <h:outputText value="  "></h:outputText>
    ...
    <c:verbatim>
        ...
        <h:dataTable value="#{taskSelPersonBB.addPersonList}" var="list" width="100%" id="dateList"
