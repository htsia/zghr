...
<script type="text/javascript">
         function addPerson(){
          var reval = window.showModalDialog("/employee/abroad/personQueryList.jsf?planID="+document.all("form1:planId").value, null, "dialogWidth:1000px; dialogHeight:600px;center:center;resizable:yes;status:yes;scroll:yes;");
