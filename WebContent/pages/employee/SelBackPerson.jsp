...
<head>
    <base target="_self">
    <title>     <%=LanguageSupport.getResource("RYGL-2418","选择人员")%></title>
                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <table>
                                    <tr>
                                        <td><%=LanguageSupport.getResource("RYGL-1016","姓名 ")%> ：<h:inputText id="name" value="#{emp_selPersonBB.name}"
                                                            size="20"/></td>
                                        <td><%=LanguageSupport.getResource("RYGL-2290","所属机构 ")%>：<h:inputText id="org" value="#{emp_selPersonBB.org}"
