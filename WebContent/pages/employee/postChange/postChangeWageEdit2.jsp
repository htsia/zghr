...
<h:form id="form1">
    ...
    <h:panelGrid width="98%" columns="2">
          <h:panelGrid align="right" columns="2">
            <h:panelGroup>
                ...
                <h:outputText value="#{emppostChangeWageMgrBB.mypage.totalRecord}"></h:outputText>
	            ...
	            <h:outputText value="#{emppostChangeWageMgrBB.mypage.currentPage}"></h:outputText>
	            <f:verbatim>
									<%=LanguageSupport.getResource(
										"COMM-1047", "页")%>
								</f:verbatim>
            
	            <h:commandButton value="首页" action="#{emppostChangeWageMgrBB.first}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{emppostChangeWageMgrBB.pre}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{emppostChangeWageMgrBB.next}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{emppostChangeWageMgrBB.last}" styleClass="button01"></h:commandButton>
            </h:panelGroup>
    ...
    <x:dataTable value="#{emppostChangeWageMgrBB.wageItemList}" var="list" align="center" id="dateList"
