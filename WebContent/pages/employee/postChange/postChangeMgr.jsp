...
<h:form id="form1">
    ...
    <f:verbatim>
						  <%=LanguageSupport.getResource("RYGL-0300", "人员管理")%>->
          				  <%=LanguageSupport.getResource("RYGL-2140", "转岗管理")%>
							</td>
							<td class=td_title align="right">
                         </f:verbatim>
                               <h:commandButton value="流程说明" type="button" styleClass="button01" rendered="#{emppostChangeMgrBB.mustApprov}" onclick="showFlowDefine();"/>
                               <h:outputText	value="  ">   </h:outputText>
                               <h:commandButton value="薪酬变动项目设置" styleClass="button01"	onclick="return SetProbation()" />
                            ...
                            <td align="right" class=td_title>
                                   ...
                                   <h:selectBooleanCheckbox value="#{emppostChangeMgrBB.apply}"
									onclick="submit();"
									valueChangeListener="#{emppostChangeMgrBB.queryApply}" />
                                   <h:outputText	value=" " rendered="#{emppostChangeMgrBB.mustApprov}" />
                                   <h:outputText	value="审批" rendered="#{emppostChangeMgrBB.mustApprov}" />
								   <h:selectBooleanCheckbox value="#{emppostChangeMgrBB.apprving}"
									onclick="submit();"
									...
									value="批准" rendered="#{emppostChangeMgrBB.mustApprov}" />
								<h:selectBooleanCheckbox value="#{emppostChangeMgrBB.apprived}"
									onclick="submit();"
								...
								<h:selectBooleanCheckbox value="#{emppostChangeMgrBB.refuse}"
									onclick="submit();"
									valueChangeListener="#{emppostChangeMgrBB.queryRsfuse}"
									rendered="#{emppostChangeMgrBB.mustApprov}" /> <f:verbatim>
							</td>
						</tr>
					</table></td>
			</tr>
                    ...
                    <f:verbatim escape="false">" />
							...
							<h:column>
								...
								<h:commandButton value="查看薪资" styleClass="button01"
									onclick="return selectPerson3('#{list.postChangeId}');"
									rendered="#{list.status!='0'}" />
