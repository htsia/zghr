...
%>
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/employee/postChange/postChangList.jsf?superId=" + orgId+"&OperID="+document.all('form1:operate').value;
        }
...
<h:form id="form1">
    <h:inputHidden value="#{emppostChangeAuditBB.init}"></h:inputHidden>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                    <iframe name="main" height="100%"  frameborder="0"  scrolling="auto" width="100%"
                           src="/employee/postChange/postChangList.jsf"></iframe>
