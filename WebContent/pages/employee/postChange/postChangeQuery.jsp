...
function showTable(changId){
	var rptID= document.all("form1:ReportID").value;
	if(rptID=='-1'){
		alert("请先选择表样");
		return false;
	}
					...
					<table width="95%" borer=1>
						<tr>
							<td align="left">
								...
								<h:outputText escape="false" value="<strong>当前机构：#{emppostChangeMgrBB.orgName}</strong>"/>
					            <h:outputText value="  姓名或编号："/>
					            <h:inputText value="#{emppostChangeMgrBB.name}" size="15"/>
