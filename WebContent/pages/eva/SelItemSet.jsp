...
<%
    ...
    String rootId = request.getParameter("templateID");
%>
<html>
<head>
    <title></title>
    ...
    <script language="javascript">
        ...
        function showTree(pid) {
            ...
            xmlHttp.open("GET", "../ajax/TemplateDefine.jsp?superId=" + pid, true);
            xmlHttp.send(null);
        }
        ...
        function parseResults() {
            ...
            var trees = results.getElementsByTagName("tempLateItemSet");
            if (superId == "<%=rootId%>") {
