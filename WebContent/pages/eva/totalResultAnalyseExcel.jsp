...
<table border="1"  align="center" id="dateList" width="100%">
			<%
				...
				if(firstMode!=null&&!firstMode.equals("")&&superId!=null&&!superId.equals("")){
					if(firstMode.equals(EvaPlanBO.EVA_MODEL_TABLE)||firstMode.equals(EvaPlanBO.EVA_MODEL_ELECTION)){
						objList=objectucc.getObjectsByPlanIdAndOrgId(null,firstPlanId,superId);
					}else if(firstMode.equals(EvaPlanBO.EVA_MODEL_POST)){
						objList=jobucc.findResultScore(null,firstPlanId,superId);
					}else if(firstMode.equals(EvaPlanBO.EVA_MODEL_TASK)){
						objList=taskucc.getTaskResultScore(null,firstPlanId,superId);
					}
				}
			%>
			<%
