...
<h:form id="form1">
    <h:inputHidden value="#{evaTeamSetBB.initTeamMaster}"></h:inputHidden>
    <h:inputHidden id="objectID" value="#{evaTeamSetBB.objectID}"></h:inputHidden>
    <h:inputHidden id="templateID" value="#{evaTeamSetBB.objectbo.templateID}"></h:inputHidden>
    <c:verbatim>
    ...
    <c:verbatim>
        ...
        <h:selectOneMenu id="masterID" value="#{evaTeamSetBB.masterID}">
            <c:selectItems value="#{evaTeamSetBB.masterList}"></c:selectItems>
        </h:selectOneMenu>
