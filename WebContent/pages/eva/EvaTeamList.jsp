    ...
    <script type="text/javascript">
         function add(rootid){
             if(document.all("form1:templateID").value=="-1"){
            	 ...
            	 var reval=window.showModalDialog("/eva/selTeam.jsf?planId="+document.all("form1:planId").value, null, "dialogWidth:600px; dialogHeight:400px;center:center;resizable:yes;status:yes;scroll:yes;");
            	 if (reval != null && reval!="") {
                     var vars=reval.split("|");
                     document.all("form1:teamIds").value = vars[1];
                     return true;
                 } else {
                     return false;
                 }
         ...
         function setMaster(id){
             window.showModalDialog("/eva/setTeamMaster.jsf?objectID="+id, null, "dialogWidth:600px; dialogHeight:400px;center:center;resizable:yes;status:yes;scroll:yes;");
             return false;
          }
...
<h:form id="form1">
    ...
    <x:dataTable value="#{evaTeamSetBB.objectList}" var="list" rowIndexVar="index" align="center" id="dateList"
       ...
       <h:column>
            ...
            <h:commandButton value="删除"  styleClass="button01" action="#{evaTeamSetBB.delete}">
            	 <x:updateActionListener property="#{evaTeamSetBB.objectID}" value="#{list.objectID}"/>
            </h:commandButton>
       </h:column>
    </x:dataTable>
    <c:verbatim>
