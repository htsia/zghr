...
<x:saveState value="#{evaAimCheckBB}"></x:saveState>
<h:form id="form1">
    <h:inputHidden value="#{evaAimCheckBB.initAdd}"></h:inputHidden>
    <c:verbatim>
        ...
        <tr><td height=8 align="left">
            ...
            <h:outputText value="当前机构：#{evaAimCheckBB.orgName}"></h:outputText>
    <c:verbatim>
        </td></tr>
        ...
        <tr><td height=8 align="right">
            ...
            <h:commandButton value="首页" action="#{evaAimCheckBB.addfirst}" styleClass="button01"></h:commandButton>
            <h:commandButton value="上页" action="#{evaAimCheckBB.addpre}" styleClass="button01"></h:commandButton>
            <h:commandButton value="下页" action="#{evaAimCheckBB.addnext}" styleClass="button01"></h:commandButton>
            <h:commandButton value="尾页" action="#{evaAimCheckBB.addlast}" styleClass="button01"></h:commandButton>
            <h:outputText value="  "></h:outputText>
    ...
    <c:verbatim>
        ...
        <h:dataTable value="#{evaAimCheckBB.addPersonList}" var="list" width="100%" id="dateList"
