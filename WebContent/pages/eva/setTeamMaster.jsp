...
<script type="text/javascript">
    function addMaster(){
        ...
        window.showModalDialog("/eva/addDeptMaster.jsf?objectID="+document.all('form1:objectID').value+"&deptId="+deptId, null, "dialogWidth:500px; dialogHeight:350px;center:center;resizable:yes;status:no;scroll:yes;");
        return true;
    }
</script>
<x:saveState value="#{evaTeamSetBB}"></x:saveState>
<h:form id="form1">
    <h:inputHidden value="#{evaTeamSetBB.initmaster}"></h:inputHidden>
    <h:inputHidden id="objectID" value="#{evaTeamSetBB.objectID}"></h:inputHidden>
    <h:inputHidden id="superId" value="#{evaTeamSetBB.orgId}"></h:inputHidden>
    <c:verbatim>
        ...
        <tr><td height=8 align="left">
            ...
            <h:outputText value="考核客体:#{evaTeamSetBB.teamName}"></h:outputText>
    <c:verbatim>
        </td></tr>
    ...
    <c:verbatim>
        ...
        <h:dataTable value="#{evaTeamSetBB.masterPersonList}" var="list" width="100%" id="dateList"
            ...
            <h:column>
                ...
                <h:commandButton value="删除" styleClass="button01" action="#{evaTeamSetBB.deleteMaster}">
                     <x:updateActionListener property="#{evaTeamSetBB.masterID}" value="#{list.masterID}"/>
                </h:commandButton>
            </h:column>
