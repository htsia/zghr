...
<h:form id="form1">
	<h:inputHidden id="initTemplat" value="#{eva_gradeResultAnalyseBB.initTemplatSelf}"></h:inputHidden>
	...
	<c:verbatim>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="right"></c:verbatim><h:panelGrid align="right" columns="2">
					<h:panelGroup>
						...
						<h:commandButton value="首页"
							action="#{eva_gradeResultAnalyseBB.first1}" styleClass="button01"></h:commandButton>
						<h:commandButton value="上页"
							action="#{eva_gradeResultAnalyseBB.pre1}" styleClass="button01"></h:commandButton>
						<h:commandButton value="下页"
							action="#{eva_gradeResultAnalyseBB.next1}" styleClass="button01"></h:commandButton>
						<h:commandButton value="尾页"
							action="#{eva_gradeResultAnalyseBB.last1}" styleClass="button01"></h:commandButton>
					</h:panelGroup>
			...
			<tr>
				...
				<h:commandButton id="showValue" value="开始分析" styleClass="button01"
					...
					action="#{eva_gradeResultAnalyseBB.doQuerySelf}"></h:commandButton> <c:verbatim></td>
			</tr>
			<tr>
				<td align="center">
				<% 
	...
	<tr>
		...
		<div style='width:100%;height:600px;overflow:auto' id=datatable>
