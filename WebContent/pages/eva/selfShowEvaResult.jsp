...
<h:form id="form1">
    ...
    <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
       <h:panelGroup>
        ...
        <h:outputText value=" 绩效管理 -> 查看考核结果"/>
        </h:panelGroup>
    </h:panelGrid>
    ...
    <h:panelGrid columns="1" align="center" width="98%">
        ...
        <h:column>
            ...
            <h:column>
                ...
                <h:commandButton value="查看结果"  styleClass="button01" onclick="doSetScore('#{list.planId}')" rendered="#{list.evaModel=='0'}">
                </h:commandButton>
                <h:commandButton value="投票情况"  styleClass="button01" onclick="querySelection('#{list.planId}')" rendered="#{list.evaModel=='3'}">
                </h:commandButton>
            </h:column>
