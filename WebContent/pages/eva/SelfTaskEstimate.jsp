...
<f:verbatim>
    <script type="text/javascript">
        function doSetScore(id) {
            window.showModalDialog("/eva/ShowSelfTaskDetail.jsf?planID="+id+"&PersonID="+document.all("form1:personId").value, "", "dialogWidth:"+screen.width*0.6+"px; dialogHeight:"+screen.height*0.6+"px;center:center;resizable:yes;status:yes;scroll:yes;");
            return true;
        }
    </script>
</f:verbatim>
...
<h:form id="form1">
    <h:inputHidden id="pageInit" value="#{selfTaskEstimateBB.pageInit}"/>
	<h:inputHidden id="personId" value="#{selfTaskEstimateBB.personId}"></h:inputHidden>
    ...
    <h:panelGrid columns="1" align="center" width="98%">
        <h:dataTable value="#{selfTaskEstimateBB.planList}" width="100%" var="list" align="center" id="dateList"
