...
<f:verbatim>
	...
	<tr height="10"></tr>
	<tr><td class="td_form01">领导意见</td><td colspan="3" class="td_form02">	
</f:verbatim>		
		<h:inputTextarea value="#{selfTaskEstimateBB.estimatebo.option}" cols="80" rows="3" readonly="#{selfTaskEstimateBB.canEdit}">
		</h:inputTextarea>
<f:verbatim>
	</td></tr>
	<tr height="10"></tr>
