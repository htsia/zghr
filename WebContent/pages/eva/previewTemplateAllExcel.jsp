...
<body>
   <%
       ...
       try {
           ...
           templateList = ucc.getAllTemplate(setId,user.getOrgId());
       }
       catch (Exception e) {
           e.printStackTrace();
       }
   ...
   <%
     if(templateList!=null&&templateList.size()>0){
           ...
           EvaTemplateBO   templatebo=(EvaTemplateBO)templateList.get(m);
   %>
      ...
      <tr><td align="center"><span style="font-size:18px;font-weight:bold;align:center"><%=templatebo.getTemplateName()%></span></td></tr>
       ...
       <tr><td>
           <table class="table02"  align="center" >
               <%
                   List root = ucc.getAllChildItemSet(templatebo.getTemplateID());
