...
<h:form id="form1" enctype="multipart/form-data">
    <h:inputHidden value="#{eva_planeditBB.orguid}"></h:inputHidden>
    <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
       <h:panelGroup>
        <h:graphicImage value="/images/tips.gif" />
        <h:outputText value=" 绩效管理 -> 新增考核计划"/>
        </h:panelGroup>
    </h:panelGrid>
    <br>
    ...
    <h:panelGrid align="center" width="60%" columns="1">
        <h:panelGrid columns="4" width="100%" columnClasses="td_form01,td_form02,td_form01,td_form02" align="center" styleClass="table03">
            ...
            <h:selectOneMenu id="evaModel" value="#{eva_planeditBB.planbo.evaModel}" onchange="submit();" valueChangeListener="#{eva_planeditBB.changeMode}">
            ...
            <h:selectOneMenu value="#{eva_planeditBB.planbo.scorePers}">
                ...
                <c:selectItem itemLabel="三位小数" itemValue="3"></c:selectItem>
            </h:selectOneMenu>
        ...
        <h:panelGrid columns="2" align="right" cellspacing="2">
            <h:commandButton styleClass="button01" value="保存" action="#{eva_planeditBB.save}"
