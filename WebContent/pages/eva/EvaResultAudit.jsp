...
<script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/eva/EvaResultAuditList.jsf?planId='"+document.all("form1:planId").value+"'&superId=" + orgId;
        }
...
<h:inputHidden id="planId" value="#{eva_resultAnalyseBB.planID}"></h:inputHidden>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif"> 绩效管理 -> 绩效考核结果审批</td>
        </tr>
    </table>
     </c:verbatim>
  <c:verbatim>
        ...
        <tr>
            ...
            <td align="center" valign="top">
             <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/eva/EvaResultAuditList.jsf"></iframe>
           </td>
        </tr>
    </table>
    </c:verbatim>
