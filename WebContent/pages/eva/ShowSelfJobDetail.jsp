...
<h:form id="form1">
    ...
    <h:panelGroup>
				<h:panelGrid align="left">
					<h:outputText value="当前状态:#{eva_showSelfJobDetailBB.jobBo.statusDes}"/>
					<h:inputHidden id ="status" value="#{eva_showSelfJobDetailBB.jobBo.statusDes}"/>
				</h:panelGrid>
				<h:panelGrid align="right">
				<h:panelGroup>
					<h:commandButton value="增加" styleClass="button01" onclick="return doAddScore();" rendered="#{eva_showSelfJobDetailBB.jobBo.status==0 or eva_showSelfJobDetailBB.jobBo.status==4}"></h:commandButton>
					<h:commandButton value="职责报批" styleClass="button01"  action="#{eva_showSelfJobDetailBB.doApproval}" rendered="#{eva_showSelfJobDetailBB.jobBo.status==0 or eva_showSelfJobDetailBB.jobBo.status==4}"></h:commandButton>
					<h:commandButton value="申请修改" styleClass="button01"  action="#{eva_showSelfJobDetailBB.doModify}" rendered="#{eva_showSelfJobDetailBB.jobBo.status==2}"></h:commandButton>
					<h:commandButton value="申请修改内容" styleClass="button01"  action="#{eva_showSelfJobDetailBB.doModifyContent}" rendered="#{eva_showSelfJobDetailBB.jobBo.status==2}"></h:commandButton>
					<h:commandButton value="修改内容提交" styleClass="button01"  action="#{eva_showSelfJobDetailBB.dosubmitContent}" rendered="#{eva_showSelfJobDetailBB.jobBo.status==6}"></h:commandButton>
				</h:panelGroup>
				</h:panelGrid> 
				</h:panelGroup>
		<c:verbatim>
