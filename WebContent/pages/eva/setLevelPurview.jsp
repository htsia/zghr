...
<script type="text/javascript">
    function addlevelPurview(){
        ...
        window.showModalDialog("/eva/addLevelPruview.jsf?method=add&objectID="+document.all('form1:objectID').value+"&deptId="+deptId, null, "dialogWidth:500px; dialogHeight:350px;center:center;resizable:yes;status:no;scroll:yes;");
        return true;
    }
    function modifylevelPurview(id){
    	window.showModalDialog("/eva/addLevelPruview.jsf?method=modify&levelId="+id, null, "dialogWidth:500px; dialogHeight:350px;center:center;resizable:yes;status:no;scroll:yes;");
      	return true;
    }
</script>
<x:saveState value="#{eva_objectBB}"></x:saveState>
<h:form id="form1">
    <h:inputHidden value="#{eva_objectBB.initLevelPurview}"></h:inputHidden>
    ...
    <c:verbatim>
        ...
        <tr><td height=8 align="left">
            ...
            <h:outputText value="考核客体:#{eva_objectBB.personName}"></h:outputText>
    <c:verbatim>
        </td></tr>
    ...
    <c:verbatim>
        ...
        <h:dataTable value="#{eva_objectBB.levelPurviewList}" var="list" width="100%" id="dateList"
            ...
            <h:column>
                ...
                <h:commandButton value="删除" styleClass="button01" action="#{eva_objectBB.deleteLevalPurview}">
