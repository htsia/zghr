...
<h:form id="form1">
	...
	<h:inputHidden value="#{eva_resultAnalyseBB.initTemplateSelf}"></h:inputHidden>
	...
	<c:verbatim>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
				 ...
				 <h:panelGrid align="right" columns="2">
					<h:panelGroup>
						...
						<h:commandButton value="首页"
							action="#{eva_resultAnalyseBB.first1}" styleClass="button01" onclick="showProcessBar();"></h:commandButton>
						<h:commandButton value="上页"
							action="#{eva_resultAnalyseBB.pre1}" styleClass="button01" onclick="showProcessBar();"></h:commandButton>
						<h:commandButton value="下页"
							action="#{eva_resultAnalyseBB.next1}" styleClass="button01" onclick="showProcessBar();"></h:commandButton>
						<h:commandButton value="尾页"
							action="#{eva_resultAnalyseBB.last1}" styleClass="button01" onclick="showProcessBar();"></h:commandButton>
					</h:panelGroup>
				</h:panelGrid> 
				<c:verbatim></td>
			</tr>
			...
			<tr>
				...
				<td align="right"><br /></c:verbatim> <h:outputText value="模板类型:"></h:outputText>
				<h:selectOneMenu id="tem" value="#{eva_resultAnalyseBB.templateID}"
					style="width:200px">
					<c:selectItems value="#{eva_resultAnalyseBB.templateList}" />
				</h:selectOneMenu> <h:commandButton value="开始分析" styleClass="button01"
					onclick="return forcheck();"
					action="#{eva_resultAnalyseBB.doParameterSelf}"></h:commandButton> <c:verbatim></td>
			</tr>
