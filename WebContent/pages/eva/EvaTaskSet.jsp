...
%>
    ...
    <script type="text/javascript">
        function refreshList(orgId) {
               ...
               document.main.location.href = "/eva/EvaTaskObjectList.jsf?planID="+document.all("planID").value+"&orgId=" + orgId+"&personType="+perType;
        }
        function forSel() {
           if(PopUpMutilCodeDlgNoLayerForSubmit('form1:personType', 'form1:personTypeValue', "0135","")){
               ...
               var perType=document.all("form1:personType").value;
               document.main.location.href = "/eva/EvaTaskObjectList.jsf?orgId=" + orgId+"&personType="+perType;
           }
            return false;
        }
...
<f:verbatim>
            ...
            <td align="center" valign="top">
                   <iframe name="main" height="100%"  frameborder="0"  scrolling="auto" width="100%"  src="/eva/EvaTaskObjectList.jsf"></iframe>
            </td>
        </tr>
    </table>
</f:verbatim>
