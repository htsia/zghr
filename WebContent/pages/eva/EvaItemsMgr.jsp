...
<h:form id="form1">
      ...
      <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="1" align="center">
        <h:panelGroup>
            ...
            <h:outputText value="#{eva_itemKeyBB.unitName}考核体系"/>
        </h:panelGroup>
      </h:panelGrid>
            ...
            <td id="showTree" width="210">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td align="right">
                        ...
                        <h:commandButton styleClass="button01"  value="删除" action="#{eva_itemKeyBB.deleteSet}" onclick="return deletedDictionary();"></h:commandButton>
<f:verbatim>
                        </td>
                    </tr>
                    <tr><td height="8px"></td></tr>
