...
%>
    <script type="text/javascript">
        ...
        function doPopupTax(id) {
            var dateId = id;
            window.showModalDialog("/wage/payoff/WageTaxAudit.jsf?dateId=" + dateId, null, "dialogWidth:"+screen.width*0.95+"px; dialogHeight:"+screen.height*0.85+"px;center:center;resizable:yes;toolbar:yes;status:no;scroll:yes;");
            return true;
        }
    </script>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width=100% bgcolor="#FFFFFF" >
            <tr>
                <td class=td_title>
                    ...
                    <h:outputText value=" 薪酬管理 ->  #{wage_dateBB.name0678}"/>
    <f:verbatim>
                </td>
        ...
        <h:dataTable value="#{wage_dateBB.dateList}" var="list" align="center"  id="dateList"
            ...
            <h:column>
                ...
                <h:panelGrid columns="5" align="center" cellspacing="2">
                    <h:commandButton value="打开" styleClass="button01"    action="#{wage_dateBB.dateList}" onclick="return doPopupTax('#{list.dateId}');"/>
