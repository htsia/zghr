...
<x:saveState value="#{wage_classBB}"/>
  <h:form id="form1">
      <h:inputHidden value="#{wage_classBB.showAuditGroup}"/>
...
<c:verbatim>
          ...
          <tr>
              <td  height=8>
                  ...
                  <h:commandButton id="count" value="统计" styleClass="button01" onclick="return chechPara();" action="#{wage_classBB.beginAllCalc}" ></h:commandButton>
