...
%>
  ...
  <h:form id="form1">
      <h:inputHidden value="#{wage_groupBB.showAuditGroup}"/>
      <h:inputHidden value="#{wage_groupBB.setId}"/>
      <h:inputHidden value="#{wage_groupBB.groupField}"/>
      <h:inputHidden value="#{wage_groupBB.dateId}"/>
      <c:verbatim>
...
<c:verbatim>
                  ...
                  <td  height=8 align="right">
                      ...
                      <h:selectOneMenu value="#{wage_groupBB.groupLevel}" onchange="submit()" valueChangeListener="#{wage_groupBB.changeAuditLevel}">
...
<c:verbatim>
          ...
          <tr>
              <td height=8>
                  ...
                  <h:commandButton id="count" value="统计" styleClass="button01" onclick="return chechPara();" action="#{wage_groupBB.beginAllCalc}" ></h:commandButton>
