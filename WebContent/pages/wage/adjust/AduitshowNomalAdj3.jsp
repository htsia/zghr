       ...
       <table height=98% width=100% align="center">
		...
		<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
    	 <h:outputText value="审批意见"/>
            <h:selectOneMenu id="status" value="#{wage_AdjAduiteditBB.adjustBo.auditResult3}">
                <c:selectItem itemValue="1" itemLabel="同意"/>
                <c:selectItem itemValue="0" itemLabel="不同意"/>
            </h:selectOneMenu>

            <h:outputText value="原因"/>
            <h:inputTextarea value="#{wage_AdjAduiteditBB.adjustBo.auditOption3}" rows="3" cols="80"/>

            <h:outputText value="操作"/>
            <h:commandButton styleClass="button01" value="审批" action="#{wage_AdjAduiteditBB.audit3}"/>
    	</h:panelGrid>
    <c:verbatim>
			</td>
        </tr>
