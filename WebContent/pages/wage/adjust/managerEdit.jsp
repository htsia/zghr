...
<h:form id="form1" >
      ...
      <h:panelGrid columns="1"  width="98%" align="left">
           <h:panelGrid columns="2" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
               	<h:outputText value="职务级别"></h:outputText>
               	<h:panelGroup>
               		<h:inputText styleClass="input" id="A705718" code="" dict="yes" dict_num="0175"
                     readonly="true" value="#{wageReformJobSetBB.jobWageBo.sourceCode}"
                     alt="职务级别|0|s|50||"/>
                     <c:verbatim>
                     <input type="button" class="button_select" onclick="PopUpCodeDlgOneControl('form1:A705718')">
                     </c:verbatim>
               	</h:panelGroup>
           ...
           <h:panelGrid align="right">
              <h:commandButton value="保存" id="save" action="#{wageReformJobSetBB.saveManger}"   styleClass="button01"  onclick="javascript:return forSave()"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
<script type="text/javascript">
