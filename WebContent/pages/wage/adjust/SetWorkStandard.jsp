...
<script type="text/javascript">
	function add(){
		window.showModalDialog("/wage/adjust/workerEdit.jsf?new=yes", null, "dialogWidth:300px; dialogHeight:200px;center:center;resizable:no;status:no;scroll:no;");
		document.all('form1:refresh').click();
	    return true;
	}
	function modify(id){
		window.showModalDialog("/wage/adjust/workerEdit.jsf?itemId="+id, null, "dialogWidth:300px; dialogHeight:200px;center:center;resizable:no;status:no;scroll:no;");
		document.all('form1:refresh').click();
	    return true;
	}
</script>
...
<h:form id="form1">
<h:inputHidden id="initEdit" value="#{wageReformJobSetBB.initWorkerList}"></h:inputHidden>
<h:commandButton id="refresh" value="刷新" style="display:none;"  action="#{wageReformJobSetBB.refersh3}"></h:commandButton>
<f:verbatim>
...
<tr>
                ...
                <td align="center" width="16%" class=activeTab><a href="SetWorkStandard.jsf">工勤岗位</a></td>
</tr>
</table>
<br>
...
<f:verbatim>
     ...
     <tr><td valign="top">
        ...
        <h:dataTable value="#{wageReformJobSetBB.workerList}" var="list" align="center"  id="dateList"
                     headerClass="td_top tr_fixrow" columnClasses="td_middle_center,td_middle,td_middle_center,td_middle,td_middle,td_middle_center"
                     styleClass="table03" width="95%" >
            <h:column>
                <c:facet name="header"><h:outputText value="源字段"/></c:facet>
                <h:outputText value="工人技术等级名称(A081701)"/>
            </h:column>
