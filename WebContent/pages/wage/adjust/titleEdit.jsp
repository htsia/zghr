...
<h:form id="form1" >
      ...
      <h:panelGrid columns="1"  width="98%" align="left">
           <h:panelGrid columns="2" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
               	...
               	<h:panelGroup>
               		<h:inputText styleClass="input" id="A010006" code="" dict="yes" dict_num="0170"
           ...
           <h:panelGrid align="right">
              <h:commandButton value="保存" id="save" action="#{wageReformJobSetBB.saveTitle}"   styleClass="button01"  onclick="javascript:return forSave()"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
<script type="text/javascript">
