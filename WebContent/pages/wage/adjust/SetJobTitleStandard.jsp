...
<script type="text/javascript">
	function add(){
		window.showModalDialog("/wage/adjust/titleEdit.jsf?new=yes", null, "dialogWidth:300px; dialogHeight:200px;center:center;resizable:no;status:no;scroll:no;");
		document.all('form1:refresh').click();
	    return true;
	}
	function modify(id){
		window.showModalDialog("/wage/adjust/titleEdit.jsf?itemId="+id, null, "dialogWidth:300px; dialogHeight:200px;center:center;resizable:no;status:no;scroll:no;");
		document.all('form1:refresh').click();
	    return true;
	}
</script>
...
<h:form id="form1">
<h:inputHidden id="initEdit" value="#{wageReformJobSetBB.initTitleList}"></h:inputHidden>
<h:commandButton id="refresh" value="刷新" style="display:none;"  action="#{wageReformJobSetBB.refersh2}"></h:commandButton>
<f:verbatim>
...
<tr>
                <td align="center" width="16%" class=tab><a href="SetJobStandard.jsf">管理岗位</a></td>
                <td align="center" width="16%" class=activeTab><a href="SetJobTitleStandard.jsf">专业技术岗位</a></td>
...
&nbsp;&nbsp;&nbsp;	&nbsp;	&nbsp;	&nbsp;		
     ...
     <tr><td valign="top">
        ...
        <h:dataTable value="#{wageReformJobSetBB.titleList}" var="list" align="center"  id="dateList"
                     headerClass="td_top tr_fixrow" columnClasses="td_middle_center,td_middle,td_middle_center,td_middle,td_middle,td_middle_center"
                     styleClass="table03" width="95%" >
            <h:column>
                <c:facet name="header"><h:outputText value="源字段"/></c:facet>
                <h:outputText value="专业技术级别(A010006)"/>
            </h:column>
