...
<h:form id="form1">
    <h:inputHidden value="#{wage_grossBB.beginInput}"></h:inputHidden>
    <h:inputHidden id="year" value="#{wage_grossBB.curYear}"></h:inputHidden>
    <%
    ...
    <table width="98%">
        <tr><td align="right">
            <h:commandButton styleClass="button01" value="确认" action="#{wage_grossBB.saveInput}"   />
