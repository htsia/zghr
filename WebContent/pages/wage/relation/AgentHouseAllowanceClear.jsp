...
//            alert(sDate+","+eDate)
            windowOpen("/pages/wage/clear/ClearHouseAllowance1.jsp?Id="+id+"&sDate="+sDate+"&eDate="+eDate, '', '', '500', '200', 'yes', '250', '250', 'yes') ;
            windowOpen("/pages/wage/clear/ClearHouseAllowance2.jsp?Id="+id+"&sDate="+sDate+"&eDate="+eDate, '', '', '500', '200', 'yes', '260', '260', 'yes') ;
...
<h:form id="form1">
    <h:commandButton id="clear" action="#{wage_salaryClearBB.getAgentSalary}" styleClass="button01" style="display:none"/>
    <h:panelGrid columns="1" width="95%" align="center">
        <h:outputText value="发薪单位：#{wage_salaryClearBB.unitName}"/>
       <%
        //<h:multlink value="3" paneLable="代发工资,代缴社会保险,代发住房补贴,代缴企业年金"
        ...
        <h:panelGrid columns="7" cellspacing="2">
            ...
            <h:inputText id="sDate" alt="开始时间|0|d"  size="10" value="#{wage_salaryClearBB.startDate}"/>
            ...
            <h:commandButton value="查询" onclick="return forsubmit(form1);" action="#{wage_salaryClearBB.queryAgentHouseAllowancePerson}"
                             styleClass="button01"/>
        </h:panelGrid>
    </h:panelGrid>
    <f:verbatim>
