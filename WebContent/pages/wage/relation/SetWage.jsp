...
<h:form id="form1">
    <h:inputHidden value="#{wage_salaryRelationBB.setWage}"/>
    ...
    <h:panelGrid width="98%"  align="center"  bgcolor="#FFFFFF" cellpadding="0" columns="2"
        ...
        <h:panelGrid width="40%" align="right" >
             <h:panelGroup>
                 ...
                 <h:commandButton value="保存" styleClass="button01" action="#{wage_salaryRelationBB.saveNewItem}"></h:commandButton>
