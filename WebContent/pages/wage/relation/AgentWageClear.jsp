...
//            alert(sDate+","+eDate)
            windowOpen("/pages/wage/clear/ClearWage1.jsp?Id="+id+"&sDate="+sDate+"&eDate="+eDate, '', '', '500', '200', 'yes', '250', '250', 'yes') ;
            windowOpen("/pages/wage/clear/ClearWage2.jsp?Id="+id+"&sDate="+sDate+"&eDate="+eDate, '', '', '500', '200', 'yes', '260', '260', 'yes') ;
...
<body>
<x:saveState value="#{wage_salaryClearBB}"/>
...
<h:form id="form1">
    <h:panelGrid columns="1" width="95%" align="center">
       ...
       <%
      //  <h:multlink value="1" paneLable="代发工资,代缴社会保险,代发住房补贴,代缴企业年金"
        ...
        <h:panelGrid columns="7" cellspacing="2">
            ...
            <h:inputText id="eDate" alt="结束时间|0|d" size="10" value="#{wage_salaryClearBB.endDate}"/>
            <h:commandButton type="button" styleClass="button_date"
                             onclick="PopUpCalendarDialog('form1:eDate')"/>
            <h:commandButton value="查询" onclick="return forsubmit(form1);" action="#{wage_salaryClearBB.queryAgentWagePerson}" styleClass="button01"/>
        </h:panelGrid>
