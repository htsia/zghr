...
function enterAdj(id) {
    window.showModalDialog("/wage/institution/wageNomalAdjItemList.jsf?adjId="+id, null, "dialogWidth:"+screen.width*0.8+"px; dialogHeight:"+screen.height*0.8+"px;center:center;resizable:no;status:no;scroll:yes;");
    return true;
}
function showAdj(id) {
    window.showModalDialog("/wage/institution/showNomalAdjDetail.jsf?adjId="+id, null, "dialogWidth:"+screen.width*0.8+"px; dialogHeight:"+screen.height*0.8+"px;center:center;resizable:no;status:no;scroll:yes;");
    return true;
}
</script>

<x:saveState value="#{wage_instNomalAdjListBB}"/>
<h:form id="form1">
    <h:inputHidden id="pageInit" value="#{wage_instNomalAdjListBB.pageInit}"/>
    <f:verbatim>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width=100% bgcolor="#FFFFFF" >
            <tr>
                <td class=td_title>
                    ...
                    <h:outputText value=" 薪酬管理 -> 年度调整薪级工资"/>
      <f:verbatim>
                </td>
            </tr>
        </table>
...
<f:verbatim>
     ...
     <tr><td>
        ...
        <h:dataTable value="#{wage_instNomalAdjListBB.nomalAdjustList}" var="list" align="center"  id="dateList"
