...
<h:form id="form1">
    ...
    <h:panelGrid columns="1" cellspacing="2" width="98%"  align="center" >
        <h:panelGrid columns="2">
            <h:panelGroup>
                <h:outputText escape="false" value="<strong>薪资账套：</strong>#{wage_deptBB.setName}"/>
                ...
                <h:selectOneMenu id="personID" value="#{wage_deptBB.personID}" onchange="submit()" valueChangeListener="#{wage_deptBB.changePerson}">
                    <c:selectItems value="#{wage_deptBB.personList}"></c:selectItems>
                </h:selectOneMenu>
            </h:panelGroup>

            <h:panelGrid align="right">
                   <h:commandButton value="增加" styleClass="button01" onclick="doAdd();"></h:commandButton>
                   <h:commandButton value="复制权限定义" styleClass="button01" onclick="return doCopyPower();" action="#{wage_deptBB.copyDeptPower}"></h:commandButton>
            </h:panelGrid>
        </h:panelGrid>
