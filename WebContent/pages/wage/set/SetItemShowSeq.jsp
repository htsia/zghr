...
<h:form id="form1">
    ...
    <h:panelGrid align="center" columns="1"   styleClass="table03">
        <h:selectManyListbox id="itemList" value="#{wage_setItemBB.showSeq}" size="50" style="height:400px">
            <c:selectItems value="#{wage_setItemBB.showList}"/>
        </h:selectManyListbox>
    </h:panelGrid>
    ...
    <h:panelGrid columns="5" align="right" cellspacing="2">
        ...
        <h:commandButton styleClass="button01" value="保存"
                         action="#{wage_setItemBB.saveShowItemSequence}"
