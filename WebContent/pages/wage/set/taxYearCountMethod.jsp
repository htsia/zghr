...
<h:form id="form1">
    ...
    <table width=98% align="center">
       <tr>
           <td class="td_title"><img src="/images/tips.gif" alt="">年终奖算法
           </td>
       </tr>
        ...
        <tr>
            <td>
                ...
                <div id="cont1" style="display:none">
                    <%
                        WageFormulaBO formula = (WageFormulaBO) request.getAttribute("formula3");
                        if (formula!=null){
                ...
                <table width="98%" border="0" cellspace="0">
                    <tr>
                        <td >
                            ...
                            <h:outputText escape="false" rendered="#{wage_taxmethodBB.actwcbo.description==null || wage_taxmethodBB.actwcbo.description==''}" value="<strong>年终奖所得税</strong>=(年终奖-不足起征点差额部分)×对应税率-速算扣除"></h:outputText>
                            ...
                            <h:outputText value="         "></h:outputText>
                            <h:outputText escape="false" value="&nbsp;&nbsp;<strong>按年终奖所得/12查表</strong>"></h:outputText>
<c:verbatim>
                        </td>
                    </tr>
                </table>
