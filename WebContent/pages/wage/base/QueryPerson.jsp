...
<x:saveState value="#{wage_bonusPlanBB}"/>
...
<h:form id="form1">
    <h:panelGrid columns="1" width="95%" styleClass="table03" align="center" columnClasses="td_middle">
        <h:panelGrid align="center" columns="7" cellspacing="2">
            ...
            <f:verbatim><input type="text" size="16" alt="姓名|0" name="form1:nameStr" onkeypress="enterKeyDown('form1:btnSearch')"></f:verbatim>
            ...
            <h:commandButton styleClass="button01" value="查询多头发放人员" action="#{wage_personQueryBB.queryManyHeadPerson}"/>
