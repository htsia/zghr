...
<f:verbatim>
    ...
    <tr height=8>
                ...
                <td align="center" width="16%" class=activeTab><img src="/images/common/handtip.gif">&nbsp;<a href="SetPersonItem.jsf?act=3">薪资项目－员工人力成本</a></td>
    ...
    <tr>
       ...
       <div class="tabbody" id=datatable>
        ...
        <h:dataTable styleClass="table03" align="center" width="95%"  id="dateList"
            ...
            <h:column>
                <f:facet name="header"><h:outputText value="薪资项目(A815)" styleClass="td03"/></f:facet>
                <h:outputText value="#{list.costNameEx}"/>
            </h:column>
            <h:column>
                <f:facet name="header"><h:outputText value="员工人力成本项目(A028)" styleClass="td03"/></f:facet>
