...
<f:verbatim><br>
    ...
    <tr height=8>
                ...
                <td align="center" width="16%" class=activeTab><img src="/images/common/handtip.gif">&nbsp;<a href="SetPieceItem.jsf?act=6">个人计量汇总</a></td>
        ...
        <div class="tabbody" id=datatable>
            ...
            <h:dataTable align="center" width="95%"  value="#{wage_wageItemSetBB.pieceSet}" var="list"  id="dateList"
                ...
                <h:column>
                    <f:facet name="header"><h:outputText value="计量汇总(A003)"/></f:facet>
