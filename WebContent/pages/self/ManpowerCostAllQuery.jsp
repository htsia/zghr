...
<h:inputHidden value="#{self_querypercostbb.initHid_ManpowerCostAllQuery}"/>
	...
	columnClasses="h_css_td_5,h_css_td_5,h_css_td_5,h_css_td_5"cellpadding="3" >
        ...
        <h:panelGroup>
               <h:inputText styleClass="input" id="beginTime" size="12" alt="开始时间|0|d" value="#{self_querypercostbb.beginTime}" readonly="true"/>
		...
		<h:panelGroup>
               <h:inputText styleClass="input" id="endTime" alt="结束时间|0|d" size="12" value="#{self_querypercostbb.endTime}" readonly="true"/>
	...
	<h:panelGrid columns="2" align="center" width="95%">
		...
		<h:outputText value="#{self_querypercostbb.beginTime}至#{self_querypercostbb.endTime}" style="font-weight:bold" />
		</h:panelGrid>
