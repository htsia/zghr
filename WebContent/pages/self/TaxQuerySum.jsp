...
<script>
      ...
      function showDetail(){
         var inputCode="";
         if (document.all('form1:inputCode')!=null){
            inputCode=document.all('form1:inputCode').value; 
         }
         if (checkDate()){
...
<h:form id="form1">
  ...
  <c:verbatim>
        ...
        <table width="90%"  cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td align="center" width="30%" class=tab><img src="/images/common/handtip.gif">&nbsp;<a href="\self\PayQueryByMonth.jsf">薪资查询－按月份查询工资发放明细</a></td>
                <td align="center" width="30%" class=tab><img src="/images/common/handtip.gif">&nbsp;<a href="\self\PayQuerySum.jsf">薪资查询－按时间段查询工资汇总情况</a></td>
                <td align="center" width="30%" class=activeTab><img src="/images/common/handtip.gif">&nbsp;<a href="\self\TaxQuerySum.jsf">薪资查询-个人所得税申报查询</a></td>
            </tr>
      <tr>
          <td colspan=3>
            ...
            <table width="90%" align="center">
                <tr><td>
                   ...
                   <h:inputText id="inputCode" value="#{self_querypaybb.inputCode}"></h:inputText>
