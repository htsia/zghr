...
<c:verbatim>
    ...
    <script language="javascript">
        with (window) onload = onresize = function(){
            var mainHeight = document.body.offsetHeight - 95;
    ...
    <c:verbatim>
        ...
        <tr>
            ...
            <td  width="50%" align="center">
                <span style="font-size:30px; color:#ffffff; line-height:43px; font-weight:bold; padding-left:0px; padding-top:15px; height:43px; width:480px;"><%=Constants.TITLE_NAME%></span>
           </td>
            <td align="right" >
                <font color="white"><%=user.getName()%>，您好！ 欢迎登录<% out.println(Constants.SYSTEM_NAME+Constants.SELF_SYSTEM_NAME);%><br>上次登录：<%=user.getLastLoginTime()%>这是您今天第<%=user.getTodayTimes()%>次登录本系统</font>
            </td>
       </tr>
      </table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="22" bgcolor="<%=Constants.MENU_COLOR%>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="3" bgcolor="<%=Constants.MENU_COLOR%>"></td>
                <td height="22" bgcolor="<%=Constants.MENU_COLOR%>" width="<%if(menu!=null) if(menu.getMenus()!=null) out.print(menu.getMenus().size()*25);%>">
...
<c:verbatim>
    ...
    <td height="22" width="180" align="right" bgcolor="<%=Constants.MENU_ICON_COLOR%>">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td align="center">
        <iframe name="main" height="100%"  frameborder="0"  scrolling="auto" width="100%"    src="<%=url%>" >
        </iframe>
        </td>
  </tr>
</table>
