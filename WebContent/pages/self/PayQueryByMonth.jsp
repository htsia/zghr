...
<h:form id="form1">
    ...
    <f:verbatim>
        ...
        <table width="90%"  cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td align="center" width="30%" class=activeTab><img src="/images/common/handtip.gif">&nbsp;<a href="\self\PayQueryByMonth.jsf?Init=true"><strong>薪资查询－按月份查询工资发放明细</strong></a></td>
                <td align="center" width="30%" class=tab id="PayQuerySum"><img src="/images/common/handtip.gif">&nbsp;<a href="\self\PayQuerySum.jsf"><strong>薪资查询－按时间段查询工资汇总情况</strong></a></td>
                <td align="center" width="30%" class=tab id="TaxQuerySum"><img src="/images/common/handtip.gif">&nbsp;<a href="\self\TaxQuerySum.jsf"><strong>薪资查询-个人所得税申报查询</strong></a></td>
            ...
            <tr>
                ...
                <f:verbatim>
                               ...
                               <h:outputText value=" " />
                                <h:outputText value="#{self_querypaybb.codeMsg}" rendered="#{sys_commonInfoBB.enableWageQueryCheck}"></h:outputText>
                                <h:inputText value="#{self_querypaybb.inputCode}" rendered="#{sys_commonInfoBB.enableWageQueryCheck}"></h:inputText>
                                <h:commandButton value="获取查询码" styleClass="button01" rendered="#{sys_commonInfoBB.enableWageQueryCheck}" action="#{self_querypaybb.generateQueryCode}" />
