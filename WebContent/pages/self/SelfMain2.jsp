      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="height:100%">
        <tr>
            ...
            <td id="showTree" align="left" width=200 valign="top">
                 <iframe name="tree" frameborder="no" border="0" marginwidth="0" marginheight="0"  scrolling="auto" style="height:100%;width:100%;" src="/pages/ShowSelfOperateTree.jsp?Root=YGZZ"></iframe>
            </td>
