...
<%
    ...
    if (!"".equals(rootId) && !"undefined".equals(rootId) && !"null".equals(rootId)) {
        ...
        try {
            ...
            if ("-1".equals(superId)) {
                PartyBO[] os = (PartyBO[]) api.getTreeRoot("1", (User) session.getAttribute(Constants.USER_INFO));
        ...
        try {
            ...
            if ("-1".equals(superId)) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    PartyBO o = (PartyBO) list.get(i);
                    if (api.checkPartyTreeId((User) session.getAttribute(Constants.USER_INFO), o.getTreeId(), "1") == 1)
                    {
                        list.remove(i);
                        i--;
                    }
