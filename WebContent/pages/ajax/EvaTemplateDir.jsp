...
<%@ page import="com.hr319wg.eva.pojo.bo.EvaTemplateSetBO" %>
...
<%
    ...
    try {
        ...
        list = rc.getAllChildTemplateSet(superId);
    }
    catch (Exception e) {
    ...
    if (list != null) {
        for (int i = 0; i < list.size(); i++) {
            ...
            EvaTemplateSetBO o = (EvaTemplateSetBO) list.get(i);
            if (o != null) {
                try {
                    List li = rc.getAllChildTemplateSet(o.getSetID());
