...
<script type="text/javascript">
	function doAddItem(id) {
		window.showModalDialog(
				"/attence/personEvcctionAuditEdit.jsf?evcctionNO=" + id
	...
	function doAddItem1(id) {
		window.showModalDialog(
				"/attence/personEvcctionAuditEdit1.jsf?evcctionNO=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
	...
	function doAddItem2(id) {
		window.showModalDialog(
				"/attence/personEvcctionAuditEdit2.jsf?evcctionNO=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
						+ screen.height * 1.0 + "px; status:0;resizable:yes");
		return true;
	...
	function doAddItem3(id) {
		window.showModalDialog(
				"/attence/personEvcctionAuditEdit3.jsf?evcctionNO=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
	...
	function doAddItem4(id) {
		window.showModalDialog(
				"/attence/personEvcctionAuditEdit4.jsf?evcctionNO=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
						+ screen.height * 1.0 + "px; status:0;resizable:yes");
		return true;
