...
<h:form id="form1">
	...
	<h:panelGrid width="98%" align="center">
		<h:outputText escape="false" value="出差审批单"
	...
	<f:verbatim>
		<table align="center" border="0" width="610" id="table1"
			...
			<tr>
				...
				<h:outputText escape="false" value="出差" /> 
				<h:outputText escape="false" value="申请" rendered="#{personevectionBB.bo1.evcctionType=='2'}"/>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personevectionBB.bo1.manAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personevectionBB.bo1.manAuditResultvalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personevectionBB.bo1.manAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{personevectionBB.bo1.manAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
 ...
 <f:verbatim></td>
				...
				<td height="40" align="center" width="80" colspan="6"
					style="border: 1px solid #555555;"></f:verbatim>
<h:inputTextarea value="#{personevectionBB.bo1.hrAuditCause}" rows="3" cols="80"/>
 <f:verbatim></td>
			</tr>
			...
			<h:commandButton styleClass="button01" value="确认"
				action="#{personevectionBB.personEvectionAudit3}" />
					 <f:verbatim></td>
			</tr>
