...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.leaderAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.leaderAuditCausevalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.leaderAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{personaddworkBB.bo1.leaderAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.manAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.manAuditResultvalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personaddworkBB.bo1.manAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{personaddworkBB.bo1.manAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
 ...
 <f:verbatim></td>
				...
				<td height="40" align="center" width="80" colspan="6"
					style="border: 1px solid #555555;"></f:verbatim>
			<h:inputTextarea value="#{personaddworkBB.bo1.hrAuditCause}" rows="3"
				cols="80" />
 <f:verbatim></td>
			</tr>
			...
			<h:commandButton styleClass="button01" value="确认"
				action="#{personaddworkBB.personAddWorkAudit3}" />
					 <f:verbatim></td>
			</tr>
