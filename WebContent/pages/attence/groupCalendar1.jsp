...
function newCalendar() {
    ...
    xmlhttp.open("GET","/pages/attence/getFeast1.jsp?yearvalue="+parseYear+"&monthvalue="+parseMonth+"&name="+name+"&personID="+personID,true);
    xmlhttp.send(null);
        ...
        for (var intDay = 0;intDay < tableCal.rows[intWeek].cells.length;intDay++)
        {
            ...
            //var ymdValue=new Array("2010-02-01","2010-02-17","2010-02-28","2010-12-17");
             ...
             for(var m=0;m<feasts.length;m++){
                 ...
                 ymdValues.push(feasts2[3]);
                 ymdValuess.push(feasts2[2]);
                 ...
                 if(parseYear+"-0"+parseMonth+"-"+daily==ymd[i]){ 
                  ...
                  if(isfeast){
                	  ...
                	  if(ymdValue2=="未设"){
                		  ...
                		  if(ymdValue4=="A"){
                    		  cell.innerHTML+="<div style='cursor: pointer;' onclick=GetDate('"+ymdValue3+"')>"+ymdValue1+"</div>"; 
                		      ...
                		      cell.innerHTML+="<div style='cursor: pointer;' onclick=GetDate('"+ymdValue3+"')>"+ymdValue4+" "+ymdValue1+"</div>"; 
                    	  }
                      }
                 }
                  else{
...
{
  window.showModalDialog("/pages/attence/groupCalendarEdit1.jsp?name="+name, null, "dialogWidth:400px; dialogHeight:400px;center:center;resizable:yes;status:no;scroll:yes;");
