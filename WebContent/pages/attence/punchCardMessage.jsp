...
<script type="text/javascript">
 ...
 function punchCard(){
  window.showModalDialog("/attence/punchCardMessageEdit.jsf", null, "dialogWidth:200px; dialogHeight:200px;center:center;resizable:yes;status:no;scroll:no;");
    return false;
 }
</script>
<x:saveState value="#{punch_cardmessageBB}" />
<h:form id="form1">
<h:inputHidden id="pageInit" value="#{punch_cardmessageBB.pageInit}" />
	<h:inputHidden id="personList" value="#{punch_cardmessageBB.personList}" />
	<f:verbatim>
				...
				<td class="td_page" height=8></f:verbatim> <h:panelGrid width="95%"
					...
					<h:panelGroup>
						...
						<h:inputText styleClass="input" id="beginTime" size="12"
							alt="开始时间|0|d" value="#{punch_cardmessageBB.beginTime}"
							readonly="true" />
						<f:verbatim>
						...
						<h:inputText styleClass="input" id="endTime" alt="结束时间|0|d"
							size="12" value="#{punch_cardmessageBB.endTime}" readonly="true" />
						<f:verbatim>
						...
						<h:commandButton id="set" styleClass="button01" value="查询"
							action="#{punch_cardmessageBB.checkPersonCardMessage}"
							onclick="return checkDate();" />
						<h:commandButton id="set1" styleClass="button01" value="打卡"
							onclick="return punchCard();" rendered="#{punch_cardmessageBB.showButtonDK=='1'}"/>
						<h:outputText value=" " />
						<h:outputText value=" " />
						<h:outputText value="(" />
						<h:outputText value="员工编号:#{punch_cardmessageBB.personseq}" />
						<h:outputText value=", " />
						<h:outputText value="姓名:#{punch_cardmessageBB.personName}" />
						<h:outputText value=", " />
						<h:outputText value="考勤卡号:#{punch_cardmessageBB.personcard}" />
						<h:outputText value=", " />
						<h:outputText value="所在机构:#{punch_cardmessageBB.orgnamevalue}" />
					    <h:outputText value=", " />
						<h:outputText value="所属部门:#{punch_cardmessageBB.deptnamevalue}" />
						<h:outputText value=")" />
					</h:panelGroup>
