...
<script type="text/javascript">
	...
	function doAddItem() {
		...
		if(desc != null && desc != ""){
			window.showModalDialog("/attence/personLeave/personLeaveMessage.jsf?okID=100", "",
	...
	function doEditItem(id) {
		var desc = document.all('form1:desc').value;
		if(desc != null && desc != ""){
			window.showModalDialog("/attence/personLeave/personLeaveMessage.jsf?furloughNO="
	...
	function doEditItem1(id, id1, id2) {
		window.showModalDialog("/attence/personLeave/personLeaveMessages.jsf?furloughNO="
	...
	function doEditItem2(id) {
		window.showModalDialog(
				"/attence/personLeave/personLeaveMessagesHistory.jsf?furloughNO=" + id, "",
	...
	function doTimeOff(id) {
		window.showModalDialog(
				"/attence/personLeave/personLeaveNetworkholiday.jsf?furloughNO=" + id, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
