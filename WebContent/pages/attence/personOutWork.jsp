...
<script type="text/javascript">
	function doAddItem() {
		...
		if(desc != null && desc != ""){
			window.showModalDialog("/attence/personOutWorkMessage.jsf?okID=100",
	...
	function doEditItem(id) {
		var desc = document.all('form1:desc').value;
		if(desc != null && desc != ""){
			window.showModalDialog("/attence/personOutWorkMessage.jsf?outWorkNo="
	...
	function doEditItem1(id, id1, id2) {
		window.showModalDialog("/attence/personOutWorkMessages.jsf?outWorkNo="
	...
	function doEditItem2(id) {
		window.showModalDialog(
				"/attence/personOutWorkMessageHistory.jsf?outWorkNo=" + id, "",
