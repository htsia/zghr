...
<x:saveState value="#{punch_cardmonthcollectBB}" />
<h:form id="form1">
	<h:inputHidden id="pageInit"
		value="#{punch_cardmonthcollectBB.pageInit}" />
	<h:inputHidden id="personList"
		value="#{punch_cardmonthcollectBB.personList}" />
	<f:verbatim>
				...
				<td class="td_page" height=8></f:verbatim> <h:panelGrid width="95%"
					...
					<h:panelGroup>
						...
						<h:inputText styleClass="input" id="beginTime" size="12"
							alt="开始时间|0|d" value="#{punch_cardmonthcollectBB.beginTime}"
							readonly="true" />
						<f:verbatim>
						<img onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM',el:'form1:beginTime'})" src="../images/search.gif" class="button_select" width="16" height="22" align="absmiddle">
						</f:verbatim>

						<h:outputText value="结束日期" />
						<h:inputText styleClass="input" id="endTime" alt="结束时间|0|d"
							size="12" value="#{punch_cardmonthcollectBB.endTime}"
							readonly="true" />
						<f:verbatim>
						<img onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM',el:'form1:endTime'})" src="../images/search.gif" class="button_select" width="16" height="22" align="absmiddle">
						</f:verbatim>

						<h:commandButton id="set" styleClass="button01" value="查询"
							action="#{punch_cardmonthcollectBB.checkPersonCardMessage}"
