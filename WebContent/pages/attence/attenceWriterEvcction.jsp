...
<x:saveState value="#{attwriterevcctionBB}"></x:saveState>
<h:form id="form1">
    <h:commandButton id="refresh" value="刷新" style="display:none;" action="#{attwriterevcctionBB.makesure}"></h:commandButton>
	<h:inputHidden value="#{attwriterevcctionBB.pageInit}"></h:inputHidden>
	<f:verbatim>
			...
			<tr>
				...
				<table width="98%" align="center">
					<tr>
						...
						<td align="center" width="12%" class=activeTab><a href="attenceWriterEvcction.jsf">出差录入</a></td>
...
<f:verbatim>
			<tr>
				...
				<x:dataTable value="#{attwriterevcctionBB.listscommon}" var="list"
			...
			<h:commandButton styleClass="button01" value="去除" 
				action="#{attwriterevcctionBB.remove}"
...
<f:verbatim>
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{attwriterevcctionBB.begindatevalueWdate}" onclick="timeCheck();"
				    readonly="true"/>
				    <f:verbatim>
			...
			<h:outputText escape="false" value=" 至  " />
				...
				<h:inputText styleClass="input" id="endTime" alt="结束日期|0|d" onclick="timeCheck();"
					size="30" value="#{attwriterevcctionBB.enddatevalueWdate}" readonly="true"/>
					<f:verbatim>
			...
			<h:inputText styleClass="input" style="border:0px;" id="totalday" 
				value="#{attwriterevcctionBB.kqglLeaverDayValue}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>
			...
			<h:inputText styleClass="input" id="destination"
				value="#{attwriterevcctionBB.destValue}"/>
				<f:verbatim>
				</td>
			</tr>
...
<h:inputTextarea id="desc" value="#{attwriterevcctionBB.reasonValue}"
            ...
            <h:commandButton styleClass="button01" value="提交" action="#{attwriterevcctionBB.save}"
