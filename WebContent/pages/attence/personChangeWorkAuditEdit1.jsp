...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personChangeWorkBB.bo1.deptAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personChangeWorkBB.bo1.deptAuditCausevalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personChangeWorkBB.bo1.deptAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{personChangeWorkBB.bo1.deptAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
 ...
 <f:verbatim></td>
				...
				<td height="40" align="center" width="80" colspan="6"
					style="border: 1px solid #555555;"></f:verbatim>
<h:inputTextarea value="#{personChangeWorkBB.bo1.hrAuditCause}" rows="3" cols="80"/>
 <f:verbatim></td>
			</tr>
			...
			<h:commandButton styleClass="button01" value="确认"
				action="#{personChangeWorkBB.personChangeWorkAudit2}" />
					 <f:verbatim></td>
			</tr>
