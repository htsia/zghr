...
<script type="text/javascript">
	function doAddItem() {
		...
		if (desc != null && desc != "") {
			window.showModalDialog(
					"/attence/evection/personEvectionMessage.jsf?okID=100", "",
	...
	function doEditItem(id) {
		...
		if (desc != null && desc != "") {
			window.showModalDialog(
					"/attence/evection/personEvectionMessage.jsf?evcctionNO=" + id, "",
					"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
							+ screen.height * 0.9
							+ "px; status:0;resizable:yes");
			return true;
	...
	function doEditItem1(id, id1, id2) {
		window.showModalDialog(
				"/attence/evection/personEvectionMessages.jsf?evcctionNO=" + id
	...
	function doEditItem2(id) {
		window.showModalDialog(
				"/attence/evection/personEvectionMessageHistory.jsf?evcctionNO=" + id,
