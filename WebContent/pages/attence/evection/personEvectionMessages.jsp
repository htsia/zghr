...
<h:form id="form1">
	<h:commandButton id="refresh" value="刷新" style="display:none;"
		action="#{personevectionBB.makesure}"></h:commandButton>
	<h:commandButton id="refresh1" value="刷新" style="display:none;"
		action="#{personevectionBB.makesure2}"></h:commandButton>
	<h:inputHidden value="#{personevectionBB.pageInit2}" />
	<c:verbatim>
		<input type="hidden" name="content" value="">
	</c:verbatim>
	<h:panelGrid width="98%" align="center">
		<h:outputText escape="false" value="续增/销减出差单"
		...
		<table align="center" border="0" width="610" id="table1"
			...
			<tr>
				...
				<td class="table_rlbt" colspan="3"  height="40" align="center" width="80" style="border:1px solid #555555;"></f:verbatim> <h:outputText
					...
					value="#{personevectionBB.personName}" /> <f:verbatim></td>
				...
				<td class="table_rlbt"  height="40" align="center" width="80" style="border:1px solid #555555;" colspan="2"></f:verbatim> <h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{personevectionBB.bo.dest}" /> <f:verbatim></td>
			</tr>
			...
			<h:panelGroup>
				<h:outputText value="#{personevectionBB.begindatevalueWdate3}"/>
			</h:panelGroup>
			<h:outputText escape="false" value=" 至  " />
						<h:panelGroup>
				<h:outputText value="#{personevectionBB.enddatevalueWdate3}"/>
			</h:panelGroup>
				<f:verbatim>
				</td>
			</tr>
			...
			<tr>
				...
				<h:outputText value="续增时间" rendered="#{personevectionBB.flag!='3'}"/>
				<h:outputText value="销减时间" rendered="#{personevectionBB.flag=='3'}"/>
				<f:verbatim>
				</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
				    ...
				    readonly="true"/>
				    <h:panelGroup rendered="#{personevectionBB.flag=='3'}">
				    <f:verbatim>
			...
			<tr>
				...
				<td height="40" colspan=6 class="table_rlbt"></f:verbatim> <h:inputText
					...
					value="#{personevectionBB.kqglLeaverDayValue}" /> <f:verbatim></td>
			</tr>
			...
			<tr>
				...
				<td class="table_rlbt" align="left" valign="top" colspan="6"
					...
					value="#{personevectionBB.reason}" cols="75" rows="3"
...
<h:panelGroup rendered="#{personevectionBB.isExist5}">
<f:verbatim>
			<tr>
				<td align="center" height="40" class="table_rlbt">出差倒休信息操作</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim> 
			<h:selectOneRadio value="#{personevectionBB.typeStatus}"
				onclick="submit();">
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime2" size="30"
					alt="起始日期|0|d" value="#{personevectionBB.begindatevalueWdate2}" onclick="timeCheck1();"
				    readonly="true"/>
				    <h:panelGroup rendered="#{personevectionBB.typeStatus=='2'}">
				    <f:verbatim>
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="endTime2" alt="结束日期|0|d" onclick="timeCheck1();"
					size="30" value="#{personevectionBB.enddatevalueWdate2}" readonly="true"/>
					<h:panelGroup rendered="#{personevectionBB.typeStatus=='2'}">
					<f:verbatim>
			...
			<h:inputText id="totaldayvalue2" styleClass="input" style="border:0px;"
				value="#{personevectionBB.daySpan1}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>
</f:verbatim>
...
<f:verbatim>
			...
			<tr>
				...
				<h:commandButton
					...
					action="#{personevectionBB.PersonEvcctionMessages}"
					onclick="return check_test();" /> 
				<h:outputText value="  " />
                <h:outputText value="  " />
                <h:outputText value="  " />
                <h:commandButton styleClass="button01" value="确认并报批" action="#{personevectionBB.PersonEvcctionMessagesAndPersonEvectionMessageAudit}"
                             onclick="return check_test();"  />
					<f:verbatim></td>
			</tr>
