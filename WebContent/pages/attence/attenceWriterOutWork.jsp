...
<x:saveState value="#{attwriteroutworkBB}"></x:saveState>
<h:form id="form1">
    <h:commandButton id="refresh" value="刷新" style="display:none;" action="#{attwriteroutworkBB.makesure}"></h:commandButton>
	<h:inputHidden value="#{attwriteroutworkBB.pageInit}"></h:inputHidden>
	<f:verbatim>
			...
			<tr>
				...
				<table width="98%" align="center">
					<tr>
						...
						<td align="center" width="12%" class=activeTab><a href="attenceWriterOutWork.jsf">公出录入</a></td>
...
<f:verbatim>
			<tr>
				...
				<x:dataTable value="#{attwriteroutworkBB.listscommon}" var="list"
			...
			<h:commandButton styleClass="button01" value="去除" 
				action="#{attwriteroutworkBB.remove}"
...
<f:verbatim>
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{attwriteroutworkBB.begindatevalueWdate}" onclick="timeCheck();"
				    readonly="true"/>
				    <f:verbatim>
			...
			<h:outputText escape="false" value=" 至  " />
				...
				<h:inputText styleClass="input" id="endTime" alt="结束日期|0|d" onclick="timeCheck();"
					size="30" value="#{attwriteroutworkBB.enddatevalueWdate}" readonly="true"/>
					<f:verbatim>
			...
			<h:inputText styleClass="input" style="border:0px;" id="totalday" 
				value="#{attwriteroutworkBB.kqglLeaverDayValue}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>

			<tr>
				<td align="center" height="40" class="table_rlbt">目的地</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:inputText styleClass="input" id="destination"
				value="#{attwriteroutworkBB.destValue}"/>
				<f:verbatim>
				</td>
			</tr>
...
<h:inputTextarea id="desc" value="#{attwriteroutworkBB.reasonValue}"
            ...
            <h:commandButton styleClass="button01" value="提交" action="#{attwriteroutworkBB.save}"
