...
<x:saveState value="#{attwriteraddworkBB}"></x:saveState>
<h:form id="form1">
    <h:commandButton id="refresh" value="刷新" style="display:none;" action="#{attwriteraddworkBB.makesure}"></h:commandButton>
	<h:inputHidden value="#{attwriteraddworkBB.pageInit}"></h:inputHidden>
	<f:verbatim>
			...
			<tr>
				...
				<table width="98%" align="center">
					<tr>
						...
						<td align="center" width="12%" class=activeTab><a href="attenceWriterAddWork.jsf">加班录入</a></td>
						<td align="center" width="12%" class=tab><a href="attenceWriterNewWork.jsf">年假录入</a></td>
...
<f:verbatim>
			<tr>
				...
				<x:dataTable value="#{attwriteraddworkBB.listscommon}" var="list"
			...
			<h:commandButton styleClass="button01" value="去除" 
				action="#{attwriteraddworkBB.remove}"
...
<f:verbatim>
			<tr>
				<td align="center" height="40" class="table_rlbt">加班类型</td>
				<td height="40" width="600" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:selectOneRadio value="#{attwriteraddworkBB.status}"
				onclick="submit();">
			...
			<tr>
				<td align="center" height="40" class="table_rlbt">加班时间</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{attwriteraddworkBB.begindatevalueWdate}" onclick="timeCheck();"
				    readonly="true"/>
				    <f:verbatim>
			...
			<h:outputText escape="false" value=" 至  " />
				...
				<h:inputText styleClass="input" id="endTime" alt="结束日期|0|d" onclick="timeCheck();"
					size="30" value="#{attwriteraddworkBB.enddatevalueWdate}" readonly="true"/>
					<f:verbatim>
			...
			<h:inputText styleClass="input" style="border:0px;" id="totalday" 
				value="#{attwriteraddworkBB.kqglLeaverDayValue}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>
...
<h:inputTextarea id="desc" value="#{attwriteraddworkBB.reasonValue}"
            ...
            <h:commandButton styleClass="button01" value="提交" action="#{attwriteraddworkBB.save}"
