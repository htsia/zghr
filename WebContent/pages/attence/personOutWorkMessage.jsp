...
function selectNewPersonTimeOff(){
	...
	if (perIds.length <= 0) {
		...
		window.showModalDialog("/attence/personOutWorkMessageTimeOff.jsf?personIdTimeOff="+perIds+"&personIdTimeOffDay="+personIdTimeOffDay, null, "dialogWidth:"+screen.width*0.6+"px; dialogHeight:"+screen.height*0.6+"px;center:center;resizable:yes;status:no;scroll:yes;");
	}
	return true;
}
</script>
