...
<script type="text/javascript">
	...
	function forAddDate() {
		window
				.showModalDialog(
						"/attence/catering/setWeekSumAdd.jsf?ok=10000",
						null,
	...
	function forFinanceDate(id, id1) {
		window
				.showModalDialog(
						"/attence/catering/setWeekSumAdd.jsf?subId=" + id
								+ "&orgId=" + id1,
						null,
						"dialogWidth:500px; dialogHeight:300px;center:center;resizable:yes;status:no;scroll:yes;");
		document.all('form1:refresh').click();
	...
	function doDetailPopup(id,id1,id2) {
		window
				.showModalDialog(
						"/attence/catering/setWeekSumList.jsf?orgId=" + id+"&attenceDate="+id1+"&attenceWeekDate="+id2,
						null,
...
<h:form id="form1">
	...
	<h:inputHidden id="pageInit" value="#{setweeksumBB.pageInit}" />
	...
	<h:panelGrid columns="2" cellspacing="2" width="89%" align="center">
		<h:panelGroup>
			<h:outputText value="记录数:#{setweeksumBB.mypage.totalRecord}"></h:outputText>
			<h:outputText value="  "></h:outputText>
			<h:outputText value="页数:#{setweeksumBB.mypage.totalPage}"></h:outputText>
			<h:outputText value="  "></h:outputText>
			<h:outputText value="每页有#{setweeksumBB.mypage.pageSize}"></h:outputText>
			<h:outputText value="  "></h:outputText>
			<h:outputText value="当前为第#{setweeksumBB.mypage.currentPage}页"></h:outputText>

			<h:commandButton value="首页" action="#{setweeksumBB.first}"
				styleClass="button01"></h:commandButton>
			<h:commandButton value="上页" action="#{setweeksumBB.pre}"
				styleClass="button01"></h:commandButton>
			<h:commandButton value="下页" action="#{setweeksumBB.next}"
				styleClass="button01"></h:commandButton>
			<h:commandButton value="尾页" action="#{setweeksumBB.last}"
				styleClass="button01"></h:commandButton>
	...
	<h:dataTable value="#{setweeksumBB.dateList}" var="list"
		...
		<h:column>
			...
			<h:commandButton value="查看历史" styleClass="button01" type="button"
				onclick="return doDetailPopup('#{list.orguid}','#{list.attenceDate}','#{list.attenceWeekDate}');" />
		</h:column>
	</h:dataTable>
</h:form>
<script type="text/javascript">
