	...
	<f:verbatim>
		<table align="center" border="0" width="610" id="table1"
			...
			<tr>
				...
				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim>
				...
				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim>
				<h:outputText escape="false" value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
					style="border: 1px solid #555555;"></f:verbatim> <h:selectOneMenu
					value="#{mrnetworkholidayBB.status}" onchange="submit();"
			...
			<tr>
				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim>
				<h:outputText escape="false" value="说明" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="6"
					style="border: 1px solid #555555;"></f:verbatim> <h:inputTextarea
					value="#{mrnetworkholidayBB.bo1.deptAuditCause}" rows="3" cols="80" />
				<f:verbatim></td>
			</tr>
			...
			<tr>
				...
				<td height="40" colspan=6 class="table_rlbt"></f:verbatim> <h:commandButton
					...
					action="#{mrnetworkholidayBB.mrNetWorkHolidayAudit1}" /> <f:verbatim></td>
			</tr>
