...
<x:saveState value="#{attwriterBB}"></x:saveState>
<h:form id="form1">
	<h:commandButton id="refresh" value="刷新" style="display:none;" action="#{attwriterBB.makesure}"></h:commandButton>
	<h:inputHidden value="#{attwriterBB.pageInit}"></h:inputHidden>
	<f:verbatim>
		...
		<table height=98% width=98% align="center">
			<tr>
				...
				<table width="98%" align="center">
					<tr>
						<td align="center" width="12%" class=activeTab><a href="attenceWriter.jsf">请假录入</a></td>
...
<f:verbatim>
			<tr>
				...
				<x:dataTable value="#{attwriterBB.listscommon}" var="list"
...
<f:verbatim>
			<tr>
				<td align="center" height="40" class="table_rlbt">假期类型</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:selectOneMenu value="#{attwriterBB.flleavevalue}" style="width:90px;"
				 onchange="submit();" valueChangeListener="#{attwriterBB.changeflleavevalue}">
				<c:selectItems value="#{attwriterBB.flleavevaluelist}"></c:selectItems>
			</h:selectOneMenu>
				<f:verbatim>
				</td>
			</tr>
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{attwriterBB.begindatevalueWdate}" onclick="timeCheck();"
				    readonly="true"/>
				    <f:verbatim>
			...
			<h:outputText escape="false" value=" 至  " />
				...
				<h:inputText styleClass="input" id="endTime" alt="结束日期|0|d" onclick="timeCheck();"
					size="30" value="#{attwriterBB.enddatevalueWdate}" readonly="true"/>
					<f:verbatim>
			...
			<h:inputText styleClass="input" style="border:0px;" id="totalday" 
				value="#{attwriterBB.kqglLeaverDayValue}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>
...
<h:inputTextarea id="desc" value="#{attwriterBB.reasonValue}"
            ...
            <h:commandButton styleClass="button01" value="提交" action="#{attwriterBB.save}"
