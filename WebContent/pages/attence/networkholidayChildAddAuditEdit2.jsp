...
<h:form id="form1">
   <h:inputHidden id="pageInit" value="#{networkholidaychildaddBB.initEdit2}" />
	<c:verbatim>
		<input type="hidden" name="content" value="">
	</c:verbatim>
	<h:panelGrid width="98%" align="center">
		<h:outputText escape="false" value="年假审批单"
		...
		<table align="center" border="0" width="610" id="table1"
			...
			<tr>
				<td  height="40" align="center" width="80" style="border:1px solid #555555;" class="table_rlbt"></f:verbatim> <h:outputText
					escape="false" value="申请人" /> <f:verbatim></td>
			...
			<tr>
				...
				<td height="40" colspan=6 class="table_rlbt"></f:verbatim>
				 <h:panelGroup>
<h:outputText escape="false" value="#{networkholidaychildaddBB.bo1.holidayBegin}" />
				<h:outputText  escape="false" value=" 至  " />
<h:outputText escape="false" value="#{networkholidaychildaddBB.bo1.holidayEnd}" />
</h:panelGroup>			
                <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.deptAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.deptAuditCausevalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.deptAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{networkholidaychildaddBB.bo1.deptAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.hileaderAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.hileaderAuditResultvalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.hileaderAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{networkholidaychildaddBB.bo1.hileaderAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.leaderAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.leaderAuditCausevalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.leaderAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{networkholidaychildaddBB.bo1.leaderAuditDate}" />
					 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.manAuditOper}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
...
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.manAuditResultvalue}" />
 <f:verbatim></td>
			</tr>
				...
				<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.bo1.manAuditCause}" />
 <f:verbatim></td>
			</tr>
...
<h:outputText
					escape="false"
					value="#{networkholidaychildaddBB.bo1.manAuditDate}" />
					 <f:verbatim></td>
			</tr>
			...
			<tr>
				<td align="center" height="100" style="border: 1px solid #666666"
					rowspan="3"></f:verbatim> <h:outputText escape="false"
					value="人<br>力<br>资<br>源<br>审<br>批" /> <f:verbatim></td>
									<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="姓名" /> <f:verbatim></td>
				<td height="40" align="center" width="80"
					style="border: 1px solid #555555;"></f:verbatim>
<h:outputText
					escape="false" style="text-align:center;width:100%"
					value="#{networkholidaychildaddBB.personName}" />
 <f:verbatim></td>
 				<td align="center" height="40" style="border: 1px solid #666666"></f:verbatim> <h:outputText escape="false"
					value="意见" /> <f:verbatim></td>
				<td height="40" align="center" width="80" colspan="3"
					style="border: 1px solid #555555;"></f:verbatim>
			<h:selectOneMenu value="#{networkholidaychildaddBB.status}" onchange="submit();"
				valueChangeListener="#{networkholidaychildaddBB.changeStatus}">
 ...
 <f:verbatim></td>
				...
				<td height="40" align="center" width="80" colspan="6"
					style="border: 1px solid #555555;"></f:verbatim>
			<h:inputTextarea value="#{networkholidaychildaddBB.bo1.hrAuditCause}" rows="3"
				cols="80" />
 <f:verbatim></td>
			</tr>
			...
			<h:commandButton styleClass="button01" value="确认"
				action="#{networkholidaychildaddBB.saveoraudit3}" />
					 <f:verbatim></td>
			</tr>
