...
<script type="text/javascript">
	function doAddItem(id) {
		window.showModalDialog("/attence/outWork/personOutWorkAuditEdit.jsf?outWorkNo="
	...
	function doAddItem1(id) {
		window.showModalDialog(
				"/attence/outWork/personOutWorkAuditEdit1.jsf?outWorkNo=" + id
	...
	function doAddItem2(id) {
		window.showModalDialog(
				"/attence/outWork/personOutWorkAuditEdit2.jsf?outWorkNo=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
						+ screen.height * 1.0 + "px; status:0;resizable:yes");
		return true;
	...
	function doAddItem3(id) {
		window.showModalDialog(
				"/attence/outWork/personOutWorkAuditEdit3.jsf?outWorkNo=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
	...
	function doAddItem4(id) {
		window.showModalDialog(
				"/attence/outWork/personOutWorkAuditEdit4.jsf?outWorkNo=" + id
						+ "&operID=" + document.all("form1:operID").value, "",
				"dialogWidth:" + screen.width * 0.6 + "px; dialogHeight:"
						+ screen.height * 1.0 + "px; status:0;resizable:yes");
		return true;
