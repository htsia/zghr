...
<script>
    ...
    function addMore(){
        window.showModalDialog("/attence/outWork/personWorkOutAdd.jsf","","dialogWidth:600px; dialogHeight:400px; status:0;resizable:yes");
        return true;
    }
...
<h:form id="form1">
	...
	<h:panelGrid width="98%" columns="1" >
		<h:panelGrid columns="1" align="left" >
				...
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{attOutWorkMgrBB.beginTime}"
			...
			<h:outputText escape="false" value=" 至  " />
                ...
                <h:commandButton value="查询" action="#{attOutWorkMgrBB.doQuery}"
        ...
        <h:panelGrid columns="1" align="right">
                        <h:panelGroup>
				<h:outputText
					value="记录数:#{attOutWorkMgrBB.mypage.totalRecord}"></h:outputText>
				<h:outputText value="  "></h:outputText>
				<h:outputText value="页数:#{attOutWorkMgrBB.mypage.totalPage}"></h:outputText>
				<h:outputText value="  "></h:outputText>
				<h:outputText value="每页有#{attOutWorkMgrBB.mypage.pageSize}"></h:outputText>
				<h:outputText value="  "></h:outputText>
				<h:outputText
					value="当前为第#{attOutWorkMgrBB.mypage.currentPage}页"></h:outputText>

				<h:commandButton value="首页" action="#{attOutWorkMgrBB.first}"
					styleClass="button01"></h:commandButton>
				<h:commandButton value="上页" action="#{attOutWorkMgrBB.pre}"
					styleClass="button01"></h:commandButton>
				<h:commandButton value="下页" action="#{attOutWorkMgrBB.next}"
					styleClass="button01"></h:commandButton>
				<h:commandButton value="尾页" action="#{attOutWorkMgrBB.last}"
					styleClass="button01"></h:commandButton>
                <h:outputText value="  "></h:outputText>
	...
	<x:dataTable value="#{attOutWorkMgrBB.personList}" id="dateList"
		...
		<h:column>
			<f:facet name="header">
				<h:outputText value="公出人员" styleClass="td03" />
			</f:facet>
        ...
        <h:column>
			...
			<h:commandButton action="#{attOutWorkMgrBB.deleteOutWork}" styleClass="button01" value="删除">
