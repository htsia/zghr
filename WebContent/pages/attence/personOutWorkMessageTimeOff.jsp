...
<h:form id="form1">
    <h:commandButton id="refresh" value="刷新" style="display:none;" action="#{personoutworkBB.makesures}"></h:commandButton>
    <h:inputHidden value="#{personoutworkBB.pageInit3}" />
	<c:verbatim>
	...
	<f:verbatim>
		<table align="center" border="0" width="610" id="table1"
			...
			<h:outputText styleClass="input" style="border:0px;"
				value="#{personoutworkBB.personIdTimeOff}"/>
				<f:verbatim>
				</td>
			</tr>
			
			<tr>
				<td align="center" height="40" class="table_rlbt">本次公出最大倒休天数</td>
				<td height="40" colspan=6 class="table_rlbt">
				</f:verbatim>
			<h:outputText styleClass="input" style="border:0px;" id="totalday1" 
				value="#{personoutworkBB.personIdTimeOffDay}"/>
				<f:verbatim>
				</td>
			</tr>
			...
			<h:panelGroup>
				<h:inputText styleClass="input" id="beginTime" size="30"
					alt="起始日期|0|d" value="#{personoutworkBB.timeoffbegindatevalueWdate}" onclick="timeCheck();"
				    readonly="true"/>
				    <f:verbatim>
			...
			<h:outputText escape="false" value=" 至  " />
				...
				<h:inputText styleClass="input" id="endTime" alt="结束日期|0|d" onclick="timeCheck();"
					size="30" value="#{personoutworkBB.timeoffenddatevalueWdate}" readonly="true"/>
					<f:verbatim>
			...
			<h:inputText styleClass="input" style="border:0px;" id="totalday2" 
				value="#{personoutworkBB.timeoffkqglLeaverDayValue}" readonly="true"/>
				<f:verbatim>
				</td>
			</tr>
            ...
            <h:commandButton styleClass="button01" value="确认" action="#{personoutworkBB.personEvectionMessageTimeOff}" disabled="#{personoutworkBB.isExist3==false}"/>
				<f:verbatim>
				</td>
			</tr>
