...
<%
    ...
    if (user == null) {
        ...
        title = "文本分析结果查看";
        url = "/lead/TextResult.jsf";
    }
%>

    <script type="text/javascript" language="javascript">
        function refreshList(resId) {
                document.list.location = "/lead/TextResult.jsf?resId=" + resId;
        }
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="center" valign="top" class="explorer" id="showTree" width="210">
                               <iframe name="tree" height="100%"  frameborder="0"  scrolling="auto" width="100%"  src="/pages/lead/datashow/TextResourceTree.jsp"></iframe>
                    </td>
