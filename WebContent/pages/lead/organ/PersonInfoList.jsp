...
<%@ page import="com.hr319wg.doc.ucc.IDocBrowseUCC" %>
<%@ page import="com.hr319wg.doc.pojo.vo.GeneralInfoVO" %>
...
<h:form id="form1">
    ...
    <c:verbatim>
        ...
        <%
            ...
            IDocBrowseUCC docbrow = (IDocBrowseUCC) SysContext.getBean("doc_idocBrowseUCC");
            ...
            if (list != null && list.size() > 0) {
                for (int i = 0; i < list.size(); i++) {
                    ...
                    GeneralInfoVO gv = docbrow.getGeneralInfoVO(id);
                    if (gv!=null){
                        studyDegree=CodeUtil.interpertCode(null,CommonFuns.filterNull(gv.getStudyDegree()));
                        curDegree=CodeUtil.interpertCode(null,CommonFuns.filterNull(gv.getCurDegree()));
                    }
        %>
                <tr>
                    <td width=180 align="left" valign="top">
                            <a onclick="forView('<%=id%>')"><img width=<%=Constants.PHOTOWIDTH%> height=<%=Constants.PHOTOHEIGHT%> src="<%=img%>" alt="" style="cursor:pointer"></a><br><br>
                            ...
                            <strong>第一学历:</strong><%=studyDegree%><br>
                            <strong>最高学历:</strong><%=curDegree%><br><br>
                     </td>
         <%
                    i++;
                    ...
                    if (avo!=null){
                     ...
                     studyDegree="";
                     curDegree="";
                     gv = docbrow.getGeneralInfoVO(id);
                     if (gv!=null){
                         studyDegree=CodeUtil.interpertCode(null,CommonFuns.filterNull(gv.getStudyDegree()));
                         curDegree=CodeUtil.interpertCode(null,CommonFuns.filterNull(gv.getCurDegree()));
                     }
