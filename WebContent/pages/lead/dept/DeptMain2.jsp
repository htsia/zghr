...
<%
    ...
    if (url == null || "".equals(url)) {
        SelfOperateBO sb = us.getSelfOperateBO("0201");
        url = sb.getUrl();
    }
%>
...
<c:verbatim>
  ...
  <tr>
            ...
            <tr>
                    <%
                        ...
                        for(int i=0;i<childMenu.size();i++){
							...
							out.println("<a href=\"/lead/DeptMain2.jsf?moduleId="+cMenu.getOperateId()+"\">"+cMenu.getName()+"</a>");
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
          <%if (!"0201".equals(moduleId)){%>
          <td id="showTree" align="left" width=200>
                     <iframe name="tree" height="400"  style="height:100%;width:100%" src="/pages/ShowSelfOperateTree.jsp?Root=BMJLZZ"></iframe>
                </td>
