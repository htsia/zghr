...
<script type="text/javascript">
    function addDictionary(){
        window.showModalDialog("/rule/LawDictEdit.jsf", null, "dialogWidth:330px; dialogHeight:140px;center:center;resizable:no;status:no;scroll:no;");
        document.tree.location.href="/pages/common/ShowLawType.jsp";
    }
    function modifyDictionary(){
        ...
        window.showModalDialog("/rule/LawDictEdit.jsf?dicID="+document.all("form1:currentID").value, null, "dialogWidth:330px; dialogHeight:140px;center:center;resizable:no;status:no;scroll:no;");
        document.tree.location.href="/pages/common/ShowLawType.jsp";
        return false;
    }
    ...
    function refreshList(orgId) {
        ...
        document.main.location.href = "/rule/LawManagerListChild.jsf?superId=" + orgId;
    }
...
<h:form id="form1">
	  <h:inputHidden id="currentID" value="#{law_editbb.dicID}"></h:inputHidden>
            ...
            <td id="showTree" width="210">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td align="right">
                        ...
                        <h:commandButton styleClass="button01"  value="删除" action="#{law_editbb.DeleteType}" onclick="return deletedDictionary();"></h:commandButton>
<f:verbatim>
                        </td>
                    </tr>
                    <tr><td height="8px"></td></tr>
            ...
            <td align="center" valign="top">
                        <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                    src="/rule/LawManagerListChild.jsf"></iframe>
            </td>
        </tr>
    </table>
</f:verbatim>    
