...
%>
    ...
    <script type="text/javascript">
        function setScore(id) {
            window.showModalDialog("/xys/eva/DeptKpiScoreSet.jsf?objId="+id, null, "dialogWidth:"+screen.width+"px;dialogHeight:"+screen.height+"px;center:center;resizable:no;status:no;scroll:yes;");
            return true;
        }
    </script>
...
<h:form id="form1">
    <h:inputHidden value="#{dept_KpiAuditBB.pageInit}"></h:inputHidden>
     <c:verbatim>
    ...
    <br>
     ...
     <x:dataTable value="#{dept_KpiAuditBB.objList}" var="list" align="center" id="dateList" rowIndexVar="index"
