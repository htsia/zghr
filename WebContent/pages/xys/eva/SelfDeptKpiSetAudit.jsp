...
%>
    ...
    <script type="text/javascript">
        ...
        function auditKey(id){
            window.showModalDialog("/xys/eva/SelfDeptKpiAudit.jsf?objId="+id, null, "dialogWidth:"+screen.width*0.6+"px;dialogHeight:"+screen.height*0.6+"px;center:center;resizable:no;status:no;scroll:yes;");
            return true;
        }
        function preview(id){
            window.showModalDialog("/pages/xys/eva/PreviewDeptKpi.jsp?objId="+id, null, "dialogWidth:"+screen.width*0.6+"px; dialogHeight:"+screen.height*0.6+"px;center:center;resizable:no;status:no;scroll:yes;");
        }
    </script>

<x:saveState value="#{self_DeptKpiSetBB}"></x:saveState>
<h:form id="form1">
    <h:inputHidden value="#{self_DeptKpiSetBB.initDeptAudit}"></h:inputHidden>
     <c:verbatim>
