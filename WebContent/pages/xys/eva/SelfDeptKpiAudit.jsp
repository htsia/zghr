...
<x:saveState value="#{self_DeptKpiSetBB}"/>
<h:form id="form1">
    <h:inputHidden id="initEdit" value="#{self_DeptKpiSetBB.initAudit}"></h:inputHidden>
    <c:verbatim>
    ...
    <h:commandButton styleClass="button01" value="通过" action="#{self_DeptKpiSetBB.auditPass}"/>
    <h:outputText value="  "></h:outputText>
    <h:commandButton styleClass="button01" value="退回" action="#{self_DeptKpiSetBB.auditOut}"/>
    <c:verbatim>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        </td>
        </tr>
