          ...
          <h:panelGrid align="right" columns="2">
             <h:panelGroup>
	            ...
	            <h:outputText value="当前为第#{person_360AuditCtrBB.mypage.currentPage}页"></h:outputText>
           		<h:commandButton value="首页" action="#{person_360AuditCtrBB.first}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{person_360AuditCtrBB.pre}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{person_360AuditCtrBB.next}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{person_360AuditCtrBB.last}" styleClass="button01"></h:commandButton>
            </h:panelGroup>
          </h:panelGrid>
    ...
    <h:dataTable value="#{person_360AuditCtrBB.planList}" var="list" align="center" id="dateList"
        ...
        <h:column>
            ...
            <h:panelGrid columns="3" align="center">
	            ...
	            <h:commandButton value="开始打分" action="#{person_360AuditCtrBB.beginGrade}" styleClass="button01" 
	            ...
	            <h:commandButton value="结束打分" action="#{person_360AuditCtrBB.endGrade}" styleClass="button01" rendered="#{list.status=='2'&&list.person360Status=='1'}">
	                  <x:updateActionListener property="#{person_360AuditCtrBB.planId}" value="#{list.planId}"/>
	            </h:commandButton>
