   ...
   %>
       <tr>
           <td align="center" width="60%">
               <span style="font-size:18px;font-weight:bold;" ><%=obo.getName()%>KPI考核</span>
            </td>
           ...
           <table class="table02"  align="center" width="100%">
               <%
                   ...
                   if(libList!=null&&libList.size()>0){
                	   out.println("<tr>");
                	   out.println("<td class='td_xys_top' style='width:80px'>指标名称</td>");
                	   out.println("<td  class='td_xys_top' >指标内容和工作计划</td>");
                	   out.println("<td class='td_xys_top' >目标值</td>");
                	   out.println("<td class='td_xys_top' style='width:100px'>评分标准</td>");
	                	   ...
	                	   XysKpiObjLibBO lib = (XysKpiObjLibBO) libList.get(i);
	                        ...
	                        if (items != null && items.size() > 0) {
	                            ...
	                            for (int j = 1; j < items.size(); j++) {
	                                ...
	                                out.println("<td class='td_xys_mid'><div style='margin:6px'>");
		                            out.println(itembo.getKeyName());
		                            out.println("</td>");
