...
%>
    ...
    <script type="text/javascript">
        function refreshList(orgId) {
            ...
            document.main.location.href = "/xys/eva/Person360ScoreQry.jsf?superId="+orgId
                    +"&planId="+planId;
        }
...
<h:form id="form1">
    <h:inputHidden id="initIndex" value="#{person_360AuditCtrBB.initIndex}"/>
           ...
           <td width="10" class="ctrlbar" valign="middle">
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/xys/eva/Person360ScoreQry.jsf"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
