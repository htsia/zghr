...
<h:form id="form1">
          ...
          <h:panelGrid align="right" columns="2">
             <h:panelGroup>
	            ...
	            <h:outputText value="当前为第#{dept_KpiAuditCtrBB.mypage.currentPage}页"></h:outputText>
           		<h:commandButton value="首页" action="#{dept_KpiAuditCtrBB.first}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{dept_KpiAuditCtrBB.pre}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{dept_KpiAuditCtrBB.next}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{dept_KpiAuditCtrBB.last}" styleClass="button01"></h:commandButton>
            </h:panelGroup>
          </h:panelGrid>
    ...
    <h:dataTable value="#{dept_KpiAuditCtrBB.planList}" var="list" align="center" id="dateList"
        ...
        <h:column>
            ...
            <h:commandButton value="开始打分" action="#{dept_KpiAuditCtrBB.beginGrade}" styleClass="button01" 
            ...
            <h:commandButton value="结束打分" action="#{dept_KpiAuditCtrBB.endGrade}" styleClass="button01" rendered="#{list.status=='2'&&list.deptKpiStatus=='1'}">
                  <x:updateActionListener property="#{dept_KpiAuditCtrBB.planId}" value="#{list.planId}"/>
            </h:commandButton>
