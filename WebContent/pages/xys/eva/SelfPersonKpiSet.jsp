...
%>
    ...
    <script type="text/javascript">
        ...
        function preview(id){
            window.showModalDialog("/pages/xys/eva/PreviewDeptKpi.jsp?objId="+id, null, "dialogWidth:"+screen.width+"px; dialogHeight:"+screen.height+"px;center:center;resizable:no;status:no;scroll:yes;");
        }
    </script>

<x:saveState value="#{self_PersonKpiSetBB}"></x:saveState>
<h:form id="form1">
    <h:inputHidden value="#{self_PersonKpiSetBB.pageInit}"></h:inputHidden>
     <c:verbatim>
       <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
           ...
           <td class="td_title">
                 ...
                 <h:selectBooleanCheckbox value="#{self_PersonKpiSetBB.selectAll}" onclick="submit();" valueChangeListener="#{self_PersonKpiSetBB.queryAll}" />
    <c:verbatim>
         &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
           </td>
        </tr>
     ...
     <h:dataTable value="#{self_PersonKpiSetBB.objList}" var="list" align="center" id="dateList"
        ...
        <h:column>
            <c:facet name="header"><h:outputText value="操作"/></c:facet>
              ...
              <h:commandButton value="报批指标" action="#{self_PersonKpiSetBB.submitObj}" styleClass="button01" rendered="#{list.keyStatus=='1'||list.keyStatus=='F'}">
