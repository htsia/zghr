...
<table border="1"  align="center" id="dateList" width="100%" style="font-size:10pt">
			...
			<%	
				if(planId!=null&&!planId.equals("")){
					list=ucc.getXysDeptObjExportVOByPlanId(planId);
					if(list!=null&&list.size()>0){
					    ...
					    if(list!=null&&list.size()>0){
					    	...
					    	for(int i=0;i<size;i++){
					    		...
					    		sb.append("<tr>");
					    		XysDeptObjExportVO vo=(XysDeptObjExportVO)list.get(i);
					    		sb.append("<td>");
					    		sb.append(vo.getDeptName());
					    		sb.append("</td>");
					    		sb.append("<td>");
					    		sb.append(vo.getPersonName());
					    		sb.append("</td>");
					    		sb.append("<td>");
					    		sb.append(vo.getPersonCode());
					    		sb.append("</td>");
					    		sb.append("<td>");
