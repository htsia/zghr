...
<table border="1"  align="center" id="dateList" width="100%" style="font-size:10pt">
			<%
				...
				try {
					...
					ucc.exportPerson360ByPlanId(planId);
					...
					if(temList!=null&&temList.size()>0){
					    ...
					    if(temList!=null&&temList.size()>0){
					    	...
					    	for(int i=0;i<size;i++){
					    		...
					    		sb.append("</td>");
					    		sb.append("<td>");
					    		sb.append(CommonFuns.filterNull(vo.getV4()));
					    		sb.append("</td>");
					    		sb.append("<td>");
					    		sb.append(CommonFuns.filterNull(vo.getV5()));
					    		sb.append("</td>");
					    		sb.append("<td>");
					    		sb.append(CommonFuns.filterNull(vo.getV6()));
					    		sb.append("</td>");
					    		sb.append("</tr>");
