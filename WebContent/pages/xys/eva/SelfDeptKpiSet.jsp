     ...
     <h:dataTable value="#{self_DeptKpiSetBB.objList}" var="list" align="center" id="dateList"
        ...
        <h:column>
            <c:facet name="header"><h:outputText value="操作"/></c:facet>
              ...
              <h:commandButton value="报批指标" onclick="return confirm('确定要报领导审批吧?确认后将不能再编辑指标.')" action="#{self_DeptKpiSetBB.submitObj}" styleClass="button01" rendered="#{list.keyStatus=='1'||list.keyStatus=='F'}">
