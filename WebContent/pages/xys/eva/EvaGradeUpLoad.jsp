...
<h:form id="form1" enctype="multipart/form-data">
    <h:inputHidden id="initUpload" value="#{xys_evaPlanCaclBB.initUpload}"></h:inputHidden>
        ...
        <h:panelGrid columns="2" width="100%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
            ...
            <h:outputText value="附件"></h:outputText>
             <h:panelGroup>
 					...
 					<h:commandButton value="上传"  styleClass="button01" action="#{xys_evaPlanCaclBB.uploadFile}" onclick="showProcessBar();"/>
