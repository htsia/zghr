...
%>
    ...
    <script type="text/javascript">
        function preview(id){
            window.showModalDialog("/xys/eva/SelfPersonKpiScoreSet.jsf?objId="+id, null, "dialogWidth:"+screen.width*0.8+"px; dialogHeight:"+screen.height*0.8+"px;center:center;resizable:no;status:no;scroll:yes;");
        }
...
<h:form id="form1">
    <h:inputHidden value="#{self_PersonKpiGradeBB.pageInit}"></h:inputHidden>
     <c:verbatim>
       <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
           ...
           <td class="td_title">
                 ...
                 <h:selectBooleanCheckbox value="#{self_PersonKpiGradeBB.selectAll}" onclick="submit();" valueChangeListener="#{self_PersonKpiGradeBB.queryAll}" />
    <c:verbatim>
         &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
           </td>
        </tr>
     ...
     <h:dataTable value="#{self_PersonKpiGradeBB.objList}" var="list" align="center" id="dateList"
