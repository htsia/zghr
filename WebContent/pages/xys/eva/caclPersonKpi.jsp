...
<h:form id="form1">
    <h:inputHidden value="#{xys_evaPlanCaclBB.initPersKpi}"></h:inputHidden>
     <c:verbatim>
    <br>
    ...
    <h:panelGrid width="98%" columns="2">
		  ...
		  <h:panelGroup>
                  ...
                  <h:commandButton value="查询" action="#{xys_evaPlanCaclBB.queryPersonKpi}" styleClass="button01"></h:commandButton>
              </h:panelGroup>
		  </h:panelGrid>
          <h:panelGrid align="right" columns="2">
             <h:panelGroup>
	            ...
	            <h:outputText value="当前为第#{xys_evaPlanCaclBB.mypage.currentPage}页"></h:outputText>
           		<h:commandButton value="首页" action="#{xys_evaPlanCaclBB.first1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{xys_evaPlanCaclBB.pre1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{xys_evaPlanCaclBB.next1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{xys_evaPlanCaclBB.last1}" styleClass="button01"></h:commandButton>
            </h:panelGroup>
          </h:panelGrid>
    ...
    <c:verbatim>
     ...
     <x:dataTable value="#{xys_evaPlanCaclBB.persKpiObjList}" var="list" align="center" id="dateList" rowIndexVar="index"
