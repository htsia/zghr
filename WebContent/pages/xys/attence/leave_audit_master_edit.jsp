...
%>
  ...
  <h:form id="form1">
      <h:inputHidden id="initEdit" value="#{xysLeaveAuditBB.initMasterAuditEdit}"></h:inputHidden>
      ...
      <h:panelGrid columns="1"  width="98%" align="left">
           ...
           <h:panelGrid align="right">
              <h:commandButton value="审批"  styleClass="button01"  action="#{xysLeaveAuditBB.saveMasterAudit}"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
