...
<h:form id="form1">
    ...
    <h:panelGrid align="center" width="98%" columns="1">
        <h:panelGrid columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
            ...
            <h:selectOneMenu id="status" value="#{midAuditEidtRucuPlanBB.planbo.midAudResult1}">
                <c:selectItem itemValue="1" itemLabel="同意"/>
                <c:selectItem itemValue="0" itemLabel="不同意"/>
            </h:selectOneMenu>

            <h:outputText value="原因"/>
            <h:inputTextarea value="#{midAuditEidtRucuPlanBB.planbo.midAudContent1}" rows="3" cols="80"/>

            <h:outputText value="操作"/>
            <h:commandButton styleClass="button01" value="审批" action="#{midAuditEidtRucuPlanBB.audit1}"
