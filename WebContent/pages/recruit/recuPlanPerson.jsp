...
<f:verbatim>
    <script type="text/javascript">
        function doQuery(id) {
            window.open("/recruit/interViewPost.jsf?planID="+id, null, "dialogWidth:900px; dialogHeight:450px;center:center;resizable:no;status:no;scroll:no;");
            return true;
        }
    </script>
</f:verbatim>
...
<h:form id="form1">
   ...
   <c:verbatim>
    ...
    <x:dataTable value="#{recu_recuPersonBB.planList}" width="100%" var="list" rowIndexVar="index" align="center" id="dateList"
                     headerClass="td_top" columnClasses="td_middle_center,td_middle_center,td_middle_center,td_middle_center,td_middle_center"
                     styleClass="table03" >
             <h:column>
        ...
        <h:column>
                 ...
                 <h:commandButton value="拟录名单审批" styleClass="button01" onclick="return doQuery('#{list.planID}');"></h:commandButton>
            </h:column>
    </x:dataTable>
