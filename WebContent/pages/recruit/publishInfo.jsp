...
<script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/recruit/recuPublishInfoList.jsf?superId=" + orgId;
        }
...
<h:form id="form1">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif"> 招聘管理 ->外部招聘计划信息发布</td>
        </tr>
    </table>
     </c:verbatim>
  <c:verbatim>
        ...
        <tr>
            ...
            <td align="center" valign="top">
             <iframe name="main" frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/recruit/recuPublishInfoList.jsf"></iframe>
           </td>
        </tr>
    </table>
    </c:verbatim>
