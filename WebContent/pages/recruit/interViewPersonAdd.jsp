...
<h:form id="form1">
    <h:inputHidden value="#{recu_interviewResultBB.initAdd}"></h:inputHidden>
    <c:verbatim>
    ...
    <c:verbatim>
        ...
        <tr><td height=8 align="right">
            ...
            <h:inputText id="codValue" value="#{recu_interviewResultBB.codValue}"></h:inputText>
            <h:outputText value="  "></h:outputText>
            <h:commandButton value="查询" onclick="check()" action="#{recu_interviewResultBB.QueryAddPerson2}" styleClass="button01"></h:commandButton>
    		<h:outputText value="共#{recu_interviewResultBB.mypage.totalPage}页"></h:outputText>
            <h:outputText value="  "></h:outputText>
            ...
            <h:commandButton value="首页" action="#{recu_interviewResultBB.addfirst}" styleClass="button01"></h:commandButton>
            <h:commandButton value="上页" action="#{recu_interviewResultBB.addpre}" styleClass="button01"></h:commandButton>
            <h:commandButton value="下页" action="#{recu_interviewResultBB.addnext}" styleClass="button01"></h:commandButton>
            <h:commandButton value="尾页" action="#{recu_interviewResultBB.addlast}" styleClass="button01"></h:commandButton>
            <h:outputText value="  "></h:outputText>
    ...
    <c:verbatim>
        ...
        <h:dataTable value="#{recu_interviewResultBB.addPersonList}" var="list" width="100%" id="dateList"
