...
<br>
   <table width=95% align=center border=0 cellpadding=0 cellspacing=0>
    <tr nowrap>
		...
		<td align="right"></f:verbatim><h:commandButton type="button" styleClass="button01" value="添加" onclick="addA838()" ></h:commandButton><f:verbatim></td>
     </tr>
     <tr>
     	<td colspan="3">
  ...
  <x:dataTable  headerClass="td_top" styleClass="table03"  width="100%" rowIndexVar="index"
        columnClasses="td_middle_left,td_middle_left" id="a838List"  align="center" border="0"  value="#{ResumeManageRecuitBB.a838List}"    var="list">
