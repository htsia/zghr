...
<%@ include file="/pages/include/taglib.jsp" %>
    ...
    <script type="text/javascript">
      ...
      <h:form id="form1">
          <h:inputHidden value="#{recruit_outterPostBB.initView}"></h:inputHidden>
<c:verbatim>
          ...
          <h:panelGrid styleClass="td_title" width="98%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="1">
             <h:panelGroup>
                  ...
                  <h:outputText value=" 招聘管理 ->  外部招聘名单"/>
              </h:panelGroup>
          </h:panelGrid>
<c:verbatim>
         </td></tr>
          ...
          <tr>
              <td>
                  <div style='width:100%;height:100%;overflow:auto' id=datatable>
                      ...
                      <x:dataTable value="#{recruit_outterPostBB.personlist}" var="list"  rowIndexVar="index" id="data"
