...
<%@ include file="/pages/include/taglib.jsp" %>
 ...
 <h:form id="form1" >
      <h:inputHidden id="initPostEdit" value="#{recruit_outterPostBB.initPostEdit}"></h:inputHidden>
      ...
      <h:panelGrid columns="1"  width="100%" align="left">
           <h:panelGrid columns="2" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
				...
				<h:inputText styleClass="input" id="postType" code="" dict="yes" dict_num="0110"
                     readonly="true" value="#{recruit_outterPostBB.outterBo.postType}"
                     alt="岗位类别|0|s|50||"/>
				...
				<h:inputText styleClass="input" id="majorType" code="" dict="yes" dict_num="0370"
                     readonly="true" value="#{recruit_outterPostBB.outterBo.majorType}"
                     alt="专业|0|s|50||"/>
           ...
           <h:panelGrid align="right">
              <h:commandButton value="保存" id="save" onclick="return checkDateNull();"  action="#{recruit_outterPostBB.savePost}"  styleClass="button01"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
<script type="text/javascript">
