...
<h:form id="form1">
    <h:inputHidden id="pageInit" value="#{coalTaskMgrBB.initAmerceEdit}"/>

    <h:panelGrid align="center" width="90%">
        <h:panelGrid columns="2" width="100%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
            <h:outputText value="违法时间"/>
            <h:panelGroup>
            	<h:inputText id="operateTime" value="#{coalTaskMgrBB.amercebo.operateTime}" readonly="true"></h:inputText>
            ...
            <h:inputText id="address" value="#{coalTaskMgrBB.amercebo.address}" />
            <h:outputText value="违法操作"/>
            <h:panelGroup>
            	<h:inputText id="taskStandard" value="#{coalTaskMgrBB.amercebo.itemName}" />
            	<h:inputHidden id="itemId" value="#{coalTaskMgrBB.amercebo.itemId}"></h:inputHidden>
            	<h:commandButton type="button" styleClass="button_select" onclick="selectItem()"></h:commandButton>
            </h:panelGroup>
        </h:panelGrid>

        <h:panelGrid columns="2" align="right" cellspacing="2">
            <h:commandButton styleClass="button01" value="保存" action="#{coalTaskMgrBB.saveAmerce}"/>
        </h:panelGrid>
    </h:panelGrid>
</h:form>
