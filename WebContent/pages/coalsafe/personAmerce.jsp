...
function amerce(id){
    window.showModalDialog("/coalsafe/taskAmerce.jsf?itemId="+id, null, "dialogWidth:"+screen.width*0.4+"px; dialogHeight:"+screen.height*0.3+"px;center:center;resizable:yes;status:no;scroll:yes;");
    return true;
}
</script>
      ...
      <h:panelGrid width="98%" columns="1" align="center">
          ...
          <x:dataTable value="#{coalTaskMgrBB.personList}"  id="dateList"
                ...
                <h:column>
                    ...
                    <h:commandButton value="扣分" onclick="amerce('#{briefList.itemId}');" styleClass="button01"></h:commandButton>
                </h:column>
			</x:dataTable>
			<f:verbatim>
				<br>
