...
<h:form id="form1">
      <h:inputHidden value="#{coalOverseeMgrBB.selfPageInit}"></h:inputHidden>
       ...
       <h:panelGroup>
	        ...
	        <h:outputText value=" 监控执法  -> 自助查询监控扣分"/>
	        </h:panelGroup>
       </h:panelGrid>
      <h:panelGrid width="98%" columns="1" align="center">
      	  <h:panelGrid columns="2">
      	  		<h:panelGroup>
      	  			...
      	  			<h:outputText value=""></h:outputText>
      	  			<h:commandButton value="查询" action="#{coalOverseeMgrBB.doQuery1}" styleClass="button01"></h:commandButton>
      	  		</h:panelGroup>
      	  </h:panelGrid>
		  <h:panelGrid columns="2" align="right">
	            ...
	            <h:outputText value="当前为第#{coalOverseeMgrBB.mypage.currentPage}页"></h:outputText>
           		<h:commandButton value="首页" action="#{coalOverseeMgrBB.first1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="上页" action="#{coalOverseeMgrBB.pre1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="下页" action="#{coalOverseeMgrBB.next1}" styleClass="button01"></h:commandButton>
	            <h:commandButton value="尾页" action="#{coalOverseeMgrBB.last1}" styleClass="button01"></h:commandButton>
                </h:panelGroup>
          </h:panelGrid>
