...
<x:saveState value="#{train_selfdepartdemandeditbb}" />
<h:form id="form1">
	<h:inputHidden id="initEdit"
		value="#{train_selfdepartdemandeditbb.initEdit}"></h:inputHidden>
	...
	<c:verbatim>
		<table border="0" align="center" cellspacing="2" cellpadding="10"
			...
			<tr>
				<td class="td_form01">提需求者</td>
				<td class="td_form02">
	</c:verbatim> 
	<h:inputText id="personName"
					styleClass="input"
					value="#{train_selfdepartdemandeditbb.personName}" size="80"
	...
	<c:verbatim></td>
			...
			<tr>
                ...
                <td class="td_form02">
                 ...
                 <h:selectOneMenu value="#{train_selfdepartdemandeditbb.demandbo.bullId}">
				<c:selectItems value="#{train_selfdepartdemandeditbb.bullList}"/>
			</h:selectOneMenu>
<c:verbatim>
                </td>
            </tr>
			<tr>
				<td class="td_form01">所在部门</td>
				<td class="td_form02">
	</c:verbatim> 
	<h:inputText id="deptName"
					styleClass="input" value="#{train_selfdepartdemandeditbb.deptName}"
	...
	<h:selectOneMenu value="#{train_selfdepartdemandeditbb.demandbo.demandStyle}">
	...
	<h:inputText id="createDate"
					styleClass="input"
					value="#{train_selfdepartdemandeditbb.demandbo.createDate}" size="17"
					readonly="true">
				</h:inputText>
	<c:verbatim></td>
			</tr>
	...
	<h:selectOneMenu value="#{train_selfdepartdemandeditbb.demandbo.demandTime}">
	...
	<h:inputTextarea id="memo" rows="15" cols="80" style="display:none;" value="#{train_selfdepartdemandeditbb.demandbo.memo}" /> 
	<c:verbatim>
	...
	<h:panelGrid align="right">
		<h:commandButton value="保存" id="save" onclick="return forSave();"	action="#{train_selfdepartdemandeditbb.save}" styleClass="button01" />
	</h:panelGrid>
