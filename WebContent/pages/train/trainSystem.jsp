...
<script type="text/javascript">
    function refreshList(orgId) {
        ...
        document.main.location.href = "/train/trainSystemList.jsf?superId="+orgId;
    }
...
<h:form id="form1">
	  <h:inputHidden id="currentID" value="#{trainSystemBB.currentID}"></h:inputHidden>
        ...
        <tr>
            <td id="showTree" width="210">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr><td height="8px">
                   		<table>
                   			<tr>
                   				<td align="center"  class=activeTab><a href="trainSystem.jsf">按类型分</a></td>
                				<td align="center"  class=tab><a href="trainSystemPost.jsf">按岗位分</a></td>
                   			</tr>
                   		</table>
                    </td></tr>
                    ...
                    <tr> <td valign="top">
                            <iframe name="tree" height="100%"  frameborder="1"  scrolling="auto" width="100%"
                                    src="/pages/train/showCodeList.jsp"></iframe>
                    </td></tr>
                </table>
            </td>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0"  scrolling="auto" width="100%"
                                    src="/train/trainSystemList.jsf"></iframe>
            </td>
        </tr>
    </table>
</f:verbatim>    
