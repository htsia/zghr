...
<script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/train/TrainEquipmentList.jsf?superId=" + orgId;
        }
...
<h:form id="form1">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif"> 培训管理 -> 培训器材管理</td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%"
                                   src="/train/TrainEquipmentList.jsf"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
