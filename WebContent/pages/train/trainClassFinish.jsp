...
%>
    ...
    <script type="text/javascript">
         function addClass(){
             window.showModalDialog("/train/trainClassEdit.jsf?superId="+document.all("form1:superId").value, "", "dialogWidth:450px; dialogHeight:500px; status:0;resizable:yes");
             return true;
         }
        function modify(id){
            window.showModalDialog("/train/trainClassEdit.jsf?classID="+id, "", "dialogWidth:450px; dialogHeight:500px; status:0;resizable:yes");
            return true;
        }
    </script>
...
<h:form id="form1">
    ...
    <h:inputHidden id="superId" value="#{TrainClass_listBB.superId}"></h:inputHidden>
     ...
     <c:verbatim>
       <table height=98% width=98% align="center">
       	<tr height=8>
            <td class="td_title"><img src="/images/tips.gif"> 培训管理-> 培训班结算</td>
        </tr>
       <tr><td height=8> 
    </c:verbatim>
    ...
    <x:dataTable value="#{TrainClass_listBB.classList}" var="list" rowIndexVar="index" align="center" id="dateList"
       ...
       <h:column>
            ...
            <h:commandButton value="结算"  action="#{TrainClass_listBB.jiesuan}" styleClass="button01" rendered="#{list.classStatus=='3'}">
