    ...
    <h:panelGrid align="center" width="98%" columns="1">
    	<h:panelGrid width="100%" columns="2" cellspacing="2" columnClasses="td_form01,td_form02" styleClass="table03">
    	 <h:outputText value="审批意见"/>
            <h:selectOneMenu id="status" value="#{Train_planAuditeditBB.planbo.auditResult}">
                <c:selectItem itemValue="1" itemLabel="同意"/>
                <c:selectItem itemValue="0" itemLabel="不同意"/>
            </h:selectOneMenu>

            <h:outputText value="原因"/>
            <h:inputTextarea value="#{Train_planAuditeditBB.planbo.auditContent}" rows="3" cols="80"/>

            <h:outputText value="操作"/>
            <h:commandButton styleClass="button01" value="审批" action="#{Train_planAuditeditBB.audit}"
        ...
        <h:panelGrid columns="2" width="100%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
            ...
            <h:inputTextarea id="desc" value="#{Train_planAuditeditBB.planbo.planDesc}" cols="75" rows="3" style="display:none;"/>
            <c:verbatim>
