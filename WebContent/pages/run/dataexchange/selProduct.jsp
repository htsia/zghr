        ...
        <table width="95%"  >
            ...
            <td align="right">
	            ...
	            <h:selectOneMenu value="#{SendProdouctMgrBB.method}">
	            	<c:selectItem itemLabel="生产者自行生产" itemValue="1"/>
	            	<c:selectItem itemLabel="平台代为产生" itemValue="2"/>
	            </h:selectOneMenu>
	            <h:commandButton value="保存"  styleClass="button01" onclick="additem()" action="#{SendProdouctMgrBB.saveSend}"/>
<f:verbatim>
            </td></tr>
        </table>
      </td></tr>
