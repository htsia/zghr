    ...
    <tr>
        ...
        <td>
            ...
            <h:inputText id="loginName" styleClass="inputDark" alt="用户名|0|s|50"
                         value="#{daexloginBB.loginName}" size="23" tabindex="1"/>
             <h:outputText value="  "></h:outputText>
            <h:commandButton  onclick="return forsubmit(document.forms(0))" styleClass="button01" value="登录"
                    action="#{daexloginBB.login}" tabindex="3"/>
<f:verbatim>
        </td>
        <td width="54" rowspan="2"></td>
    </tr>
    ...
    <tr>
        ...
        <h:inputSecret id="password" styleClass="inputDark" alt="密码|0|s|50"     value="#{daexloginBB.password}" size="23" tabindex="2"/>
