...
<h:form id="form1">
   ...
   <h:panelGrid width="400" border="0" cellpadding="0" cellspacing="0" styleClass="table03" align="center" columns="2" columnClasses="td_form01,td_form02">
           ...
           <h:outputText value="中止合同约定起始时间"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.contStartDate}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="中止合同约定终止时间"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.contEndDate}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="恢复履行劳动合同时间"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.resumeExecuteContDate}"></h:outputText>
           </h:panelGroup>
