...
<table width="100%" height=100% border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF">
    <tr>
        <td  align="left" valign="top" class="td_title">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                            ...
                            <tr>
                                <td>
                                    <iframe name="tree" height="100%"  frameborder="0"  scrolling="yes" width="100%"
                                            height="<%=height%>"
                                            src="/pages/cont/base/PersonWageInfoSetTree.jsp"></iframe>
                                </td>
                            </tr>
                            <%
                    ...
                    <td align="center" valign="top" class="explorer">
                                    <iframe name="list" frameborder="0"  scrolling="auto" width="100%"  height="<%=height%>"
                                            src="/wage/base/PersonInfoDetail.jsf?act=init&setId=A708&persId=<%=persId.replaceAll("#","~")%>"></iframe>
                    </td>
                </tr>
            </table>
        </td>
