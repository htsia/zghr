...
<h:form id="form1">
<h:inputHidden id="str_2" value="#{cont_contSignBB.selectContIds}"/>
<%
    int  rowCount = 0;
...
<h:panelGrid width="100%" border="0" cellspacing="6" cellpadding="0" >
   <h:outputText value="合同补签维护" styleClass="td_title" style="width:100%"></h:outputText>
</h:panelGrid>
...
<h:panelGrid width="800" border="0" cellpadding="0" cellspacing="0" styleClass="table03" align="center" columns="4" columnClasses="td_form01,td_form02,td_form01,td_form02">
         ...
         <h:outputText value="#{cont_contSignBB.bo.contCode}"/>
     ...
     <h:panelGrid  border="0" cellspacing="2" cellpadding="5" align="center" columns="2">
                <h:commandButton styleClass="button01" value="保存" action="#{cont_contSignBB.save_edit}"  onclick="if( checkSubmit(document.forms(0))&&checkAll(document.forms(0)) ){ return confirmSave(document.forms(0));}else{return false;}"/>
