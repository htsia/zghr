...
<script language="javascript">
        ...
        function chkNull() {
            if (document.getElementById("form1:sumitem").value == "" ){
                ...
                document.all("form1:sumType").value="2";
                return true;
            }
        }
...
<h:form id="form1">
	<h:inputHidden value="#{cont_staticBB.initEndRule}" />
    ...
    <f:verbatim>
		...
		<table width="96%" align="center">
			<tr>
                ...
                <td align="center" width="25%" class=activetab><a href="modiEndRule.jsf?Init=true">终止合同人数</a></td>
	...
	<h:panelGrid width="98%" align="center" border="0" columns="1">
		...
		<h:dataTable styleClass="table03" align="center" width="95%"
			...
			value="#{cont_staticBB.endItemBos}" var="list" border="1">
			<h:column>
				<f:facet name="header">
