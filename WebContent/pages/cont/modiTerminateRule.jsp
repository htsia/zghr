...
<script language="javascript">
        ...
        function chkNull() {
            if (document.getElementById("form1:sumitem").value == "" ){
                ...
                document.all("form1:sumType").value="3";
                return true;
            }
        }
...
<h:form id="form1">
	<h:inputHidden value="#{cont_staticBB.initTerminateRule}" />
    <h:inputHidden id="sumType" value="#{cont_staticBB.sumType}"></h:inputHidden>
    <f:verbatim>
		<br>
		<table width="96%" align="center">
			<tr>
                <td align="center" width="25%" class=tab><a href="modiRule.jsf?Init=true">签订合同人数</a></td>
                ...
                <td align="center" width="25%" class=activetab><a href="modiTerminateRule.jsf?Init=true">解除合同人数</a></td>
	...
	<h:panelGrid width="98%" align="center" border="0" columns="1">
		...
		<h:dataTable styleClass="table03" align="center" width="95%"
			...
			value="#{cont_staticBB.terminateItemBos}" var="list" border="1">
			<h:column>
				<f:facet name="header">
