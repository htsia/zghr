...
<h:form id="form1">
   ...
   <h:panelGrid width="400" border="0" cellpadding="0" cellspacing="0" styleClass="table03" align="center" columns="2" columnClasses="td_form01,td_form02">
           ...
           <h:outputText value="劳动合同文档"></h:outputText>
           <h:panelGroup>
           ...
           <h:outputText value="终止/解除时间"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.contEndSignDate}"></h:outputText>
           </h:panelGroup>
           ...
           <h:outputText value="经济补偿金额"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.repairMoney}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="合同违约金"></h:outputText>
           <h:panelGroup>
                    <h:outputText value="#{cont_contQueryBB.bo.fellbackMoney}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="医疗补助"></h:outputText>
           <h:panelGroup>
                   <h:outputText value="#{cont_contQueryBB.bo.medicineMoney}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="其他费用"></h:outputText>
           <h:panelGroup>
                   <h:outputText value="#{cont_contQueryBB.bo.otherMoney}"></h:outputText>
           </h:panelGroup>

           <h:outputText value="劳动合同摘要"></h:outputText>
           <h:panelGroup>
