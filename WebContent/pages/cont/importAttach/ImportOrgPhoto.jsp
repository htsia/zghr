...
function checkSubmit(form1) {
        flag = true;
        var directoryOrgPhoto = form1.all("form1:directoryOrgPhoto").value;
        if (directoryOrgPhoto == "" || directoryOrgPhoto == null){
            alert("照片所在文件目录不能为空！");
            flag = false;
            return flag;
        }
...
<h:panelGrid width="100%" border="0" cellspacing="0" cellpadding="0" >
   <h:outputText value="导入机构照片" styleClass="td_title" style="width:100%"></h:outputText>
</h:panelGrid>
<h:form id="form1">
<br/><br/>
<h:panelGrid  border="0"  align="center" columns="1" width="95%">
     ...
     <h:panelGrid  border="0"  cellspacing="0" align="left" columns="3" >
         <h:outputText styleClass="td_title" value="机构照片存放的文件目录"></h:outputText>
         <h:inputText size="50" id="directoryOrgPhoto" value="#{cont_importAttachBB.directoryOrgPhoto}" />
         <h:commandButton  value="导入" action="#{cont_importAttachBB.importOrgPhoto}" onclick="javascript:return checkSubmit(document.forms(0));"/>
     </h:panelGrid>
