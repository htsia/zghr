...
<h:form id="form1">
    <h:panelGrid width="100%" border="0" cellspacing="0" cellpadding="0" >
       <h:outputText value="合同变更" styleClass="td_title" style="width:100%"></h:outputText>
    </h:panelGrid>

    <h:panelGrid  border="0"  align="center" columns="1" width="600">
     <h:panelGrid  border="0"  cellspacing="0" align="left" columns="4" >
         <h:panelGroup>
            <h:selectBooleanCheckbox value="#{cont_contChangeSignBB.asPersonCode}"></h:selectBooleanCheckbox>
            <h:outputText value="同时用于员工编号"></h:outputText>
         </h:panelGroup>

         <h:panelGroup>
             <h:selectBooleanCheckbox value="#{cont_contChangeSignBB.asLogin}"></h:selectBooleanCheckbox>
             <h:outputText value="同时用于登录名"></h:outputText>
         </h:panelGroup>
        <h:commandButton styleClass="button01" value=" 保存 " action="#{cont_contChangeSignBB.save_mainContCode}" onclick="if( forsubmit(document.forms(0)) ){}else{return false;}"/>
        <h:commandButton styleClass="button01" value="取消返回" action="#{cont_contChangeSignBB.forwardList}"/>
     </h:panelGrid>
    </h:panelGrid>
<br/>
<center>
<x:dataTable value="#{cont_contChangeSignBB.bos}" var="list"  rowIndexVar="index"
                     headerClass="td_top"
