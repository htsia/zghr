...
function selectPauseCont(ctrlobj) {
	showx = event.screenX - event.offsetX - 4 - 210 ;
	showy = event.screenY - event.offsetY + 18;
	retval = window.showModalDialog("/cont/SelectPauseCont.jsf", "", "dialogWidth:800px; dialogHeight:400px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:yes; directories:yes;scrollbars:yes;Resizable=yes; "  );
    if (retval != null) {
...
<h:panelGrid width="100%" border="0" styleClass="td_title" cellspacing="6" cellpadding="0" >
    <h:panelGroup>
        ...
        <h:outputText value="恢复履行协议维护 " ></h:outputText>
    </h:panelGroup>
</h:panelGrid>
...
<h:panelGrid  border="0"  align="center" columns="2" width="800">
    ...
    <h:panelGrid  border="0"  cellspacing="0" align="right" columns="2" >
         <h:commandButton styleClass="button01" value="选择" action="#{cont_contResumeBB.selectPauseCont}" onclick="javascript:return selectPauseCont();"/>
         <h:commandButton styleClass="button01" value="去除" action="#{cont_contResumeBB.deletePauseCont}" onclick="javascript:return deletePauseCont();"/>
    </h:panelGrid>
</h:panelGrid>
<center>
...
<h:panelGrid width="800" border="0" cellpadding="0" cellspacing="0" styleClass="table03" align="center" columns="4" columnClasses="td_form01,td_form02,td_form01,td_form02">
     ...
     <h:panelGrid  border="0" cellspacing="2" cellpadding="5" align="center" columns="2">
                <h:commandButton styleClass="button01" value="保存" action="#{cont_contResumeBB.save_add}"  onclick="if( checkSubmit(document.forms(0))&&checkAll(document.forms(0)) ){ return confirmSave(document.forms(0));}else{return false;}"/>
