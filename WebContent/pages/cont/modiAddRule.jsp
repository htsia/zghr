...
<script language="javascript">
        ...
        function chkNull() {
            if (document.getElementById("form1:sumitem").value == "" ){
                ...
                document.all("form1:sumType").value="1";
                return true;
            }
        }
...
<h:form id="form1">
	<h:inputHidden value="#{cont_staticBB.initAddRule}" />
    ...
    <f:verbatim>
		...
		<table width="96%" align="center">
			<tr>
                ...
                <td align="center" width="25%" class=activetab><a href="modiAddRule.jsf?Init=true">续订合同人数</a></td>
	...
	<h:panelGrid width="98%" align="center" border="0" columns="1">
		...
		<h:dataTable styleClass="table03" align="center" width="95%"
			...
			value="#{cont_staticBB.addItemBos}" var="list" border="1">
			<h:column>
				<f:facet name="header">
