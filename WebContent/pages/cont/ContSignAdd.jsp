...
<h:panelGrid width="100%" border="0" cellspacing="0" styleClass="td_title" cellpadding="0" >
    <h:panelGroup>
        ...
        <h:outputText value="合同补签维护" ></h:outputText>
    </h:panelGroup>
</h:panelGrid>
...
<h:panelGrid  border="0"  align="center" columns="2" width="800">
    ...
    <h:panelGrid  border="0"  cellspacing="0" align="right" columns="3" >
        <h:panelGroup>
         ...
         <h:commandButton id="advance1" styleClass="button01"  value="自定义查询" action="#{cont_contSignBB.selPerson}" onclick="return queryPerson();"/>
         <h:commandButton styleClass="button01" value="去除人员" action="#{cont_contSignBB.delPerson}" onclick="javascript:return delPerson();"/>
    </h:panelGrid>
</h:panelGrid>
...
<h:panelGrid width="800" border="0" cellpadding="0" cellspacing="0" styleClass="table03" align="center" columns="4" columnClasses="td_form01,td_form02,td_form01,td_form02">
         ...
         <h:inputText styleClass="input" value="#{cont_contSignBB.bo.contClass}" id="contClass"  code="" dict="yes" dict_num="0220" readonly="true" alt="合同处理类别|0"/>
         ...
         <h:panelGroup>
             <h:inputText styleClass="input" value="#{cont_contSignBB.bo.contTermClass}" id="contTermClass"  code="" dict="yes" dict_num="0215" readonly="true" alt="合同期限类型|0" />
         ...
         <h:panelGroup>
             <h:inputText id="contStartDate" styleClass="input" size="10" value="#{cont_contSignBB.bo.contStartDate}" readonly="true" alt="合同约定起始时间|0"/>
         ...
         <h:inputText styleClass="input" id="postName"  size="30" maxlength="15" value="#{cont_contSignBB.bo.postName}" alt="合同约定工作岗位|0|s" />
         ...
         <h:inputText styleClass="input" id="paySalaryDate"  size = "30" maxlength="30" value="#{cont_contSignBB.bo.paySalaryDate}" alt="合同约定发薪日|1|s" />
         <h:outputText value="" />
         <h:outputText value="" />

         <h:outputText value="工资标准" />
         <h:panelGroup>
            <h:inputText styleClass="input" id="standardSalaryMoney" value="#{cont_contSignBB.bo.standardSalaryMoney}" maxlength="10" alt="工资标准|1|f" />
            <h:outputText value=" 元/月" />
         </h:panelGroup>
         <h:outputText value="基本工资标准" />
         <h:panelGroup>
            <h:inputText styleClass="input" id="basicSalaryMoney" value="#{cont_contSignBB.bo.basicSalaryMoney}" maxlength="10" alt="基本工资标准|1|f" />
            <h:outputText value=" 元/月" />
         </h:panelGroup>

         <h:outputText value="绩效工资标准" />
         <h:panelGroup>
            <h:inputText styleClass="input" id="performanceSalaryMoney" value="#{cont_contSignBB.bo.performanceSalaryMoney}" maxlength="10" alt="绩效工资标准|1|f" />
            <h:outputText value=" 元/月" />
         </h:panelGroup>
         <h:outputText value="" />
         <h:outputText value="" />
         ...
         <h:panelGroup>
            <h:inputText styleClass="input" id="jobLimitTerm" value="#{cont_contSignBB.bo.jobLimitTerm}" maxlength="10" alt="竞业限制期限|1|i" />
            <h:outputText value=" 月" />
         </h:panelGroup>
         <h:outputText value="合同违约金额" />
         <h:panelGroup>
            <h:inputText styleClass="input" id="fellbackMoney" value="#{cont_contSignBB.bo.fellbackMoney}" maxlength="10" alt="合同违约金额|1|f" />
     ...
     <h:panelGrid  border="0" cellspacing="2" cellpadding="5" align="center" columns="2">
                <h:commandButton styleClass="button01" value="保存" action="#{cont_contSignBB.save_add}"  onclick="if( checkSubmit(document.forms(0))&&checkAll(document.forms(0)) ){ return confirmSave(document.forms(0));}else{return false;}"/>
