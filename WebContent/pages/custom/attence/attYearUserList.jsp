			...
			<tr>
				<td height=1></c:verbatim> <h:panelGrid width="98%" columns="1">
						<h:panelGrid align="left" columns="1">
							<h:panelGroup>
								<h:commandButton value="计算年出勤" onclick="yearAttenceDay()"
									styleClass="button01"></h:commandButton>
								<h:outputText value="  " />
								<h:outputText value="年份" />
								<h:inputText id="selectMonth" readonly="true" styleClass="input"
									size="10" onclick="WdatePicker({alwaysUseStartDate:true,dateFmt:'yyyy'})"
									value="#{attPutoffMgrBB.yearStr}" />
								...
								<h:commandButton styleClass="button01" value="查询"
									action="#{attPutoffMgrBB.attYearDoQuery}" />
			...
			<tr>
				<td>
					<div style='width: 100%; height: 100%; overflow: auto' id=datatable>
						...
						<h:dataTable value="#{attPutoffMgrBB.yearList}" var="list"
