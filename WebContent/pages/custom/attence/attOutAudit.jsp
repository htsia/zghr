...
%>
    ...
    <script type="text/javascript">
       ...
       function audit(id,taskId) {
           window.showModalDialog("/custom/attence/attOutAuditEdit.jsf?id="+id+"&taskId="+taskId, null, "dialogWidth:"+screen.width*0.5+"px;dialogHeight:"+screen.height*0.5+"px;center:center;resizable:no;status:no;scroll:yes;");
           return true;
       }
...
<x:saveState value="#{attOutAuditBB}"/>
<h:inputHidden value="#{attOutAuditBB.initAudit}"/>
<h:form id="form1">
<h:inputHidden id="selectedItemIDs" value="#{attOutAuditBB.selectedItemIDs}"/>
     <c:verbatim>
       <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
           ...
           <td class="td_title" align="right" style="padding-right:30px;">
			    ...
			    <h:selectOneMenu value="#{attOutAuditBB.result}">
			     	<c:selectItem itemLabel="通过" itemValue="1"/>
			     	<c:selectItem itemLabel="退回" itemValue="0"/>
			    </h:selectOneMenu>
           		<h:commandButton value="批量审批" styleClass="button01" onclick="return batchAudit();" action="#{attOutAuditBB.batchOutAudit}"/>
           <c:verbatim>
           </td>
        </tr>
    </table>
    ...
    <h:dataTable value="#{attOutAuditBB.list}" var="list" align="center" id="dateList"
