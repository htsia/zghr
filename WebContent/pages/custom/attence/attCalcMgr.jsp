...
<h:form id="form1">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
            <td class="td_title"><img src="/images/tips.gif">考勤管理 -> 
            <% 
            	if("1".equals(isView)){
            		out.print("结果查看");
            	}else{
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td align="center" valign="top">
				<iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%" src="/custom/attence/attCalcList.jsf?act=init&dID=<%=dID %>&isView=<%=isView%>"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
