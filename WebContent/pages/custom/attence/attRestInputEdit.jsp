...
%>
  ...
  <h:inputHidden id="initEdit" value="#{attRestApplyBB.inputEditInit}"/>
  <h:form id="form1">
	  <h:inputHidden id="selectedUserIds" value="#{attRestApplyBB.selectedUserIds}"/>
      <h:panelGrid columns="1" styleClass="td_title" width="98%" align="center">
          <h:panelGroup>
              <h:graphicImage value="/images/tips.gif" />
              <h:outputText value=" 考勤管理 ->调休录入"/>
          </h:panelGroup>
      </h:panelGrid>
      <h:panelGrid columns="1"  width="98%" align="center">
           <h:panelGrid columns="4" width="98%" columnClasses="td_form01,td_form02,td_form01,td_form02" align="center" styleClass="table03">
             ...
             <h:panelGroup>
	             <h:inputTextarea id="userIds" value="#{attRestApplyBB.selectPersonNames}" cols="30" rows="3" readonly="true"/>
             	 <h:commandButton onclick="return selperson();" value="" styleClass="button_select" action="#{attRestApplyBB.selPerson}"/>
             </h:panelGroup>
             <h:outputText value=""/>
             <h:outputText value=""/>
            ...
            <h:panelGroup>
                <h:inputText styleClass="input" id="beginTime" value="#{attRestApplyBB.inputEditBeginDate}"
            ...
            <h:panelGroup>
                <h:inputText styleClass="input" id="endTime" value="#{attRestApplyBB.inputEditEndDate}"
            ...
            <h:inputText id="applydays" value="#{attRestApplyBB.inputEditApplyDays}" styleClass="input" />
            </h:panelGrid>
		   <h:panelGrid columns="2" width="98%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
		     <h:outputText value="原因"/>
             <h:inputTextarea cols="60" rows="5" value="#{attRestApplyBB.inputEditReason}"></h:inputTextarea>
		   </h:panelGrid>
           <h:panelGrid align="right">
              <h:commandButton value="保存"  styleClass="button01" onclick="return forsave();" action="#{attRestApplyBB.saveInput}"/>
           </h:panelGrid>
      </h:panelGrid>
  </h:form>
<script type="text/javascript">
