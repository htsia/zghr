...
%>
  ...
  <h:form id="form1">
      ...
      <!-- 将存休的天数封装 -->
      <h:inputHidden id="leaveday0" value="#{attRestApplyBB.days.putoffDays}"></h:inputHidden>
      ...
      <h:panelGrid columns="1"  width="98%" align="center">
		   ...
		   <h:panelGrid columns="2" width="100%" columnClasses="td_form01,td_form02" align="center" styleClass="table03">
             ...
             <h:inputTextarea cols="60" rows="5" value="#{attRestApplyBB.restBo.reason}"></h:inputTextarea>
		   </h:panelGrid>
