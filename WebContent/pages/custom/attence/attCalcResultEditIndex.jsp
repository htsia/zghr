    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td align="center" valign="top">
				<iframe name="main" frameborder="0" framespacing="0" scrolling="auto" width="100%" src="/custom/attence/attCalcResultEditQueryList.jsf?act=init&inself=<%=inself %>"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
