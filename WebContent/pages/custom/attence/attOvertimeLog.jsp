...
<h:form id="form1">
    <h:inputHidden value="#{attOvertimeApplyBB.initLog}"></h:inputHidden>
     <c:verbatim>
    ...
    <x:dataTable value="#{attOvertimeApplyBB.currApproverList}" var="list1" align="center" id="currApproveList" rowIndexVar="index1"
    ...
    <x:dataTable value="#{attOvertimeApplyBB.logList}" var="list" align="center" id="dateList" rowIndexVar="index"
                 headerClass="td_top" columnClasses="td_middle_center,td_middle_center,td_middle_center,td_middle_center,td_middle_center,td_middle_center"
                 styleClass="table03" width="98%" >
        <h:column>
            <c:facet name="header"><h:outputText value="序号"/></c:facet>
