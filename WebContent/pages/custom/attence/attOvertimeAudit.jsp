...
<h:form id="form1">
<h:inputHidden id="selectedItemIDs" value="#{attOvertimeAuditBB.selectedItemIDs}"/>
     <c:verbatim>
        ...
        <tr>
           ...
           <td class="td_title" align="right" style="padding-right:30px;">
			    ...
			    <h:selectOneMenu value="#{attOvertimeAuditBB.result}">
           		...
           		<h:commandButton value="批量审批" styleClass="button01" onclick="return batchAudit();" action="#{attOvertimeAuditBB.batchOvertimeAudit}"/>
           <c:verbatim>
           </td>
        </tr>
    </table>
