...
<h:form id="form1">
	    ...
	    <h:panelGrid align="right" columns="1">
	       <h:panelGroup>
	       	<h:outputText value="申请"></h:outputText>
                 <h:selectBooleanCheckbox value="#{attOutApplyBB.selApply}" onclick="submit();" valueChangeListener="#{attOutApplyBB.qryApply}"></h:selectBooleanCheckbox>
    ...
    <h:dataTable value="#{attOutApplyBB.list}" var="list" align="center" id="dateList"
        ...
        <h:commandButton value="删除"  action="#{attOutApplyBB.delete}" onclick="return confirm('确定要删除吗？');" styleClass="button01" 
             	rendered="#{attOutApplyBB.ismanager=='1'||(list.personId==attOutApplyBB.userId&&list.statusDes=='退回')}">
