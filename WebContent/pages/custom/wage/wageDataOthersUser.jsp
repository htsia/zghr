...
<script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/custom/wage/wageDataOthersUserEdit.jsf?act=init&itemType=<%=itemType%>&itemID=<%=itemID%>&view=<%=view%>&orgID=" + orgId;
        }
...
<f:view>
<h:form id="form1">
    <h:inputHidden id="itemType" value="#{wage_dataOthersBB.item}"/>
    <c:verbatim>
