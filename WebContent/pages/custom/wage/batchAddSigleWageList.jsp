...
<x:saveState value="#{wage_dataSigleBB}"></x:saveState>
<h:form id="form1">
	<h:panelGrid columns="1" align="center" width="95%">
		<h:panelGroup>
			<h:commandButton styleClass="button01" value="保存" onclick="process();" action="#{wage_dataSigleBB.saveFile}" />
			<h:outputText value=" " />
			<h:commandButton styleClass="button01" value="返回" action="upload" />
		</h:panelGroup>
	</h:panelGrid>
	<h:panelGrid columns="1" align="center" width="95%">
		<h:outputLink target="_blank" rendered="#{wage_dataSigleBB.showError}"
			style="color:red" value="#{wage_dataSigleBB.errorFileUrl}">
			<f:verbatim>
