...
<script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/custom/wage/wageDataLitleUserList.jsf?act=init&itemType=<%=itemType%>&orgID=" + orgId;
        }
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td align="center" valign="top">
				<iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="auto" width="100%" src="/custom/wage/wageDataLitleUserList.jsf?act=init&itemType=<%=itemType%>"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
