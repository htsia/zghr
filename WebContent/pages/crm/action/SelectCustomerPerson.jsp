...
<h:form id="form1">
<h:inputHidden value="#{actionBB.selectCustomerPersonInit}"></h:inputHidden>
			    ...
			    <x:dataTable value="#{actionBB.list}" id="dateList"
					...
					<h:column>
						...
						<h:commandLink action="#{actionBB.saveActionPerson}">
						  ...
						  <x:updateActionListener value="#{list.person_id}" property="#{actionBB.actionPersonBO.person_id}"></x:updateActionListener>
						</h:commandLink>
					</h:column>
					 <h:column>
						<c:facet name="header">
