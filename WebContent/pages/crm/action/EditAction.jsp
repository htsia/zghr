...
<h:form id="form1">
   ...
   <h:panelGrid columns="1" styleClass="td_title" width="102%"
		...
		<h:panelGroup >
			...
			<h:outputText value="活动管理 - > 编辑活动 "></h:outputText>
		</h:panelGroup>
	</h:panelGrid>
	...
	<h:panelGrid columns="1" align="center">
		...
		<h:panelGroup>
			<h:panelGrid align="right" columns="2">
			    ...
			    <h:commandButton value="返回" onclick="window.close();"
					styleClass="button01" />
			</h:panelGrid>
		</h:panelGroup>
			...
			<h:panelGrid columns="1" columnClasses="table02" align="center">
					...
					<h:panelGrid columns="1">
						...
						<h:panelGroup>
							<h:panelGrid columns="4" styleClass="td_form01">
								...
								<h:panelGroup>
									<h:inputText id="name" value="#{actionBB.actionBO.act_name}"></h:inputText>
						...
						<h:panelGroup>
							<h:panelGrid columns="2" styleClass="td_form01">
								...
								<h:inputText value="#{actionBB.actionBO.act_addr}" size="69"></h:inputText>
							</h:panelGrid>
						</h:panelGroup>
						...
						<h:panelGroup>
							<h:panelGrid columns="2" styleClass="td_form01">
								...
								<h:inputText value="#{actionBB.actionBO.result}" size="69"></h:inputText>
							</h:panelGrid>
						</h:panelGroup>
						<h:panelGroup>
						</h:panelGroup>
				...
				<h:panelGroup>
					<h:panelGrid columns="1">
						...
						<h:panelGrid styleClass="td_form01" columns="2">
							<h:outputText value="提前提醒时间   "></h:outputText>
							<h:inputText value="#{actionBB.actionBO.alert_day}"></h:inputText>
						</h:panelGrid>
