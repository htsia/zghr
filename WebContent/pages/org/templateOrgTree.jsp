...
<head>
    ...
    <script language="javascript">
        ...
        function showTree(pid, rightFlag, rootId, cancelFlag) {
            ...
            xmlHttp.open("GET", "../ajax/templateOrg.jsp?superId=" + superId + "&rightFlag=" + rightFlag + "&rootId=" + rootId + "&cancelFlag=" + cancelFlag+"&showGroup=1", true);
            xmlHttp.send(null);
        }
...
<script language="javascript">
    ...
    showTree("-1", "1", "", cancelFlag);//树的根节点
    //定义树的节点的扩展方法
    tree.onexpand = function(srcNode){
        if (srcNode.first.label.innerText == "loading..."){
            showTree(srcNode.key2, "1", "", cancelFlag);
        }
        return true;
    }
