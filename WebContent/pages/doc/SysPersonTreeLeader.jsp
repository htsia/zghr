...
//展示树要调用的事件
function showTree(pid, rightFlag, rootId, sysFlag) {
    flag = false;
    ...
    xmlHttp.open("GET", "/pages/ajax/SysPersonTreeLeader.jsp?sysFlag=" + sysFlag + "&superId=" + superId + "&rightFlag=1&rootId=" + rootId + "&filterSQL=<%=CommonFuns.filterNull(request.getParameter("filterSQL"))%>", true);
    xmlHttp.send(null);
