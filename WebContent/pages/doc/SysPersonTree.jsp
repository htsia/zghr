...
function showTree(pid, rightFlag, rootId, sysFlag) {
    ...
    xmlHttp.open("GET", "/pages/ajax/SysPersonTree.jsp?sysFlag=" + sysFlag + "&superId=" + superId + "&rightFlag=1&rootId=" + rootId + "&filterSQL=<%=CommonFuns.filterNull(request.getParameter("filterSQL"))%>", true);
    xmlHttp.send(null);
