...
<head>
    ...
    <script type="text/javascript">
        function refreshList(orgId) {
            ...
            document.main.location.href = "/ccp/TreeSelPerson.jsf?flag=1&superId=" + orgId;
            main.showProcessBar();
        }
            ...
            <tr>
                <td width="260" height="465" valign="top">
                    <iframe name="tree" height="100%"  frameborder="0" framespacing="0" scrolling="yes" width="100%"
                            height="465" src="/pages/ccp/PartyTree.jsp?paType=1"></iframe> 
                </td>
            </tr>
        </table>
                ...
                <tr>
                    <td>
                        <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="yes" width="100%"
                                height="465" src="/ccp/TreeSelPerson.jsf"></iframe>
                    </td>
                </tr>
            </table>
        </td>
