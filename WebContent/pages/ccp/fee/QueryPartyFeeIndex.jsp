...
%>
    <script type="text/javascript">
        function refreshList(orgId) {
            document.main.location.href = "/ccp/fee/PartyFeeQuery.jsf?flag=1&superId=" + orgId;
        }
...
<h:form id="form1">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="td_title"><img src="/images/tips.gif" />党费收支明细</td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td align="center" valign="top">
                            <iframe name="main" height="100%"  frameborder="0" framespacing="0" scrolling="yes" width="100%"
                                    src="/ccp/fee/PartyFeeQuery.jsf"></iframe>
            </td>
        </tr>
    </table>
    </c:verbatim>
