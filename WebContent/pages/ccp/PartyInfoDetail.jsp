...
<h:form id="form1">
    ...
    <h:commandLink id="saveManyAdd" action="#{ccp_PartyEditBB.saveManyAdd}" style="display:none"/>
    <h:commandLink id="saveManyUpdate" action="#{ccp_PartyEditBB.saveManyUpdate}" style="display:none"/>
...
<script type="text/javascript">
    if (setId == "D015"){
        document.all("D015035").readOnly = true;
    }
</script>
</c:verbatim>
