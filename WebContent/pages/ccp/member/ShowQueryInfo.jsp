...
<h:panelGrid width="95%" border="0" align="center" cellpadding="0" cellspacing="0" columns="2">
    <h:panelGroup>
        <h:outputText  rendered="#{ccp_queryPersonbBB.columShow == 1}" value="转出党组织   " styleClass="f04" />   
        <h:outputText  rendered="#{ccp_queryPersonbBB.columShow != 1 }" value="停止党籍    "  styleClass="f04"/>  
...
<h:dataTable width="95%" value="#{ccp_queryPersonbBB.relationvo}" var="list" id="dateList"
    ...
    <h:column rendered="#{ccp_queryPersonbBB.columShow == 1}">
        <f:facet name="header"><h:outputText value="来往党组织"/></f:facet>
        <h:outputText value="#{list.sendByUnit}"/>
    </h:column>
    <h:column  rendered="#{ccp_queryPersonbBB.flag == 0}">
        <f:facet name="header"><h:outputText value="转入日期"/></f:facet>
        <h:outputText value="#{list.comeDate}"/>
    </h:column>
     <h:column rendered="#{ccp_queryPersonbBB.flag == 1}">
        <f:facet name="header"><h:outputText value="转出日期"/></f:facet>
