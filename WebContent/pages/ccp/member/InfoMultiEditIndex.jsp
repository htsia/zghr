...
<%
    ...
    String url = "/pages/ccp/InfoItemTree.jsp?setType=A";
%>
...
<h:form id="form1">
    <h:inputHidden value="#{ccp_ManyPersonBB.pageInit}"/>
<c:verbatim>
    ...
    <tr>
        <td  valign="center" class="td_title"><img src="/images/tips.gif" alt=""><strong><span id="name">多人信息维护 </span></strong>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td width="180" align="center" valign="top" id=showTree>
            <table width="100%" border=0 cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <iframe name="tree" height="400"  frameborder="0" framespacing="0" width="100%" height="500"
        ...
        <td align="right" valign="top">
                    <iframe name="rs" frameborder="0" framespacing="0" width="100%"  scrolling="yes" src=""></iframe>
        </td>
    </tr>
   </table>
</c:verbatim>    
