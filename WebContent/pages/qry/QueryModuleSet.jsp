    ...
    <tr><td height=8>
        ...
        <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
           <h:panelGroup>
            ...
            <h:outputText value=" 设置功能界面对应的查询方案 "/>
            </h:panelGroup>
        </h:panelGrid>
<c:verbatim>
    </td></tr>
    ...
    <tr><td height=8>
        ...
        <c:selectItems value="#{qry_qryModuleSettingBB.operList}"></c:selectItems>
        </h:selectOneMenu>

        <h:selectOneMenu id="qry" value="#{qry_qryModuleSettingBB.qry}">
        <c:selectItems value="#{qry_qryModuleSettingBB.qryList}"></c:selectItems>
        </h:selectOneMenu>
        <h:commandButton value="保存" styleClass="button01" action="#{qry_qryModuleSettingBB.save}"></h:commandButton>
...
<c:verbatim>
    ...
    <tr><td>
        ...
        <h:dataTable var="list" styleClass="table03" align="center" width="95%" id="dateList"
                     headerClass="td_top tr_fixrow" columnClasses="td_middle_center,td_middle,td_middle"
                     value="#{qry_qryModuleSettingBB.setList}">
            <h:column>
                <f:facet name="header">
