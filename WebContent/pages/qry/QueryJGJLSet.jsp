...
<h:form id="form1">
    ...
    <tr><td height=8>
        ...
        <h:panelGrid styleClass="td_title" width="100%" border="0" cellpadding="0" cellspacing="6" bgcolor="#FFFFFF" columns="2">
           <h:panelGroup>
            ...
            <h:outputText value=" 设置分支经理人员查询对应的查询方案 "/>
            </h:panelGroup>
        </h:panelGrid>
    <c:verbatim>
    </td></tr>
    ...
    <tr><td height=8 align="right">
        ...
        <h:selectOneMenu id="operate" value="#{qry_qryModuleSettingBB.oper}">
          <c:selectItems value="#{qry_qryModuleSettingBB.jgzlList}"></c:selectItems>
        </h:selectOneMenu>
        ...
        <h:commandButton value="保存" styleClass="button01" action="#{qry_qryModuleSettingBB.saveJGJL}"></h:commandButton>
...
<c:verbatim>
    ...
    <tr><td>
        ...
        <h:dataTable var="list" styleClass="table03" align="center" width="95%" id="dateList"
                     ...
                     value="#{qry_qryModuleSettingBB.jgzlSetList}">
            <h:column>
                <f:facet name="header">
