 ...
 *    type: 0 org  1 post  2 party 3 lead Query 9 other
 *
 */
function Node(oid,code,name,level,open,type) {
  this.oid = oid;
  this.code = code;
  this.name = name;
  this.level = level;
...
function NodeCreateAllNodesV(inParentIndex,parentChildCount){
    ...
    if( this.parent!=null ){
	    ...
	    curCell.height="50%";
            ...
            for(i=0;i<length*2-1;i++){
               if( i==length-1 ){
        	   curImage = document.createElement("<img src='" +contextPath+ "/images/orgverticalcenter.gif' width='2' height='60'>");
...
function NodeCreateAllNodesH(inParentIndex,parentChildCount){
    ...
    if( this.parent!=null ){
        ...
        if( inParentIndex==0 ){
           if( parentChildCount==1 ){
               //插入 "   |   "
              curImage = document.createElement("<img src='" +contextPath+ "/images/orgvertical.gif' width='20' height='20'>");
              if (length == 1) {
              ...
              //插入 "   ┌──"
               ...
               curImage = document.createElement("<img src='" +contextPath+ "/images/orgleft.gif' width='20' height='20'>");
             ...
             //插入 "──┼──"
			if (length == 1) {
			   curImage = document.createElement("<img src='" +contextPath+ "/images/orgcross.gif' width='20' height='20'>");
			   curRow.cells[0].appendChild(curImage);
			   curRow.cells[0].align="center";
            ...
            curImage = document.createElement("<img src='" +contextPath+ "/images/orgright.gif' width='20' height='20'>");
            subTable.rows[0].cells[1].appendChild(curImage);
			...
			if (length == 1) {
             ...
             //插入 "──┬──"
			if (length == 1) {
			   curImage = document.createElement("<img src='" +contextPath+ "/images/orgcenter.gif' width='20' height='20'>");
			   curRow.cells[0].appendChild(curImage);
			   curRow.cells[0].align="center";
			   curRow.cells[0].background = contextPath + "/images/orghorizontal.gif";
			} else {
    ...
    if( this.subnode!=null && this.subnode.length>0 ){
       ...
       for(i=0;i<length-1;i++){
	    ...
	    subTable.rows[0].cells[0].background = contextPath + "/images/orghorizontal.gif";
	    curImage = document.createElement("<img src='" +contextPath+ "/images/orgtop.gif' width='20' height='20'>");
	    subTable.rows[0].cells[1].appendChild(curImage);
	    subTable.rows[0].cells[2].background = contextPath + "/images/orghorizontal.gif";
...
function NodeCreateViewNodeT(oid){
    ...
    var wholeTable = document.createElement("<table width='100%' height='25' border='0' cellspacing='0' cellpadding='0' style='PADDING-RIGHT: 0px; PADDING-LEFT: 0px' >");
    ...
    var curImage = document.createElement("<img id='" + idItem + "' onmouseover='" +clickHandle+ "' src='" +contextPath+ "/images/orgtreeempty.gif' width='16' height='16' border='0' >");
    //curCell.appendChild( curImage );
    ...
    curCell.noWrap = true;
    if (this.type==3){      // 领导查询
        curCell.innerHTML = "<a  onclick=\"window.showModalDialog('/pages/lead/OrganView.jsp?fk="+this.oid+"','','dialogWidth:'+screen.width*0.9+'px; dialogHeight:'+screen.height*0.9+'px;center:center;resizable:yes;status:no;scroll:yes;')\">"+this.name+"</a>";
    }
    else if (this.type==2){      // 党组织
        curCell.innerHTML = "<a target='_BLANK' href='/doc/PartyIndex.jsf?fk="+this.oid+"'>"+this.name+"</a>";
    }
    else if (this.type==1){   // 岗位
        curCell.innerHTML = "<a target='_BLANK' href='/doc/SinglePostBookQuery.jsf?postid="+this.oid+"&fk="+this.oid+"'>"+this.name+"</a>";
    }
    else if (this.type==0){  // 机构
        curCell.innerHTML = "<a target='_BLANK' href='/doc/OrgIndex.jsf?fk="+this.oid+"'>"+this.name+"</a>";
    }
    else{
        curCell.innerHTML = this.name;
    }
...
function NodeCreateViewNodeV(oid){
    ...
    //create the Whole table
    var wholeTable = document.createElement("<table width='100%' border='0' cellspacing='0' cellpadding='0' style='PADDING-RIGHT: 0px; PADDING-LEFT: 0px' >");
    aDiv.appendChild(wholeTable);
    ...
    curImage = document.createElement("<img onclick='" +clickHandle + "' src='" +contextPath+ "/images/orgtreeempty.gif' width='16' height='16' border='0'  >");
//    curImage.alt = assignJobAltLabel;
    ...
    subTable = document.createElement( "<table width='2' border='0' cellspacing='0' cellpadding='2'>" );
    curCell.appendChild(subTable);
...
//show organization unit by char model   修改过
function NodeCreateViewNodeH(oid){
    ...
    //create the Whole table
    var wholeTable = document.createElement("<table width='2' height='100%' border='0' cellpadding='0' cellspacing='0'>");
    aDiv.appendChild(wholeTable);
    ...
    var subTable = document.createElement( "<table style='padding-left:2px;padding-right:2px;' width='2' border='0' cellspacing='0' cellpadding='0'>" );
    curCell.appendChild(subTable);
    /*curRow = subTable.insertRow();
    curRow.align="center";
    ...
    var curImage = document.createElement("<img id='" + idItem + "' onclick='" +clickHandle+ "' src='" +contextPath+ "/images/orgtreeempty.gif' width='16' height='16' border='0'  >");
    ...
    subTable = document.createElement( "<table style='padding-left:2px;padding-right:2px;' width='2' border='0' cellspacing='0' cellpadding='2'>" );
    curCell.appendChild(subTable);
...
function initLevelViewNode(td,aDiv){
    ...
    if( treeNode.parent!=null ){
        for(var i=treeNode.parent.level;i<treeNode.level-1;i++){
            ...
            var tempTable = document.createElement("<table width='2' height='100%' ></table>");
